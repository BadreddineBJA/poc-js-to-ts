...
/** @defgroup RNG_Exported_Functions_Group1 Initialization and configuration functions
  * @{
  */
hal_status_t HAL_RNG_Init(RNG_HandleTypeDef *hrng);
hal_status_t HAL_RNG_DeInit(RNG_HandleTypeDef *hrng);
void HAL_RNG_MspInit(RNG_HandleTypeDef *hrng);
void HAL_RNG_MspDeInit(RNG_HandleTypeDef *hrng);

/* Callbacks Register/UnRegister functions  ***********************************/
#if (USE_HAL_RNG_REGISTER_CALLBACKS == 1)
hal_status_t HAL_RNG_RegisterCallback(RNG_HandleTypeDef *hrng, HAL_RNG_CallbackIDTypeDef CallbackID,
                                      pRNG_CallbackTypeDef pCallback);
hal_status_t HAL_RNG_UnRegisterCallback(RNG_HandleTypeDef *hrng, HAL_RNG_CallbackIDTypeDef CallbackID);

hal_status_t HAL_RNG_RegisterReadyDataCallback(RNG_HandleTypeDef *hrng, pRNG_ReadyDataCallbackTypeDef pCallback);
hal_status_t HAL_RNG_UnRegisterReadyDataCallback(RNG_HandleTypeDef *hrng);
#endif /* USE_HAL_RNG_REGISTER_CALLBACKS */
...
/** @defgroup RNG_Exported_Functions_Group2 Peripheral Control functions
  * @{
  */
hal_status_t HAL_RNG_GenerateRandomNumber(RNG_HandleTypeDef *hrng, uint32_t *random32bit);
hal_status_t HAL_RNG_GenerateRandomNumber_IT(RNG_HandleTypeDef *hrng);
...
/** @defgroup RNG_Private_Functions RNG Private functions
  * @{
  */
hal_status_t RNG_RecoverSeedError(RNG_HandleTypeDef *hrng);
/**
  * @}
  */
/**
