...
/** @defgroup FMC_LL_NORSRAM_Private_Functions_Group1 NOR SRAM Initialization/de-initialization functions
  *  @{
  */
hal_status_t  FMC_NORSRAM_Init(FMC_NORSRAM_TypeDef *Device,
                               FMC_NORSRAM_InitTypeDef *Init);
hal_status_t  FMC_NORSRAM_Timing_Init(FMC_NORSRAM_TypeDef *Device,
                                      FMC_NORSRAM_TimingTypeDef *Timing, uint32_t Bank);
hal_status_t  FMC_NORSRAM_Extended_Timing_Init(FMC_NORSRAM_EXTENDED_TypeDef *Device,
                                               FMC_NORSRAM_TimingTypeDef *Timing, uint32_t Bank,
                                               uint32_t ExtendedMode);
hal_status_t  FMC_NORSRAM_DeInit(FMC_NORSRAM_TypeDef *Device,
...
/** @defgroup FMC_LL_NORSRAM_Private_Functions_Group2 NOR SRAM Control functions
  *  @{
  */
hal_status_t  FMC_NORSRAM_WriteOperation_Enable(FMC_NORSRAM_TypeDef *Device, uint32_t Bank);
hal_status_t  FMC_NORSRAM_WriteOperation_Disable(FMC_NORSRAM_TypeDef *Device, uint32_t Bank);
/**
  * @}
  */
/**
...
/** @defgroup FMC_LL_NAND_Private_Functions_Group1 NAND Initialization/de-initialization functions
  *  @{
  */
hal_status_t  FMC_NAND_Init(FMC_NAND_TypeDef *Device, FMC_NAND_InitTypeDef *Init);
hal_status_t  FMC_NAND_CommonSpace_Timing_Init(FMC_NAND_TypeDef *Device,
                                               FMC_NAND_PCC_TimingTypeDef *Timing, uint32_t Bank);
hal_status_t  FMC_NAND_AttributeSpace_Timing_Init(FMC_NAND_TypeDef *Device,
                                                  FMC_NAND_PCC_TimingTypeDef *Timing, uint32_t Bank);
hal_status_t  FMC_NAND_DeInit(FMC_NAND_TypeDef *Device, uint32_t Bank);
/**
  * @}
  */
...
/** @defgroup FMC_LL_NAND_Private_Functions_Group2 NAND Control functions
  *  @{
  */
hal_status_t  FMC_NAND_ECC_Enable(FMC_NAND_TypeDef *Device, uint32_t Bank);
hal_status_t  FMC_NAND_ECC_Disable(FMC_NAND_TypeDef *Device, uint32_t Bank);
hal_status_t  FMC_NAND_GetECC(FMC_NAND_TypeDef *Device, uint32_t *ECCval, uint32_t Bank,
                              uint32_t Timeout);
/**
  * @}
  */
