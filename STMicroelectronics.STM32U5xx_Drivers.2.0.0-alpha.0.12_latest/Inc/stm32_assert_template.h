...
/**
  ...
  * @param  expr If expr is false, it calls ASSERT_DBG_PARAM function
...
/**
  ...
  * @param  expr If expr is false, it calls ASSERT_DBG_STATE function
  *         which reports the name of the source file and the source
  *         line number of the call that failed.
  *         If expr is true, it returns no value.
  * @retval None
  */
#define ASSERT_DBG_STATE(expr) ((expr) ? (void)0U : assert_dbg_state_failed((uint8_t *)__FILE__, __LINE__))
/* Exported functions ------------------------------------------------------- */
