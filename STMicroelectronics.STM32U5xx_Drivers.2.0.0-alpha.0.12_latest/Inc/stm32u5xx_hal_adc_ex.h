...
/* ADC calibration */
hal_status_t       HAL_ADCEx_Calibration_Start(ADC_HandleTypeDef *hadc, uint32_t CalibrationMode,
                                               uint32_t SingleDiff);
...
hal_status_t       HAL_ADCEx_MultiModeStart_DMA_Data32(ADC_HandleTypeDef *hadc, const uint32_t *pData,
                                                       uint32_t Length);
...
hal_status_t       HAL_ADCEx_InjectedConfigChannel(ADC_HandleTypeDef *hadc,
