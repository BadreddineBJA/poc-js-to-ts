...
typedef struct
{
  ...
  uint32_t OCNPolarity;   /*!< Specifies the complementary output polarity.
                               ...
                               @action{show, gethwfeature(break)} */

  uint32_t OCFastMode;    /*!< Specifies the Fast mode state.
                               This parameter can be a value of @ref TIM_Output_Fast_State
                               @note This parameter is valid only in PWM1 and PWM2 mode.
                               @action{show, ('PWM' in OCMode)}*/
...
/** @defgroup TIM_Exported_Functions_Group8 TIM Peripheral Control functions
  ...
  */
/* Control functions  *********************************************************/
hal_status_t HAL_TIM_OC_ConfigChannel(TIM_HandleTypeDef *htim, const TIM_OC_InitTypeDef *sConfig, uint32_t Channel);
hal_status_t HAL_TIM_PWM_ConfigChannel(TIM_HandleTypeDef *htim, const TIM_OC_InitTypeDef *sConfig, uint32_t Channel);
...
hal_status_t HAL_TIM_ConfigOCrefClear(TIM_HandleTypeDef *htim, const TIM_ClearInputConfigTypeDef *sClearInputConfig,
                                      uint32_t Channel);
...
hal_status_t HAL_TIM_SlaveConfigSynchro_IT(TIM_HandleTypeDef *htim, const TIM_SlaveConfigTypeDef *sSlaveConfig);
