...
/** @defgroup SD_Exported_Functions_Group1 Initialization and de-initialization functions
  * @{
  */
hal_status_t HAL_SD_Init(SD_HandleTypeDef *hsd);
hal_status_t HAL_SD_InitCard(SD_HandleTypeDef *hsd);
hal_status_t HAL_SD_DeInit(SD_HandleTypeDef *hsd);
...
hal_status_t HAL_SD_ReadBlocks(SD_HandleTypeDef *hsd, uint8_t *pData, uint32_t BlockAdd, uint32_t NumberOfBlocks,
                               uint32_t Timeout);
hal_status_t HAL_SD_WriteBlocks(SD_HandleTypeDef *hsd, uint8_t *pData, uint32_t BlockAdd, uint32_t NumberOfBlocks,
                                uint32_t Timeout);
hal_status_t HAL_SD_Erase(SD_HandleTypeDef *hsd, uint32_t BlockStartAdd, uint32_t BlockEndAdd);
/* Non-Blocking mode: IT */
hal_status_t HAL_SD_ReadBlocks_IT(SD_HandleTypeDef *hsd, uint8_t *pData, uint32_t BlockAdd,
                                  uint32_t NumberOfBlocks);
hal_status_t HAL_SD_WriteBlocks_IT(SD_HandleTypeDef *hsd, uint8_t *pData, uint32_t BlockAdd,
                                   uint32_t NumberOfBlocks);
/* Non-Blocking mode: DMA */
hal_status_t HAL_SD_ReadBlocks_DMA(SD_HandleTypeDef *hsd, uint8_t *pData, uint32_t BlockAdd,
                                   uint32_t NumberOfBlocks);
hal_status_t HAL_SD_WriteBlocks_DMA(SD_HandleTypeDef *hsd, uint8_t *pData, uint32_t BlockAdd,
                                    uint32_t NumberOfBlocks);
...
hal_status_t HAL_SD_RegisterCallback(SD_HandleTypeDef *hsd, HAL_SD_CallbackIDTypeDef CallbackID,
                                     pSD_CallbackTypeDef pCallback);
hal_status_t HAL_SD_UnRegisterCallback(SD_HandleTypeDef *hsd, HAL_SD_CallbackIDTypeDef CallbackID);

#if (USE_SD_TRANSCEIVER != 0U)
hal_status_t HAL_SD_RegisterTransceiverCallback(SD_HandleTypeDef *hsd, pSD_TransceiverCallbackTypeDef pCallback);
hal_status_t HAL_SD_UnRegisterTransceiverCallback(SD_HandleTypeDef *hsd);
#endif /* USE_SD_TRANSCEIVER */
#endif /* USE_HAL_SD_REGISTER_CALLBACKS */
...
/** @defgroup SD_Exported_Functions_Group3 Peripheral Control functions
  * @{
  */
hal_status_t HAL_SD_ConfigWideBusOperation(SD_HandleTypeDef *hsd, uint32_t WideMode);
hal_status_t HAL_SD_ConfigSpeedBusOperation(SD_HandleTypeDef *hsd, uint32_t SpeedMode);
/**
  * @}
  */
...
hal_status_t       HAL_SD_GetCardCID(SD_HandleTypeDef *hsd, HAL_SD_CardCIDTypeDef *pCID);
hal_status_t       HAL_SD_GetCardCSD(SD_HandleTypeDef *hsd, HAL_SD_CardCSDTypeDef *pCSD);
hal_status_t       HAL_SD_GetCardStatus(SD_HandleTypeDef *hsd, HAL_SD_CardStatusTypeDef *pStatus);
hal_status_t       HAL_SD_GetCardInfo(SD_HandleTypeDef *hsd, HAL_SD_CardInfoTypeDef *pCardInfo);
/**
  * @}
  */
...
/** @defgroup SD_Exported_Functions_Group6 Perioheral Abort management
  * @{
  */
hal_status_t HAL_SD_Abort(SD_HandleTypeDef *hsd);
hal_status_t HAL_SD_Abort_IT(SD_HandleTypeDef *hsd);
/**
  * @}
  */
