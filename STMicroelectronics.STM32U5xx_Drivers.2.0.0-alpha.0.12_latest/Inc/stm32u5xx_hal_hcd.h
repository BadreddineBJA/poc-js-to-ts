...
hal_status_t HAL_HCD_HC_Init(HCD_HandleTypeDef *hhcd, uint8_t ch_num,
...
hal_status_t HAL_HCD_UnRegisterCallback(HCD_HandleTypeDef *hhcd,
                                        HAL_HCD_CallbackIDTypeDef CallbackID);
...
/** @addtogroup HCD_Exported_Functions_Group2 Input and Output operation functions
  * @{
  */
hal_status_t HAL_HCD_HC_SubmitRequest(HCD_HandleTypeDef *hhcd, uint8_t ch_num,
