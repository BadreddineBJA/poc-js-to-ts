...
/** @addtogroup MDF_Exported_Functions_Group1
  * @{
  */
hal_status_t HAL_MDF_Init(MDF_HandleTypeDef *hmdf);
hal_status_t HAL_MDF_DeInit(MDF_HandleTypeDef *hmdf);
void              HAL_MDF_MspInit(MDF_HandleTypeDef *hmdf);
void              HAL_MDF_MspDeInit(MDF_HandleTypeDef *hmdf);
#if (USE_HAL_MDF_REGISTER_CALLBACKS == 1)
hal_status_t HAL_MDF_RegisterCallback(MDF_HandleTypeDef        *hmdf,
                                      HAL_MDF_CallbackIDTypeDef CallbackID,
                                      pMDF_CallbackTypeDef      pCallback);
hal_status_t HAL_MDF_UnRegisterCallback(MDF_HandleTypeDef        *hmdf,
                                        HAL_MDF_CallbackIDTypeDef CallbackID);
hal_status_t HAL_MDF_RegisterOldCallback(MDF_HandleTypeDef      *hmdf,
                                         pMDF_OldCallbackTypeDef pCallback);
hal_status_t HAL_MDF_UnRegisterOldCallback(MDF_HandleTypeDef *hmdf);
hal_status_t HAL_MDF_RegisterSndLvlCallback(MDF_HandleTypeDef         *hmdf,
                                            pMDF_SndLvlCallbackTypeDef pCallback);
hal_status_t HAL_MDF_UnRegisterSndLvlCallback(MDF_HandleTypeDef *hmdf);
#endif /* USE_HAL_MDF_REGISTER_CALLBACKS */
/**
  * @}
  */
...
/** @addtogroup MDF_Exported_Functions_Group2
  * @{
  */
hal_status_t HAL_MDF_AcqStart(MDF_HandleTypeDef *hmdf, MDF_FilterConfigTypeDef *pFilterConfig);
hal_status_t HAL_MDF_PollForAcq(MDF_HandleTypeDef *hmdf, uint32_t Timeout);
hal_status_t HAL_MDF_PollForSnapshotAcq(MDF_HandleTypeDef *hmdf, uint32_t Timeout);
hal_status_t HAL_MDF_GetAcqValue(MDF_HandleTypeDef *hmdf, int32_t *pValue);
hal_status_t HAL_MDF_GetSnapshotAcqValue(MDF_HandleTypeDef *hmdf, MDF_SnapshotParamTypeDef *pSnapshotParam);
hal_status_t HAL_MDF_AcqStop(MDF_HandleTypeDef *hmdf);
hal_status_t HAL_MDF_AcqStart_IT(MDF_HandleTypeDef *hmdf, MDF_FilterConfigTypeDef *pFilterConfig);
hal_status_t HAL_MDF_AcqStop_IT(MDF_HandleTypeDef *hmdf);
hal_status_t HAL_MDF_AcqStart_DMA(MDF_HandleTypeDef *hmdf, MDF_FilterConfigTypeDef *pFilterConfig,
                                  MDF_DmaConfigTypeDef *pDmaConfig);
hal_status_t HAL_MDF_AcqStop_DMA(MDF_HandleTypeDef *hmdf);
hal_status_t HAL_MDF_GenerateTrgo(MDF_HandleTypeDef *hmdf);
hal_status_t HAL_MDF_SetDelay(MDF_HandleTypeDef *hmdf, uint32_t Delay);
hal_status_t HAL_MDF_GetDelay(MDF_HandleTypeDef *hmdf, uint32_t *pDelay);
hal_status_t HAL_MDF_SetGain(MDF_HandleTypeDef *hmdf, int32_t Gain);
hal_status_t HAL_MDF_GetGain(MDF_HandleTypeDef *hmdf, int32_t *pGain);
hal_status_t HAL_MDF_SetOffset(MDF_HandleTypeDef *hmdf, int32_t Offset);
hal_status_t HAL_MDF_GetOffset(MDF_HandleTypeDef *hmdf, int32_t *pOffset);
hal_status_t HAL_MDF_PollForSndLvl(MDF_HandleTypeDef *hmdf, uint32_t Timeout, uint32_t *pSoundLevel,
                                   uint32_t *pAmbientNoise);
hal_status_t HAL_MDF_PollForSad(MDF_HandleTypeDef *hmdf, uint32_t Timeout);
...
/** @addtogroup MDF_Exported_Functions_Group3
  * @{
  */
hal_status_t HAL_MDF_PollForCkab(MDF_HandleTypeDef *hmdf, uint32_t Timeout);
hal_status_t HAL_MDF_CkabStart_IT(MDF_HandleTypeDef *hmdf);
hal_status_t HAL_MDF_CkabStop_IT(MDF_HandleTypeDef *hmdf);
/**
  * @}
  */
...
/** @addtogroup MDF_Exported_Functions_Group4
  * @{
  */
hal_status_t HAL_MDF_ScdStart(MDF_HandleTypeDef *hmdf, MDF_ScdConfigTypeDef *pScdConfig);
hal_status_t HAL_MDF_PollForScd(MDF_HandleTypeDef *hmdf, uint32_t Timeout);
hal_status_t HAL_MDF_ScdStop(MDF_HandleTypeDef *hmdf);
hal_status_t HAL_MDF_ScdStart_IT(MDF_HandleTypeDef *hmdf, MDF_ScdConfigTypeDef *pScdConfig);
hal_status_t HAL_MDF_ScdStop_IT(MDF_HandleTypeDef *hmdf);
/**
  * @}
  */
...
/** @addtogroup MDF_Exported_Functions_Group5
  * @{
  */
hal_status_t HAL_MDF_OldStart(MDF_HandleTypeDef *hmdf, MDF_OldConfigTypeDef *pOldConfig);
hal_status_t HAL_MDF_PollForOld(MDF_HandleTypeDef *hmdf, uint32_t Timeout, uint32_t *pThresholdInfo);
hal_status_t HAL_MDF_OldStop(MDF_HandleTypeDef *hmdf);
hal_status_t HAL_MDF_OldStart_IT(MDF_HandleTypeDef *hmdf, MDF_OldConfigTypeDef *pOldConfig);
hal_status_t HAL_MDF_OldStop_IT(MDF_HandleTypeDef *hmdf);
