...
#endif /* USE_HAL_LPTIM_REGISTER_CALLBACKS */
{
  ...
  hal_status_t              Status;           /*!< LPTIM peripheral status   */
...
#if (USE_HAL_LPTIM_REGISTER_CALLBACKS == 1)
hal_status_t HAL_LPTIM_RegisterCallback(LPTIM_HandleTypeDef *lphtim, HAL_LPTIM_CallbackIDTypeDef CallbackID,
                                        pLPTIM_CallbackTypeDef pCallback);
hal_status_t HAL_LPTIM_UnRegisterCallback(LPTIM_HandleTypeDef *lphtim, HAL_LPTIM_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_LPTIM_REGISTER_CALLBACKS */
/**
  * @}
  */
