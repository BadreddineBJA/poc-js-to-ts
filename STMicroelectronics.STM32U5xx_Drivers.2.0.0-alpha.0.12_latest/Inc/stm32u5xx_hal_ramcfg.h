...
/** @defgroup RAMCFG_Exported_Functions_Group1 Initialization and De-Initialization Functions
  ...
  * @{
  */
hal_status_t HAL_RAMCFG_Init(RAMCFG_HandleTypeDef *hramcfg);
hal_status_t HAL_RAMCFG_DeInit(RAMCFG_HandleTypeDef *hramcfg);
...
/** @defgroup RAMCFG_Exported_Functions_Group2 ECC Operation Functions
  ...
  * @{
  */
hal_status_t HAL_RAMCFG_StartECC(RAMCFG_HandleTypeDef *hramcfg);
hal_status_t HAL_RAMCFG_StopECC(RAMCFG_HandleTypeDef *hramcfg);
hal_status_t HAL_RAMCFG_EnableNotification(RAMCFG_HandleTypeDef *hramcfg, uint32_t Notifications);
hal_status_t HAL_RAMCFG_DisableNotification(RAMCFG_HandleTypeDef *hramcfg, uint32_t Notifications);
...
/** @defgroup RAMCFG_Exported_Functions_Group3 Configure Wait State Functions
  ...
  * @{
  */
hal_status_t HAL_RAMCFG_ConfigWaitState(RAMCFG_HandleTypeDef *hramcfg, uint32_t WaitState);
...
/** @defgroup RAMCFG_Exported_Functions_Group4 Write Protection Functions
  ...
  * @{
  */
hal_status_t HAL_RAMCFG_EnableWriteProtection(RAMCFG_HandleTypeDef *hramcfg, uint32_t StartPage, uint32_t NbPage);
/**
  * @}
  */
...
/** @defgroup RAMCFG_Exported_Functions_Group5 Erase Operation Functions
  ...
  * @{
  */
hal_status_t HAL_RAMCFG_Erase(RAMCFG_HandleTypeDef *hramcfg);
/**
  * @}
  */
...
#if (USE_HAL_RAMCFG_REGISTER_CALLBACKS == 1)
hal_status_t HAL_RAMCFG_RegisterCallback(RAMCFG_HandleTypeDef *hramcfg,
                                         HAL_RAMCFG_CallbackIDTypeDef CallbackID,
                                         void (* pCallback)(RAMCFG_HandleTypeDef *_hramcfg));
hal_status_t HAL_RAMCFG_UnRegisterCallback(RAMCFG_HandleTypeDef *hramcfg, HAL_RAMCFG_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_RAMCFG_REGISTER_CALLBACKS */
/**
  * @}
  */
