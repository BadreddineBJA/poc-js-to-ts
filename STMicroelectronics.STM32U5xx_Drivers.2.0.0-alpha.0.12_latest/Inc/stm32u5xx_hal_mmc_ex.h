...
/** @defgroup MMCEx_Exported_Functions_Group1 MultiBuffer functions
  * @{
  */
hal_status_t HAL_MMCEx_DMALinkedList_ReadBlocks(MMC_HandleTypeDef *hmmc, SDMMC_DMALinkedListTypeDef *pLinkedList,
                                                uint32_t BlockAdd, uint32_t NumberOfBlocks);
hal_status_t HAL_MMCEx_DMALinkedList_WriteBlocks(MMC_HandleTypeDef *hmmc, SDMMC_DMALinkedListTypeDef *pLinkedList,
                                                 uint32_t BlockAdd, uint32_t NumberOfBlocks);

hal_status_t HAL_MMCEx_DMALinkedList_BuildNode(MMC_DMALinkNodeTypeDef *pNode,
                                               MMC_DMALinkNodeConfTypeDef *pNodeConf);
hal_status_t HAL_MMCEx_DMALinkedList_InsertNode(MMC_DMALinkedListTypeDef *pLinkedList,
                                                MMC_DMALinkNodeTypeDef *pPrevNode,
                                                MMC_DMALinkNodeTypeDef *pNewNode);
hal_status_t HAL_MMCEx_DMALinkedList_RemoveNode(MMC_DMALinkedListTypeDef *pLinkedList,
                                                MMC_DMALinkNodeTypeDef *pNode);
hal_status_t HAL_MMCEx_DMALinkedList_LockNode(MMC_DMALinkNodeTypeDef *pNode);
hal_status_t HAL_MMCEx_DMALinkedList_UnlockNode(MMC_DMALinkNodeTypeDef *pNode);
hal_status_t HAL_MMCEx_DMALinkedList_EnableCircularMode(SDMMC_DMALinkedListTypeDef *pLinkedList);
hal_status_t HAL_MMCEx_DMALinkedList_DisableCircularMode(SDMMC_DMALinkedListTypeDef *pLinkedList);
