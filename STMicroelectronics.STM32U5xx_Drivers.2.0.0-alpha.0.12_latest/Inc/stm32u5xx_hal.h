...
#define ASSERT_DBG_STATE(expr) ((void) 0U)
...
#if defined(USE_HAL_RCC_MODULE) && (USE_HAL_RCC_MODULE==1U)
...
#if defined(USE_HAL_ICACHE_MODULE) && (USE_HAL_ICACHE_MODULE==1U)
#include "stm32u5xx_hal_icache.h"
#endif /* USE_HAL_ICACHE_MODULE==1U */

#if defined(USE_HAL_DCACHE_MODULE) && (USE_HAL_DCACHE_MODULE==1U)
#include "stm32u5xx_hal_dcache.h"
#endif /* USE_HAL_DCACHE_MODULE==1U */

#if defined(USE_HAL_GTZC_MODULE) && (USE_HAL_GTZC_MODULE==1U)
#include "stm32u5xx_hal_gtzc.h"
#endif /* USE_HAL_GTZC_MODULE==1U */

#if defined(USE_HAL_DMA_MODULE) && (USE_HAL_DMA_MODULE==1U)
#include "stm32u5xx_hal_dma.h"
#endif /* USE_HAL_DMA_MODULE==1U */

#if defined(USE_HAL_DMA2D_MODULE) && (USE_HAL_DMA2D_MODULE==1U)
#include "stm32u5xx_hal_dma2d.h"
#endif /* USE_HAL_DMA2D_MODULE==1U */

#if defined(USE_HAL_CORTEX_MODULE) && (USE_HAL_CORTEX_MODULE==1U)
#include "stm32u5xx_hal_cortex.h"
#endif /* USE_HAL_CORTEX_MODULE==1U */

#if defined(USE_HAL_PKA_MODULE) && (USE_HAL_PKA_MODULE==1U)
#include "stm32u5xx_hal_pka.h"
#endif /* USE_HAL_PKA_MODULE==1U */

#if defined(USE_HAL_ADC_MODULE) && (USE_HAL_ADC_MODULE==1U)
#include "stm32u5xx_hal_adc.h"
#endif /* USE_HAL_ADC_MODULE==1U */

#if defined(USE_HAL_COMP_MODULE) && (USE_HAL_COMP_MODULE==1U)
#include "stm32u5xx_hal_comp.h"
#endif /* USE_HAL_COMP_MODULE==1U */

#if defined(USE_HAL_CRC_MODULE) && (USE_HAL_CRC_MODULE==1U)
#include "stm32u5xx_hal_crc.h"
#endif /* USE_HAL_CRC_MODULE==1U */

#if defined(USE_HAL_CRYP_MODULE) && (USE_HAL_CRYP_MODULE==1U)
#include "stm32u5xx_hal_cryp.h"
#endif /* USE_HAL_CRYP_MODULE==1U */

#if defined(USE_HAL_DAC_MODULE) && (USE_HAL_DAC_MODULE==1U)
#include "stm32u5xx_hal_dac.h"
#endif /* USE_HAL_DAC_MODULE==1U */

#if defined(USE_HAL_FLASH_MODULE) && (USE_HAL_FLASH_MODULE==1U)
#include "stm32u5xx_hal_flash.h"
#endif /* USE_HAL_FLASH_MODULE==1U */

#if defined(USE_HAL_HASH_MODULE) && (USE_HAL_HASH_MODULE==1U)
#include "stm32u5xx_hal_hash.h"
#endif /* USE_HAL_HASH_MODULE==1U */

#if defined(USE_HAL_SRAM_MODULE) && (USE_HAL_SRAM_MODULE==1U)
#include "stm32u5xx_hal_sram.h"
#endif /* USE_HAL_SRAM_MODULE==1U */

#if defined(USE_HAL_MMC_MODULE) && (USE_HAL_MMC_MODULE==1U)
#include "stm32u5xx_hal_mmc.h"
#endif /* USE_HAL_MMC_MODULE==1U */

#if defined(USE_HAL_NOR_MODULE) && (USE_HAL_NOR_MODULE==1U)
#include "stm32u5xx_hal_nor.h"
#endif /* USE_HAL_NOR_MODULE==1U */

#if defined(USE_HAL_NAND_MODULE) && (USE_HAL_NAND_MODULE==1U)
#include "stm32u5xx_hal_nand.h"
#endif /* USE_HAL_NAND_MODULE==1U */

#if defined(USE_HAL_I2C_MODULE) && (USE_HAL_I2C_MODULE==1U)
#include "stm32u5xx_hal_i2c.h"
#endif /* USE_HAL_I2C_MODULE==1U */

#if defined(USE_HAL_IWDG_MODULE) && (USE_HAL_IWDG_MODULE==1U)
#include "stm32u5xx_hal_iwdg.h"
#endif /* USE_HAL_IWDG_MODULE==1U */

#if defined(USE_HAL_LPTIM_MODULE) && (USE_HAL_LPTIM_MODULE==1U)
#include "stm32u5xx_hal_lptim.h"
#endif /* USE_HAL_LPTIM_MODULE==1U */

#if defined(USE_HAL_OPAMP_MODULE) && (USE_HAL_OPAMP_MODULE==1U)
#include "stm32u5xx_hal_opamp.h"
#endif /* USE_HAL_OPAMP_MODULE==1U */

#if defined(USE_HAL_PWR_MODULE) && (USE_HAL_PWR_MODULE==1U)
#include "stm32u5xx_hal_pwr.h"
#endif /* USE_HAL_PWR_MODULE==1U */

#if defined(USE_HAL_OSPI_MODULE) && (USE_HAL_OSPI_MODULE==1U)
#include "stm32u5xx_hal_ospi.h"
#endif /* USE_HAL_OSPI_MODULE==1U */

#if defined(USE_HAL_RNG_MODULE) && (USE_HAL_RNG_MODULE==1U)
#include "stm32u5xx_hal_rng.h"
#endif /* USE_HAL_RNG_MODULE==1U */

#if defined(USE_HAL_RTC_MODULE) && (USE_HAL_RTC_MODULE==1U)
#include "stm32u5xx_hal_rtc.h"
#endif /* USE_HAL_RTC_MODULE==1U */

#if defined(USE_HAL_SAI_MODULE) && (USE_HAL_SAI_MODULE==1U)
#include "stm32u5xx_hal_sai.h"
#endif /* USE_HAL_SAI_MODULE==1U */

#if defined(USE_HAL_SD_MODULE) && (USE_HAL_SD_MODULE==1U)
#include "stm32u5xx_hal_sd.h"
#endif /* USE_HAL_SD_MODULE==1U */

#if defined(USE_HAL_SMBUS_MODULE) && (USE_HAL_SMBUS_MODULE==1U)
#include "stm32u5xx_hal_smbus.h"
#endif /* USE_HAL_SMBUS_MODULE==1U */

#if defined(USE_HAL_SPI_MODULE) && (USE_HAL_SPI_MODULE==1U)
#include "stm32u5xx_hal_spi.h"
#endif /* USE_HAL_SPI_MODULE==1U */

#if defined(USE_HAL_TIM_MODULE) && (USE_HAL_TIM_MODULE==1U)
#include "stm32u5xx_hal_tim.h"
#endif /* USE_HAL_TIM_MODULE==1U */

#if defined(USE_HAL_TSC_MODULE) && (USE_HAL_TSC_MODULE==1U)
#include "stm32u5xx_hal_tsc.h"
#endif /* USE_HAL_TSC_MODULE==1U */

#if defined(USE_HAL_UART_MODULE) && (USE_HAL_UART_MODULE==1U)
#include "stm32u5xx_hal_uart.h"
#endif /* USE_HAL_UART_MODULE==1U */

#if defined(USE_HAL_USART_MODULE) && (USE_HAL_USART_MODULE==1U)
#include "stm32u5xx_hal_usart.h"
#endif /* USE_HAL_USART_MODULE==1U */

#if defined(USE_HAL_IRDA_MODULE) && (USE_HAL_IRDA_MODULE==1U)
#include "stm32u5xx_hal_irda.h"
#endif /* USE_HAL_IRDA_MODULE==1U */

#if defined(USE_HAL_SMARTCARD_MODULE) && (USE_HAL_SMARTCARD_MODULE==1U)
#include "stm32u5xx_hal_smartcard.h"
#endif /* USE_HAL_SMARTCARD_MODULE==1U */

#if defined(USE_HAL_WWDG_MODULE) && (USE_HAL_WWDG_MODULE==1U)
#include "stm32u5xx_hal_wwdg.h"
#endif /* USE_HAL_WWDG_MODULE==1U */

#if defined(USE_HAL_PCD_MODULE) && (USE_HAL_PCD_MODULE==1U)
#include "stm32u5xx_hal_pcd.h"
#endif /* USE_HAL_PCD_MODULE==1U */

#if defined(USE_HAL_HCD_MODULE) && (USE_HAL_HCD_MODULE==1U)
#include "stm32u5xx_hal_hcd.h"
#endif /* USE_HAL_HCD_MODULE==1U */

#if defined(USE_HAL_CORDIC_MODULE) && (USE_HAL_CORDIC_MODULE==1U)
#include "stm32u5xx_hal_cordic.h"
#endif /* USE_HAL_CORDIC_MODULE==1U */

#if defined(USE_HAL_DCMI_MODULE) && (USE_HAL_DCMI_MODULE==1U)
#include "stm32u5xx_hal_dcmi.h"
#endif /* USE_HAL_DCMI_MODULE==1U */

#if defined(USE_HAL_EXTI_MODULE) && (USE_HAL_EXTI_MODULE==1U)
#include "stm32u5xx_hal_exti.h"
#endif /* USE_HAL_EXTI_MODULE==1U */

#if defined(USE_HAL_FDCAN_MODULE) && (USE_HAL_FDCAN_MODULE==1U)
#include "stm32u5xx_hal_fdcan.h"
#endif /* USE_HAL_FDCAN_MODULE==1U */

#if defined(USE_HAL_FMAC_MODULE) && (USE_HAL_FMAC_MODULE==1U)
#include "stm32u5xx_hal_fmac.h"
#endif /* USE_HAL_FMAC_MODULE==1U */

#if defined(USE_HAL_OTFDEC_MODULE) && (USE_HAL_OTFDEC_MODULE==1U)
#include "stm32u5xx_hal_otfdec.h"
#endif /* USE_HAL_OTFDEC_MODULE==1U */

#if defined(USE_HAL_PSSI_MODULE) && (USE_HAL_PSSI_MODULE==1U)
#include "stm32u5xx_hal_pssi.h"
#endif /* USE_HAL_PSSI_MODULE==1U */

#if defined(USE_HAL_RAMCFG_MODULE) && (USE_HAL_RAMCFG_MODULE==1U)
#include "stm32u5xx_hal_ramcfg.h"
#endif /* USE_HAL_RAMCFG_MODULE==1U */

#if defined(USE_HAL_MDF_MODULE) && (USE_HAL_MDF_MODULE==1U)
#include "stm32u5xx_hal_mdf.h"
#endif /* USE_HAL_MDF_MODULE==1U */
...
/** @brief  Floating Point Unit interrupt enable/disable macros
  ...
  */
#define __HAL_SYSCFG_FPU_INTERRUPT_ENABLE(__INTERRUPT__)  do {                                                        \
                                                           ASSERT_DBG_PARAM(IS_SYSCFG_FPU_INTERRUPT((__INTERRUPT__)));\
                                                           SET_BIT(SYSCFG->FPUIMR, (__INTERRUPT__));                  \
                                                          } while(0)

#define __HAL_SYSCFG_FPU_INTERRUPT_DISABLE(__INTERRUPT__) do {                                                        \
                                                           ASSERT_DBG_PARAM(IS_SYSCFG_FPU_INTERRUPT((__INTERRUPT__)));\
...
#define __HAL_SYSCFG_FASTMODEPLUS_ENABLE(__FASTMODEPLUS__) \
  do {ASSERT_DBG_PARAM(IS_SYSCFG_FASTMODEPLUS((__FASTMODEPLUS__)));\
...
hal_status_t HAL_InitTick(uint32_t TickPriority);
...
hal_status_t HAL_SetTickFreq(HAL_TickFreqTypeDef Freq);
...
hal_status_t HAL_SYSCFG_EnableVREFBUF(void);
...
hal_status_t HAL_SYSCFG_GetLock(uint32_t *pItem);
...
hal_status_t HAL_SYSCFG_GetConfigAttributes(uint32_t Item, uint32_t *pAttributes);
