...
/** @brief  Macro to configure the CLK48 source (CLK48CLK).
  ...
  *          This parameter can be one of the following values:
  *            @arg RCC_ICLK_CLKSOURCE_HSI48: HSI48 selected as CLK48 source
  *            @arg RCC_ICLK_CLKSOURCE_PLL2 : PLL2 selected as CLK48 source
  *            @arg RCC_ICLK_CLKSOURCE_PLL1 : PLL1 selected as CLK48 source
  *            @arg RCC_ICLK_CLKSOURCE_MSIK  : MSIK selected as CLK48 source
  */
...
/** @brief  macro to get the CLK48 source.
  * @retval The clock source can be one of the following values:
  *            @arg RCC_ICLK_CLKSOURCE_HSI48: HSI48 used as CLK48 source
  *            @arg RCC_ICLK_CLKSOURCE_PLL2 : PLL2 used as CLK48 source
  *            @arg RCC_ICLK_CLKSOURCE_PLL1 : PLL1 used as CLK48 source
  *            @arg RCC_ICLK_CLKSOURCE_MSIK  : MSIK used as CLK48 source
  */
