...
/** @addtogroup RNGEx_Exported_Functions_Group1
  * @{
  */
hal_status_t HAL_RNGEx_SetConfig(RNG_HandleTypeDef *hrng, RNG_ConfigTypeDef *pConf);
hal_status_t HAL_RNGEx_GetConfig(RNG_HandleTypeDef *hrng, RNG_ConfigTypeDef *pConf);
hal_status_t HAL_RNGEx_LockConfig(RNG_HandleTypeDef *hrng);
...
/** @addtogroup RNGEx_Exported_Functions_Group2
  * @{
  */
hal_status_t HAL_RNGEx_RecoverSeedError(RNG_HandleTypeDef *hrng);
