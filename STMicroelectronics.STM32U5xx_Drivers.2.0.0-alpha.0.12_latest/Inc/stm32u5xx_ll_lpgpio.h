...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPGPIO_SetPinMode(gpio_t *LPGPIOx, uint32_t Pin, uint32_t Mode)
{
...
/**
  ...
  *         @arg @ref LL_LPGPIO_MODE_OUTPUT
  */
__STATIC_INLINE uint32_t LL_LPGPIO_GetPinMode(gpio_t *LPGPIOx, uint32_t Pin)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_LPGPIO_ReadInputPort(gpio_t *LPGPIOx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_LPGPIO_IsInputPinSet(gpio_t *LPGPIOx, uint32_t PinMask)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPGPIO_WriteOutputPort(gpio_t *LPGPIOx, uint32_t PortValue)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_LPGPIO_ReadOutputPort(gpio_t *LPGPIOx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_LPGPIO_IsOutputPinSet(gpio_t *LPGPIOx, uint32_t PinMask)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPGPIO_SetOutputPin(gpio_t *LPGPIOx, uint32_t PinMask)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPGPIO_ResetOutputPin(gpio_t *LPGPIOx, uint32_t PinMask)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_LPGPIO_TogglePin(gpio_t *LPGPIOx, uint32_t PinMask)
{
...
ErrorStatus LL_LPGPIO_DeInit(gpio_t *LPGPIOx);
ErrorStatus LL_LPGPIO_Init(gpio_t *LPGPIOx, const LL_LPGPIO_InitTypeDef *const LPGPIO_InitStruct);
