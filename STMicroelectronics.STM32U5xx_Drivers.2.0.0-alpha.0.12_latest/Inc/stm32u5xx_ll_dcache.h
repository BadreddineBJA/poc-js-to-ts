...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_Enable(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_Disable(dcache_t *DCACHEx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_DCACHE_IsEnabled(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_SetStartAddress(dcache_t *DCACHEx, uint32_t addr)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_DCACHE_GetStartAddress(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_SetEndAddress(dcache_t *DCACHEx, uint32_t addr)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_DCACHE_GetEndAddress(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_SetCommand(dcache_t *DCACHEx, uint32_t Command)
{
  /* Set dcache command */
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_DCACHE_GetCommand(dcache_t *DCACHEx)
{
  /*Get Dcache Command */
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_StartCommand(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_SetReadBurstType(dcache_t *DCACHEx, uint32_t ReadBurstType)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_DCACHE_GetReadBurstType(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_Invalidate(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_EnableMonitors(dcache_t *DCACHEx, uint32_t Monitors)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_DisableMonitors(dcache_t *DCACHEx, uint32_t Monitors)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_DCACHE_IsEnabledMonitors(dcache_t *DCACHEx, uint32_t Monitors)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_ResetMonitors(dcache_t *DCACHEx, uint32_t Monitors)
{
  /* Reset */
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_DCACHE_Monitor_GetReadHitValue(dcache_t *DCACHEx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_DCACHE_Monitor_GetReadMissValue(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval Value between Min_Data=0 and Max_Data=0xFFFFFFFF
  */
__STATIC_INLINE uint32_t LL_DCACHE_Monitor_GetWriteHitValue(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval Value between Min_Data=0 and Max_Data=0xFFFF
  */
__STATIC_INLINE uint32_t LL_DCACHE_Monitor_GetWriteMissValue(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_EnableIT_BSYEND(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_DisableIT_BSYEND(dcache_t *DCACHEx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_DCACHE_IsEnabledIT_BSYEND(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_EnableIT_ERR(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_DisableIT_ERR(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DCACHE_IsEnabledIT_ERR(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_EnableIT_CMDEND(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_DisableIT_CMDEND(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DCACHE_IsEnabledIT_CMDEND(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_ClearFlag_BSYEND(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_ClearFlag_ERR(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_DCACHE_ClearFlag_CMDEND(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DCACHE_IsActiveFlag_BUSY(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DCACHE_IsActiveFlag_BSYEND(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DCACHE_IsActiveFlag_ERR(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DCACHE_IsActiveFlag_BUSYCMD(dcache_t *DCACHEx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_DCACHE_IsActiveFlag_CMDEND(dcache_t *DCACHEx)
{
