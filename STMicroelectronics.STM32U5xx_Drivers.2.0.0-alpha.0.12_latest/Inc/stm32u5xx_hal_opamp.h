...
#endif /* USE_HAL_OPAMP_REGISTER_CALLBACKS */
{
  ...
  hal_status_t   Status;                         /*!< OPAMP peripheral status                 */
...
hal_status_t HAL_OPAMP_Init(OPAMP_HandleTypeDef *hopamp);
hal_status_t HAL_OPAMP_DeInit(OPAMP_HandleTypeDef *hopamp);
...
hal_status_t HAL_OPAMP_Start(OPAMP_HandleTypeDef *hopamp);
hal_status_t HAL_OPAMP_Stop(OPAMP_HandleTypeDef *hopamp);
hal_status_t HAL_OPAMP_SelfCalibrate(OPAMP_HandleTypeDef *hopamp);
...
hal_status_t HAL_OPAMP_Lock(OPAMP_HandleTypeDef *hopamp);
...
#if (USE_HAL_OPAMP_REGISTER_CALLBACKS == 1)
hal_status_t HAL_OPAMP_RegisterCallback(OPAMP_HandleTypeDef *hopamp, HAL_OPAMP_CallbackIDTypeDef CallbackID,
                                        pOPAMP_CallbackTypeDef pCallback);
hal_status_t HAL_OPAMP_UnRegisterCallback(OPAMP_HandleTypeDef *hopamp, HAL_OPAMP_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_OPAMP_REGISTER_CALLBACKS */
