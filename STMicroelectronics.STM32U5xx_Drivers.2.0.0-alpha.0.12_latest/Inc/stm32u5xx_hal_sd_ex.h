...
/** @defgroup SDEx_Exported_Functions_Group1 Linked List functions
  * @{
  */
hal_status_t HAL_SDEx_DMALinkedList_ReadBlocks(SD_HandleTypeDef *hsd, SD_DMALinkedListTypeDef *pLinkedList,
                                               uint32_t BlockAdd, uint32_t NumberOfBlocks);
hal_status_t HAL_SDEx_DMALinkedList_WriteBlocks(SD_HandleTypeDef *hsd, SD_DMALinkedListTypeDef *pLinkedList,
                                                uint32_t BlockAdd, uint32_t NumberOfBlocks);
