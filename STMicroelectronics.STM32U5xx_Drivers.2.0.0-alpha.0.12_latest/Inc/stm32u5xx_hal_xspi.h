...
hal_status_t     HAL_XSPI_Command(XSPI_HandleTypeDef *hxspi, XSPI_RegularCmdTypeDef *const pCmd,
                                  uint32_t Timeout);
...
hal_status_t      HAL_XSPI_DLYB_GetClockPeriod(XSPI_HandleTypeDef *hxspi,
