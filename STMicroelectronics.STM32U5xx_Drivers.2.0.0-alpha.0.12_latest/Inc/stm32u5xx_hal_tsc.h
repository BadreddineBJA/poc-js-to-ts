...
hal_status_t HAL_TSC_Init(TSC_HandleTypeDef *htsc);
hal_status_t HAL_TSC_DeInit(TSC_HandleTypeDef *htsc);
void HAL_TSC_MspInit(TSC_HandleTypeDef *htsc);
void HAL_TSC_MspDeInit(TSC_HandleTypeDef *htsc);

/* Callbacks Register/UnRegister functions  ***********************************/
#if (USE_HAL_TSC_REGISTER_CALLBACKS == 1)
hal_status_t HAL_TSC_RegisterCallback(TSC_HandleTypeDef *htsc, HAL_TSC_CallbackIDTypeDef CallbackID,
                                      pTSC_CallbackTypeDef pCallback);
hal_status_t HAL_TSC_UnRegisterCallback(TSC_HandleTypeDef *htsc, HAL_TSC_CallbackIDTypeDef CallbackID);
#endif /* USE_HAL_TSC_REGISTER_CALLBACKS */
/**
  * @}
  */
...
hal_status_t HAL_TSC_Start(TSC_HandleTypeDef *htsc);
hal_status_t HAL_TSC_Start_IT(TSC_HandleTypeDef *htsc);
hal_status_t HAL_TSC_Stop(TSC_HandleTypeDef *htsc);
hal_status_t HAL_TSC_Stop_IT(TSC_HandleTypeDef *htsc);
hal_status_t HAL_TSC_PollForAcquisition(TSC_HandleTypeDef *htsc);
...
hal_status_t HAL_TSC_IOConfig(TSC_HandleTypeDef *htsc, TSC_IOConfigTypeDef *config);
hal_status_t HAL_TSC_IODischarge(TSC_HandleTypeDef *htsc, FunctionalState choice);
/**
  * @}
  */
