...
{
  dma_channel_t       *Instance;                             /*!< Register the DMA channel base address   */
...
/** @defgroup DMA_Exported_Functions_Group4 DMA Attributes Functions
  ...
  * @{
  */
hal_status_t HAL_DMA_ConfigChannelAttributes(DMA_HandleTypeDef *const hdma,
...
hal_status_t HAL_DMA_GetLockChannelAttributes(DMA_HandleTypeDef const *const hdma,
...
#define GET_DMA_INSTANCE(__HANDLE__) \
  ((dma_t *)((uint32_t)((__HANDLE__)->Instance) & (~HAL_DMA_OFFSET_MASK)))
