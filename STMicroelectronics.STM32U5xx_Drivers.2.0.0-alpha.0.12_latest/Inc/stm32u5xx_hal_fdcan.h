...
hal_status_t HAL_FDCAN_Init(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_DeInit(FDCAN_HandleTypeDef *hfdcan);
void              HAL_FDCAN_MspInit(FDCAN_HandleTypeDef *hfdcan);
void              HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_EnterPowerDownMode(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_ExitPowerDownMode(FDCAN_HandleTypeDef *hfdcan);

#if USE_HAL_FDCAN_REGISTER_CALLBACKS == 1
/* Callbacks Register/UnRegister functions  ***********************************/
hal_status_t HAL_FDCAN_RegisterCallback(FDCAN_HandleTypeDef *hfdcan, HAL_FDCAN_CallbackIDTypeDef CallbackID,
                                        pFDCAN_CallbackTypeDef pCallback);
hal_status_t HAL_FDCAN_UnRegisterCallback(FDCAN_HandleTypeDef *hfdcan, HAL_FDCAN_CallbackIDTypeDef CallbackID);
hal_status_t HAL_FDCAN_RegisterTxEventFifoCallback(FDCAN_HandleTypeDef *hfdcan,
                                                   pFDCAN_TxEventFifoCallbackTypeDef pCallback);
hal_status_t HAL_FDCAN_UnRegisterTxEventFifoCallback(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_RegisterRxFifo0Callback(FDCAN_HandleTypeDef *hfdcan,
                                               pFDCAN_RxFifo0CallbackTypeDef pCallback);
hal_status_t HAL_FDCAN_UnRegisterRxFifo0Callback(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_RegisterRxFifo1Callback(FDCAN_HandleTypeDef *hfdcan,
                                               pFDCAN_RxFifo1CallbackTypeDef pCallback);
hal_status_t HAL_FDCAN_UnRegisterRxFifo1Callback(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_RegisterTxBufferCompleteCallback(FDCAN_HandleTypeDef *hfdcan,
                                                        pFDCAN_TxBufferCompleteCallbackTypeDef pCallback);
hal_status_t HAL_FDCAN_UnRegisterTxBufferCompleteCallback(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_RegisterTxBufferAbortCallback(FDCAN_HandleTypeDef *hfdcan,
                                                     pFDCAN_TxBufferAbortCallbackTypeDef pCallback);
hal_status_t HAL_FDCAN_UnRegisterTxBufferAbortCallback(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_RegisterErrorStatusCallback(FDCAN_HandleTypeDef *hfdcan,
                                                   pFDCAN_ErrorStatusCallbackTypeDef pCallback);
hal_status_t HAL_FDCAN_UnRegisterErrorStatusCallback(FDCAN_HandleTypeDef *hfdcan);
#endif /* USE_HAL_FDCAN_REGISTER_CALLBACKS */
/**
  * @}
  */
...
hal_status_t HAL_FDCAN_ConfigFilter(FDCAN_HandleTypeDef *hfdcan, FDCAN_FilterTypeDef *sFilterConfig);
hal_status_t HAL_FDCAN_ConfigGlobalFilter(FDCAN_HandleTypeDef *hfdcan, uint32_t NonMatchingStd,
                                          uint32_t NonMatchingExt, uint32_t RejectRemoteStd,
                                          uint32_t RejectRemoteExt);
hal_status_t HAL_FDCAN_ConfigExtendedIdMask(FDCAN_HandleTypeDef *hfdcan, uint32_t Mask);
hal_status_t HAL_FDCAN_ConfigRxFifoOverwrite(FDCAN_HandleTypeDef *hfdcan, uint32_t RxFifo, uint32_t OperationMode);
hal_status_t HAL_FDCAN_ConfigRamWatchdog(FDCAN_HandleTypeDef *hfdcan, uint32_t CounterStartValue);
hal_status_t HAL_FDCAN_ConfigTimestampCounter(FDCAN_HandleTypeDef *hfdcan, uint32_t TimestampPrescaler);
hal_status_t HAL_FDCAN_EnableTimestampCounter(FDCAN_HandleTypeDef *hfdcan, uint32_t TimestampOperation);
hal_status_t HAL_FDCAN_DisableTimestampCounter(FDCAN_HandleTypeDef *hfdcan);
uint16_t          HAL_FDCAN_GetTimestampCounter(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_ResetTimestampCounter(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_ConfigTimeoutCounter(FDCAN_HandleTypeDef *hfdcan, uint32_t TimeoutOperation,
                                            uint32_t TimeoutPeriod);
hal_status_t HAL_FDCAN_EnableTimeoutCounter(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_DisableTimeoutCounter(FDCAN_HandleTypeDef *hfdcan);
uint16_t          HAL_FDCAN_GetTimeoutCounter(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_ResetTimeoutCounter(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_ConfigTxDelayCompensation(FDCAN_HandleTypeDef *hfdcan, uint32_t TdcOffset,
                                                 uint32_t TdcFilter);
hal_status_t HAL_FDCAN_EnableTxDelayCompensation(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_DisableTxDelayCompensation(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_EnableISOMode(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_DisableISOMode(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_EnableEdgeFiltering(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_DisableEdgeFiltering(FDCAN_HandleTypeDef *hfdcan);
/**
  * @}
  */
...
/** @addtogroup FDCAN_Exported_Functions_Group3
  ...
  */
/* Control functions **********************************************************/
hal_status_t HAL_FDCAN_Start(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_Stop(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_AddMessageToTxFifoQ(FDCAN_HandleTypeDef *hfdcan, FDCAN_TxHeaderTypeDef *pTxHeader,
                                           uint8_t *pTxData);
uint32_t HAL_FDCAN_GetLatestTxFifoQRequestBuffer(FDCAN_HandleTypeDef *hfdcan);
hal_status_t HAL_FDCAN_AbortTxRequest(FDCAN_HandleTypeDef *hfdcan, uint32_t BufferIndex);
hal_status_t HAL_FDCAN_GetRxMessage(FDCAN_HandleTypeDef *hfdcan, uint32_t RxLocation,
                                    FDCAN_RxHeaderTypeDef *pRxHeader, uint8_t *pRxData);
hal_status_t HAL_FDCAN_GetTxEvent(FDCAN_HandleTypeDef *hfdcan, FDCAN_TxEventFifoTypeDef *pTxEvent);
hal_status_t HAL_FDCAN_GetHighPriorityMessageStatus(FDCAN_HandleTypeDef *hfdcan,
                                                    FDCAN_HpMsgStatusTypeDef *HpMsgStatus);
hal_status_t HAL_FDCAN_GetProtocolStatus(FDCAN_HandleTypeDef *hfdcan, FDCAN_ProtocolStatusTypeDef *ProtocolStatus);
hal_status_t HAL_FDCAN_GetErrorCounters(FDCAN_HandleTypeDef *hfdcan, FDCAN_ErrorCountersTypeDef *ErrorCounters);
...
hal_status_t HAL_FDCAN_ExitRestrictedOperationMode(FDCAN_HandleTypeDef *hfdcan);
/**
  * @}
  */
...
hal_status_t HAL_FDCAN_ConfigInterruptLines(FDCAN_HandleTypeDef *hfdcan, uint32_t ITList, uint32_t InterruptLine);
hal_status_t HAL_FDCAN_ActivateNotification(FDCAN_HandleTypeDef *hfdcan, uint32_t ActiveITs,
                                            uint32_t BufferIndexes);
hal_status_t HAL_FDCAN_DeactivateNotification(FDCAN_HandleTypeDef *hfdcan, uint32_t InactiveITs);
