...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_SetPinMode(gpio_t *GPIOx, uint32_t Pin, uint32_t Mode)
{
...
/**
  ...
  *         @arg @ref LL_GPIO_MODE_ANALOG
  */
__STATIC_INLINE uint32_t LL_GPIO_GetPinMode(gpio_t *GPIOx, uint32_t Pin)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_SetPinOutputType(gpio_t *GPIOx, uint32_t PinMask, uint32_t OutputType)
{
...
/**
  ...
  *         @arg @ref LL_GPIO_OUTPUT_OPENDRAIN
  */
__STATIC_INLINE uint32_t LL_GPIO_GetPinOutputType(gpio_t *GPIOx, uint32_t Pin)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_SetPinSpeed(gpio_t *GPIOx, uint32_t Pin, uint32_t  Speed)
{
...
/**
  ...
  *         @arg @ref LL_GPIO_SPEED_FREQ_VERY_HIGH
  */
__STATIC_INLINE uint32_t LL_GPIO_GetPinSpeed(gpio_t *GPIOx, uint32_t Pin)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_SetPinPull(gpio_t *GPIOx, uint32_t Pin, uint32_t Pull)
{
...
/**
  ...
  *         @arg @ref LL_GPIO_PULL_DOWN
  */
__STATIC_INLINE uint32_t LL_GPIO_GetPinPull(gpio_t *GPIOx, uint32_t Pin)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_SetAFPin_0_7(gpio_t *GPIOx, uint32_t Pin, uint32_t Alternate)
{
...
/**
  ...
  *         @arg @ref LL_GPIO_AF_15
  */
__STATIC_INLINE uint32_t LL_GPIO_GetAFPin_0_7(gpio_t *GPIOx, uint32_t Pin)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_SetAFPin_8_15(gpio_t *GPIOx, uint32_t Pin, uint32_t Alternate)
{
...
/**
  ...
  *         @arg @ref LL_GPIO_AF_15
  */
__STATIC_INLINE uint32_t LL_GPIO_GetAFPin_8_15(gpio_t *GPIOx, uint32_t Pin)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_LockPin(gpio_t *GPIOx, uint32_t PinMask)
{
  __IO uint32_t temp;
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_GPIO_IsPinLocked(gpio_t *GPIOx, uint32_t PinMask)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_GPIO_IsAnyPinLocked(gpio_t *GPIOx)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_GPIO_ReadInputPort(gpio_t *GPIOx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_GPIO_IsInputPinSet(gpio_t *GPIOx, uint32_t PinMask)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_WriteOutputPort(gpio_t *GPIOx, uint32_t PortValue)
{
...
/**
  ...
  */
__STATIC_INLINE uint32_t LL_GPIO_ReadOutputPort(gpio_t *GPIOx)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_GPIO_IsOutputPinSet(gpio_t *GPIOx, uint32_t PinMask)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_SetOutputPin(gpio_t *GPIOx, uint32_t PinMask)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_ResetOutputPin(gpio_t *GPIOx, uint32_t PinMask)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_TogglePin(gpio_t *GPIOx, uint32_t PinMask)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_EnableHighSPeedLowVoltage(gpio_t *GPIOx, uint32_t PinMask)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_DisableHighSPeedLowVoltage(gpio_t *GPIOx, uint32_t PinMask)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_GPIO_IsEnabledHighSPeedLowVoltage(gpio_t *GPIOx, uint32_t PinMask)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_EnablePinSecure(gpio_t *GPIOx, uint32_t PinMask)
{
...
/**
  ...
  * @retval None
  */
__STATIC_INLINE void LL_GPIO_DisablePinSecure(gpio_t *GPIOx, uint32_t PinMask)
{
...
/**
  ...
  * @retval State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t LL_GPIO_IsEnabledPinSecure(gpio_t *GPIOx, uint32_t PinMask)
{
...
ErrorStatus LL_GPIO_DeInit(gpio_t *GPIOx);
ErrorStatus LL_GPIO_Init(gpio_t *GPIOx, LL_GPIO_InitTypeDef *GPIO_InitStruct);
