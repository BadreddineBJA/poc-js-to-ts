/**
  ...
  * @brief   Header file of STM32 HAL OS: implementation for  for AZURE OS.
  ******************************************************************************
  * @attention
  *
...
#define HAL_OS_TIMEOUT_FOREVER TX_WAIT_FOREVER
...
typedef TX_SEMAPHORE hal_os_semaphore_t;
typedef TX_MUTEX     hal_os_mutex_t;
