/**
  ...
  * @brief   Header file of STM32 HAL OS: implementation for  for CMSIS OS.
  ******************************************************************************
  * @attention
  *
...
#define HAL_OS_TIMEOUT_FOREVER osWaitForever
...
typedef osSemaphoreId_t hal_os_semaphore_t;
typedef osMutexId_t     hal_os_mutex_t;
