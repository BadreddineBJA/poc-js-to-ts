...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GTZC_TZSC_ConfigPeriphAttributes(uint32_t PeriphId,
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GTZC_TZSC_GetConfigPeriphAttributes(uint32_t PeriphId,
                                                     uint32_t *PeriphAttributes)
{
  uint32_t i;
  uint32_t reg_value;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GTZC_TZSC_MPCWM_ConfigMemAttributes(uint32_t MemBaseAddress,
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GTZC_TZSC_MPCWM_GetConfigMemAttributes(uint32_t MemBaseAddress,
...
/**
  ...
  */
void HAL_GTZC_TZSC_Lock(gtzc_tzsc_t *TZSC_Instance)
{
...
/**
  ...
  */
uint32_t HAL_GTZC_TZSC_GetLock(const gtzc_tzsc_t *TZSC_Instance)
{
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GTZC_MPCBB_ConfigMem(uint32_t MemBaseAddress,
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GTZC_MPCBB_GetConfigMem(uint32_t MemBaseAddress,
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GTZC_MPCBB_ConfigMemAttributes(uint32_t MemAddress,
                                                uint32_t NbBlocks,
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GTZC_MPCBB_GetConfigMemAttributes(uint32_t MemAddress,
                                                   uint32_t NbBlocks,
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GTZC_MPCBB_LockConfig(uint32_t MemAddress,
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GTZC_MPCBB_GetLockConfig(uint32_t MemAddress,
                                          uint32_t NbSuperBlocks,
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GTZC_MPCBB_Lock(uint32_t MemBaseAddress)
{
  /* check entry parameters */
  if (IS_GTZC_BASE_ADDRESS(SRAM1, MemBaseAddress))
  {
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GTZC_MPCBB_GetLock(uint32_t MemBaseAddress,
                                    uint32_t *pLockState)
{
  /* check entry parameters */
  if (IS_GTZC_BASE_ADDRESS(SRAM1, MemBaseAddress))
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GTZC_TZIC_DisableIT(uint32_t PeriphId)
{
  uint32_t register_address;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GTZC_TZIC_EnableIT(uint32_t PeriphId)
{
  uint32_t register_address;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_GTZC_TZIC_GetFlag(uint32_t PeriphId, uint32_t *pFlag)
{
  uint32_t i;
  uint32_t reg_value;
  uint32_t register_address;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GTZC_TZIC_ClearFlag(uint32_t PeriphId)
{
  uint32_t register_address;
