...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_Init(DMA_HandleTypeDef *const hdma)
{
  /* Get tick number */
  ...
  ASSERT_DBG_PARAM(IS_DMA_ALL_INSTANCE(hdma->Instance));
  ASSERT_DBG_PARAM(IS_DMA_PRIORITY(hdma->InitLinkedList.Priority));
  ASSERT_DBG_PARAM(IS_DMA_LINK_STEP_MODE(hdma->InitLinkedList.LinkStepMode));
  ASSERT_DBG_PARAM(IS_DMA_TCEM_LINKEDLIST_EVENT_MODE(hdma->InitLinkedList.TransferEventMode));
  ASSERT_DBG_PARAM(IS_DMA_LINKEDLIST_MODE(hdma->InitLinkedList.LinkedListMode));
  /* Check DMA channel instance */
  if (IS_GPDMA_INSTANCE(hdma->Instance) != 0U)
  {
    ASSERT_DBG_PARAM(IS_DMA_LINK_ALLOCATED_PORT(hdma->InitLinkedList.LinkAllocatedPort));
  }
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_DeInit(DMA_HandleTypeDef *const hdma)
{
  /* Get DMA instance */
  dma_t *p_dma_instance;
  /* Get tick number */
  uint32_t tickstart = HAL_GetTick();
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_Start(DMA_HandleTypeDef *const hdma)
{
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_Start_IT(DMA_HandleTypeDef *const hdma)
{
  HAL_DMA_StateTypeDef dma_state;
  uint32_t ccr_value;
  uint32_t cllr_mask;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_BuildNode(DMA_NodeConfTypeDef const *const pNodeConfig,
                                           DMA_NodeTypeDef *const pNode)
{
  ...
  ASSERT_DBG_PARAM(IS_DMA_NODE_TYPE(pNodeConfig->NodeType));

  /* Check DMA channel basic transfer parameters */
  ASSERT_DBG_PARAM(IS_DMA_SOURCE_INC(pNodeConfig->Init.SrcInc));
  ASSERT_DBG_PARAM(IS_DMA_DESTINATION_INC(pNodeConfig->Init.DestInc));
  ASSERT_DBG_PARAM(IS_DMA_SOURCE_DATA_WIDTH(pNodeConfig->Init.SrcDataWidth));
  ASSERT_DBG_PARAM(IS_DMA_DESTINATION_DATA_WIDTH(pNodeConfig->Init.DestDataWidth));
  ASSERT_DBG_PARAM(IS_DMA_DATA_ALIGNMENT(pNodeConfig->DataHandlingConfig.DataAlignment));
  ASSERT_DBG_PARAM(IS_DMA_REQUEST(pNodeConfig->Init.Request));
  ASSERT_DBG_PARAM(IS_DMA_DIRECTION(pNodeConfig->Init.Direction));
  ASSERT_DBG_PARAM(IS_DMA_TCEM_EVENT_MODE(pNodeConfig->Init.TransferEventMode));
  ASSERT_DBG_PARAM(IS_DMA_BLOCK_HW_REQUEST(pNodeConfig->Init.BlkHWRequest));

  /* Check DMA channel parameters */
  if ((pNodeConfig->NodeType & DMA_CHANNEL_TYPE_GPDMA) == DMA_CHANNEL_TYPE_GPDMA)
  {
    ASSERT_DBG_PARAM(IS_DMA_BURST_LENGTH(pNodeConfig->Init.SrcBurstLength));
    ASSERT_DBG_PARAM(IS_DMA_BURST_LENGTH(pNodeConfig->Init.DestBurstLength));
    ASSERT_DBG_PARAM(IS_DMA_DATA_EXCHANGE(pNodeConfig->DataHandlingConfig.DataExchange));
    ASSERT_DBG_PARAM(IS_DMA_TRANSFER_ALLOCATED_PORT(pNodeConfig->Init.TransferAllocatedPort));
  }

  /* Check DMA channel trigger parameters */
  ASSERT_DBG_PARAM(IS_DMA_TRIGGER_POLARITY(pNodeConfig->TriggerConfig.TriggerPolarity));
  if (pNodeConfig->TriggerConfig.TriggerPolarity != DMA_TRIG_POLARITY_MASKED)
  {
    ASSERT_DBG_PARAM(IS_DMA_TRIGGER_MODE(pNodeConfig->TriggerConfig.TriggerMode));
    ASSERT_DBG_PARAM(IS_DMA_TRIGGER_SELECTION(pNodeConfig->TriggerConfig.TriggerSelection));
  }

  /* Check DMA channel repeated block parameters */
  if ((pNodeConfig->NodeType & DMA_CHANNEL_TYPE_2D_ADDR) == DMA_CHANNEL_TYPE_2D_ADDR)
  {
    ASSERT_DBG_PARAM(IS_DMA_REPEAT_COUNT(pNodeConfig->RepeatBlockConfig.RepeatCount));
    ASSERT_DBG_PARAM(IS_DMA_BURST_ADDR_OFFSET(pNodeConfig->RepeatBlockConfig.SrcAddrOffset));
    ASSERT_DBG_PARAM(IS_DMA_BURST_ADDR_OFFSET(pNodeConfig->RepeatBlockConfig.DestAddrOffset));
    ASSERT_DBG_PARAM(IS_DMA_BLOCK_ADDR_OFFSET(pNodeConfig->RepeatBlockConfig.BlkSrcAddrOffset));
    ASSERT_DBG_PARAM(IS_DMA_BLOCK_ADDR_OFFSET(pNodeConfig->RepeatBlockConfig.BlkDestAddrOffset));
    ASSERT_DBG_PARAM(IS_DMA_BURST_ADDR_OFFSET(pNodeConfig->RepeatBlockConfig.SrcAddrOffset));
    ASSERT_DBG_PARAM(IS_DMA_BURST_ADDR_OFFSET(pNodeConfig->RepeatBlockConfig.DestAddrOffset));
    ASSERT_DBG_PARAM(IS_DMA_BLOCK_ADDR_OFFSET(pNodeConfig->RepeatBlockConfig.BlkSrcAddrOffset));
    ASSERT_DBG_PARAM(IS_DMA_BLOCK_ADDR_OFFSET(pNodeConfig->RepeatBlockConfig.BlkDestAddrOffset));
...
#if defined (__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
  ASSERT_DBG_PARAM(IS_DMA_ATTRIBUTES(pNodeConfig->SrcSecure));
  ASSERT_DBG_PARAM(IS_DMA_ATTRIBUTES(pNodeConfig->DestSecure));
#endif /* defined (__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U) */
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_GetNodeConfig(DMA_NodeConfTypeDef *const pNodeConfig,
                                               DMA_NodeTypeDef const *const pNode)
{
  /* Check the node configuration and physical node parameters */
  if ((pNodeConfig == NULL) || (pNode == NULL))
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_InsertNode(DMA_QListTypeDef *const pQList,
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_InsertNode_Head(DMA_QListTypeDef *const pQList,
                                                 DMA_NodeTypeDef *const pNewNode)
{
  uint32_t cllr_mask;
  uint32_t cllr_offset;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_InsertNode_Tail(DMA_QListTypeDef *const pQList,
                                                 DMA_NodeTypeDef *const pNewNode)
{
  uint32_t cllr_mask;
  uint32_t cllr_offset;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_RemoveNode(DMA_QListTypeDef *const pQList,
                                            DMA_NodeTypeDef *const pNode)
{
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_RemoveNode_Head(DMA_QListTypeDef *const pQList)
{
  uint32_t cllr_offset;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_RemoveNode_Tail(DMA_QListTypeDef *const pQList)
{
  uint32_t cllr_offset;
  DMA_NodeInQInfoTypeDef node_info;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_ReplaceNode(DMA_QListTypeDef *const pQList,
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_ReplaceNode_Head(DMA_QListTypeDef *const pQList,
                                                  DMA_NodeTypeDef *const pNewNode)
{
  uint32_t cllr_offset;
  uint32_t cllr_mask;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_ReplaceNode_Tail(DMA_QListTypeDef *const pQList,
                                                  DMA_NodeTypeDef *const pNewNode)
{
  uint32_t cllr_mask;
  uint32_t cllr_offset;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_ResetQ(DMA_QListTypeDef *const pQList)
{
  uint32_t cllr_offset;
  DMA_NodeInQInfoTypeDef node_info;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_InsertQ(DMA_QListTypeDef *const pSrcQList,
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_InsertQ_Head(DMA_QListTypeDef *const pSrcQList,
                                              DMA_QListTypeDef *const pDestQList)
{
  uint32_t cllr_mask;
  uint32_t cllr_offset;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_InsertQ_Tail(DMA_QListTypeDef *const pSrcQList,
                                              DMA_QListTypeDef *const pDestQList)
{
  uint32_t cllr_mask;
  uint32_t cllr_offset;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_SetCircularModeConfig(DMA_QListTypeDef *const pQList,
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_SetCircularMode(DMA_QListTypeDef *const pQList)
{
  uint32_t cllr_mask;
  uint32_t cllr_offset;
  DMA_NodeInQInfoTypeDef node_info;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_ClearCircularMode(DMA_QListTypeDef *const pQList)
{
  uint32_t cllr_offset;
  DMA_NodeInQInfoTypeDef node_info;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_ConvertQToDynamic(DMA_QListTypeDef *const pQList)
{
  uint32_t cllr_offset;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_ConvertQToStatic(DMA_QListTypeDef *const pQList)
{
  uint32_t cllr_offset;
  uint32_t currentnode_addr;
  DMA_NodeTypeDef context_node;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_LinkQ(DMA_HandleTypeDef *const hdma,
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_List_UnLinkQ(DMA_HandleTypeDef *const hdma)
{
  HAL_DMA_StateTypeDef state;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_ConfigDataHandling(DMA_HandleTypeDef *const hdma,
                                               DMA_DataHandlingConfTypeDef const *const pConfigDataHandling)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DMA_DATA_ALIGNMENT(pConfigDataHandling->DataAlignment));
  ASSERT_DBG_PARAM(IS_DMA_DATA_EXCHANGE(pConfigDataHandling->DataExchange));
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_ConfigTrigger(DMA_HandleTypeDef *const hdma,
                                          DMA_TriggerConfTypeDef const *const pConfigTrigger)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DMA_ALL_INSTANCE(hdma->Instance));
  ASSERT_DBG_PARAM(IS_DMA_TRIGGER_POLARITY(pConfigTrigger->TriggerPolarity));
  ASSERT_DBG_PARAM(IS_DMA_TRIGGER_MODE(pConfigTrigger->TriggerMode));
  ASSERT_DBG_PARAM(IS_DMA_TRIGGER_SELECTION(pConfigTrigger->TriggerSelection));
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_ConfigRepeatBlock(DMA_HandleTypeDef *const hdma,
                                              DMA_RepeatBlockConfTypeDef const *const pConfigRepeatBlock)
{
  ...
  /* Check parameters */
  ASSERT_DBG_PARAM(IS_DMA_2D_ADDRESSING_INSTANCE(hdma->Instance));
  ASSERT_DBG_PARAM(IS_DMA_REPEAT_COUNT(pConfigRepeatBlock->RepeatCount));
  ASSERT_DBG_PARAM(IS_DMA_BURST_ADDR_OFFSET(pConfigRepeatBlock->SrcAddrOffset));
  ASSERT_DBG_PARAM(IS_DMA_BURST_ADDR_OFFSET(pConfigRepeatBlock->DestAddrOffset));
  ASSERT_DBG_PARAM(IS_DMA_BLOCK_ADDR_OFFSET(pConfigRepeatBlock->BlkSrcAddrOffset));
  ASSERT_DBG_PARAM(IS_DMA_BLOCK_ADDR_OFFSET(pConfigRepeatBlock->BlkDestAddrOffset));
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_Suspend(DMA_HandleTypeDef *const hdma)
{
  /* Get tick number */
  uint32_t tickstart = HAL_GetTick();
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_Suspend_IT(DMA_HandleTypeDef *const hdma)
{
  /* Check the DMA peripheral handle parameter */
  if (hdma == NULL)
  {
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_DMAEx_Resume(DMA_HandleTypeDef *const hdma)
{
  /* Check the DMA peripheral handle parameter */
  if (hdma == NULL)
  {
