...
ErrorStatus LL_TIM_DeInit(TIM_TypeDef *TIMx)
{
  ...
  ASSERT_DBG_PARAM(IS_TIM_INSTANCE(TIMx));
...
ErrorStatus LL_TIM_Init(TIM_TypeDef *TIMx, const LL_TIM_InitTypeDef *TIM_InitStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_INSTANCE(TIMx));
  ASSERT_DBG_PARAM(IS_LL_TIM_COUNTERMODE(TIM_InitStruct->CounterMode));
  ASSERT_DBG_PARAM(IS_LL_TIM_CLOCKDIVISION(TIM_InitStruct->ClockDivision));
...
ErrorStatus LL_TIM_ENCODER_Init(TIM_TypeDef *TIMx, const LL_TIM_ENCODER_InitTypeDef *TIM_EncoderInitStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_ENCODER_INTERFACE_INSTANCE(TIMx));
  ASSERT_DBG_PARAM(IS_LL_TIM_ENCODERMODE(TIM_EncoderInitStruct->EncoderMode));
  ASSERT_DBG_PARAM(IS_LL_TIM_IC_POLARITY_ENCODER(TIM_EncoderInitStruct->IC1Polarity));
  ASSERT_DBG_PARAM(IS_LL_TIM_ACTIVEINPUT(TIM_EncoderInitStruct->IC1ActiveInput));
  ASSERT_DBG_PARAM(IS_LL_TIM_ICPSC(TIM_EncoderInitStruct->IC1Prescaler));
  ASSERT_DBG_PARAM(IS_LL_TIM_IC_FILTER(TIM_EncoderInitStruct->IC1Filter));
  ASSERT_DBG_PARAM(IS_LL_TIM_IC_POLARITY_ENCODER(TIM_EncoderInitStruct->IC2Polarity));
  ASSERT_DBG_PARAM(IS_LL_TIM_ACTIVEINPUT(TIM_EncoderInitStruct->IC2ActiveInput));
  ASSERT_DBG_PARAM(IS_LL_TIM_ICPSC(TIM_EncoderInitStruct->IC2Prescaler));
  ASSERT_DBG_PARAM(IS_LL_TIM_IC_FILTER(TIM_EncoderInitStruct->IC2Filter));
...
ErrorStatus LL_TIM_HALLSENSOR_Init(TIM_TypeDef *TIMx, const LL_TIM_HALLSENSOR_InitTypeDef *TIM_HallSensorInitStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_HALL_SENSOR_INTERFACE_INSTANCE(TIMx));
  ASSERT_DBG_PARAM(IS_LL_TIM_IC_POLARITY_ENCODER(TIM_HallSensorInitStruct->IC1Polarity));
  ASSERT_DBG_PARAM(IS_LL_TIM_ICPSC(TIM_HallSensorInitStruct->IC1Prescaler));
  ASSERT_DBG_PARAM(IS_LL_TIM_IC_FILTER(TIM_HallSensorInitStruct->IC1Filter));
...
ErrorStatus LL_TIM_BDTR_Init(TIM_TypeDef *TIMx, const LL_TIM_BDTR_InitTypeDef *TIM_BDTRInitStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_BREAK_INSTANCE(TIMx));
  ASSERT_DBG_PARAM(IS_LL_TIM_OSSR_STATE(TIM_BDTRInitStruct->OSSRState));
  ASSERT_DBG_PARAM(IS_LL_TIM_OSSI_STATE(TIM_BDTRInitStruct->OSSIState));
  ASSERT_DBG_PARAM(IS_LL_TIM_LOCK_LEVEL(TIM_BDTRInitStruct->LockLevel));
  ASSERT_DBG_PARAM(IS_LL_TIM_BREAK_STATE(TIM_BDTRInitStruct->BreakState));
  ASSERT_DBG_PARAM(IS_LL_TIM_BREAK_POLARITY(TIM_BDTRInitStruct->BreakPolarity));
  ASSERT_DBG_PARAM(IS_LL_TIM_AUTOMATIC_OUTPUT_STATE(TIM_BDTRInitStruct->AutomaticOutput));
  ...
  {
    ASSERT_DBG_PARAM(IS_LL_TIM_BREAK_FILTER(TIM_BDTRInitStruct->BreakFilter));
    ASSERT_DBG_PARAM(IS_LL_TIM_BREAK_AFMODE(TIM_BDTRInitStruct->BreakAFMode));
  ...
  {
    ASSERT_DBG_PARAM(IS_LL_TIM_BREAK2_STATE(TIM_BDTRInitStruct->Break2State));
    ASSERT_DBG_PARAM(IS_LL_TIM_BREAK2_POLARITY(TIM_BDTRInitStruct->Break2Polarity));
    ASSERT_DBG_PARAM(IS_LL_TIM_BREAK2_FILTER(TIM_BDTRInitStruct->Break2Filter));
    ASSERT_DBG_PARAM(IS_LL_TIM_BREAK2_AFMODE(TIM_BDTRInitStruct->Break2AFMode));
...
static ErrorStatus OC1Config(TIM_TypeDef *TIMx, const LL_TIM_OC_InitTypeDef *TIM_OCInitStruct)
{
  ...
  ASSERT_DBG_PARAM(IS_LL_TIM_OCMODE(TIM_OCInitStruct->OCMode));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCSTATE(TIM_OCInitStruct->OCState));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCPOLARITY(TIM_OCInitStruct->OCPolarity));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCSTATE(TIM_OCInitStruct->OCNState));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCPOLARITY(TIM_OCInitStruct->OCNPolarity));
  ...
  {
    ASSERT_DBG_PARAM(IS_LL_TIM_OCIDLESTATE(TIM_OCInitStruct->OCNIdleState));
    ASSERT_DBG_PARAM(IS_LL_TIM_OCIDLESTATE(TIM_OCInitStruct->OCIdleState));
...
static ErrorStatus OC2Config(TIM_TypeDef *TIMx, const LL_TIM_OC_InitTypeDef *TIM_OCInitStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_CC2_INSTANCE(TIMx));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCMODE(TIM_OCInitStruct->OCMode));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCSTATE(TIM_OCInitStruct->OCState));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCPOLARITY(TIM_OCInitStruct->OCPolarity));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCSTATE(TIM_OCInitStruct->OCNState));
...
static ErrorStatus OC3Config(TIM_TypeDef *TIMx, const LL_TIM_OC_InitTypeDef *TIM_OCInitStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_CC3_INSTANCE(TIMx));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCMODE(TIM_OCInitStruct->OCMode));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCSTATE(TIM_OCInitStruct->OCState));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCPOLARITY(TIM_OCInitStruct->OCPolarity));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCSTATE(TIM_OCInitStruct->OCNState));
...
static ErrorStatus OC4Config(TIM_TypeDef *TIMx, const LL_TIM_OC_InitTypeDef *TIM_OCInitStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_CC4_INSTANCE(TIMx));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCMODE(TIM_OCInitStruct->OCMode));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCSTATE(TIM_OCInitStruct->OCState));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCPOLARITY(TIM_OCInitStruct->OCPolarity));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCPOLARITY(TIM_OCInitStruct->OCNPolarity));
...
static ErrorStatus OC5Config(TIM_TypeDef *TIMx, const LL_TIM_OC_InitTypeDef *TIM_OCInitStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_CC5_INSTANCE(TIMx));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCMODE(TIM_OCInitStruct->OCMode));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCSTATE(TIM_OCInitStruct->OCState));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCPOLARITY(TIM_OCInitStruct->OCPolarity));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCPOLARITY(TIM_OCInitStruct->OCNPolarity));
...
static ErrorStatus OC6Config(TIM_TypeDef *TIMx, const LL_TIM_OC_InitTypeDef *TIM_OCInitStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_CC6_INSTANCE(TIMx));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCMODE(TIM_OCInitStruct->OCMode));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCSTATE(TIM_OCInitStruct->OCState));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCPOLARITY(TIM_OCInitStruct->OCPolarity));
  ASSERT_DBG_PARAM(IS_LL_TIM_OCPOLARITY(TIM_OCInitStruct->OCNPolarity));
...
static ErrorStatus IC1Config(TIM_TypeDef *TIMx, const LL_TIM_IC_InitTypeDef *TIM_ICInitStruct)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_CC1_INSTANCE(TIMx));
  ASSERT_DBG_PARAM(IS_LL_TIM_IC_POLARITY(TIM_ICInitStruct->ICPolarity));
  ASSERT_DBG_PARAM(IS_LL_TIM_ACTIVEINPUT(TIM_ICInitStruct->ICActiveInput));
  ASSERT_DBG_PARAM(IS_LL_TIM_ICPSC(TIM_ICInitStruct->ICPrescaler));
  ASSERT_DBG_PARAM(IS_LL_TIM_IC_FILTER(TIM_ICInitStruct->ICFilter));
