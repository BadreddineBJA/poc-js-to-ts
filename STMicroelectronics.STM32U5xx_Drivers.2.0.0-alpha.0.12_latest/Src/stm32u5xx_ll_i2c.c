...
ErrorStatus LL_I2C_DeInit(I2C_TypeDef *I2Cx)
{
  ...
  ASSERT_DBG_PARAM(IS_I2C_ALL_INSTANCE(I2Cx));
...
ErrorStatus LL_I2C_Init(I2C_TypeDef *I2Cx, LL_I2C_InitTypeDef *I2C_InitStruct)
{
  ...
  ASSERT_DBG_PARAM(IS_LL_I2C_PERIPHERAL_MODE(I2C_InitStruct->PeripheralMode));
  ASSERT_DBG_PARAM(IS_LL_I2C_ANALOG_FILTER(I2C_InitStruct->AnalogFilter));
  ASSERT_DBG_PARAM(IS_LL_I2C_DIGITAL_FILTER(I2C_InitStruct->DigitalFilter));
  ASSERT_DBG_PARAM(IS_LL_I2C_OWN_ADDRESS1(I2C_InitStruct->OwnAddress1));
  ASSERT_DBG_PARAM(IS_LL_I2C_TYPE_ACKNOWLEDGE(I2C_InitStruct->TypeAcknowledge));
  ASSERT_DBG_PARAM(IS_LL_I2C_OWN_ADDRSIZE(I2C_InitStruct->OwnAddrSize));
