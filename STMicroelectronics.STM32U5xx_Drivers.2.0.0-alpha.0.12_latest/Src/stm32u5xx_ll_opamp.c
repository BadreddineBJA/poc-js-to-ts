...
ErrorStatus LL_OPAMP_DeInit(OPAMP_TypeDef *OPAMPx)
{
  ...
  ASSERT_DBG_PARAM(IS_OPAMP_ALL_INSTANCE(OPAMPx));
...
ErrorStatus LL_OPAMP_Init(OPAMP_TypeDef *OPAMPx, LL_OPAMP_InitTypeDef *OPAMP_InitStruct)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_OPAMP_ALL_INSTANCE(OPAMPx));
  ASSERT_DBG_PARAM(IS_LL_OPAMP_POWER_MODE(OPAMP_InitStruct->PowerMode));
  ASSERT_DBG_PARAM(IS_LL_OPAMP_FUNCTIONAL_MODE(OPAMP_InitStruct->FunctionalMode));
  ASSERT_DBG_PARAM(IS_LL_OPAMP_INPUT_NONINVERTING(OPAMPx, OPAMP_InitStruct->InputNonInverting));
  ...
  {
    ASSERT_DBG_PARAM(IS_LL_OPAMP_INPUT_INVERTING(OPAMPx, OPAMP_InitStruct->InputInverting));
  }
