                                         ...
                                         LL_UTILS_ClkInitTypeDef *UTILS_ClkInitStruct)
{
  ...
  ASSERT_DBG_PARAM(IS_LL_UTILS_HSE_FREQUENCY(HSEFrequency));
  ASSERT_DBG_PARAM(IS_LL_UTILS_HSE_BYPASS(HSEBypass));
...
static uint32_t UTILS_GetPLLOutputFrequency(uint32_t PLL_InputFrequency, LL_UTILS_PLLInitTypeDef *UTILS_PLLInitStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LL_UTILS_PLLM_VALUE(UTILS_PLLInitStruct->PLLM));
  ASSERT_DBG_PARAM(IS_LL_UTILS_PLLN_VALUE(UTILS_PLLInitStruct->PLLN));
  ASSERT_DBG_PARAM(IS_LL_UTILS_PLLR_VALUE(UTILS_PLLInitStruct->PLLR));
                                                  ...
                                                  LL_UTILS_ClkInitTypeDef *UTILS_ClkInitStruct)
{
  ...
  ASSERT_DBG_PARAM(IS_LL_UTILS_SYSCLK_DIV(UTILS_ClkInitStruct->AHBCLKDivider));
  ASSERT_DBG_PARAM(IS_LL_UTILS_APB1_DIV(UTILS_ClkInitStruct->APB1CLKDivider));
  ASSERT_DBG_PARAM(IS_LL_UTILS_APB2_DIV(UTILS_ClkInitStruct->APB2CLKDivider));
  ASSERT_DBG_PARAM(IS_LL_UTILS_APB3_DIV(UTILS_ClkInitStruct->APB3CLKDivider));
