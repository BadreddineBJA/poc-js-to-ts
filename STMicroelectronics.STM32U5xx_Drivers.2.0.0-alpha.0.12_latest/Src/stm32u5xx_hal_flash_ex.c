...
/**
  ...
  * @retval HAL Status
  */
hal_status_t HAL_FLASHEx_Erase(FLASH_EraseInitTypeDef *pEraseInit, uint32_t *PageError)
{
  hal_status_t status;
  uint32_t page_index;
...
/**
  ...
  * @retval HAL Status
  */
hal_status_t HAL_FLASHEx_OBProgram(FLASH_OBProgramInitTypeDef *pOBInit)
{
  hal_status_t status;
...
/**
  ...
  * @retval HAL Status
  */
hal_status_t HAL_FLASHEx_ConfigBBAttributes(FLASH_BBAttributesTypeDef *pBBAttributes)
{
  hal_status_t status;
  uint8_t index;
  __IO uint32_t *reg;
...
/**
  ...
  * @retval HAL Status
  */
hal_status_t HAL_FLASHEx_ConfigSecInversion(uint32_t SecInvState)
{
  hal_status_t status;
...
/**
  ...
  * @retval HAL Status
  */
hal_status_t HAL_FLASHEx_EnablePowerDown(uint32_t Banks)
{
...
/**
  ...
  * @retval HAL Status
  */
hal_status_t HAL_FLASHEx_ConfigLowPowerRead(uint32_t ConfigLPM)
{
  hal_status_t status = HAL_OK;
