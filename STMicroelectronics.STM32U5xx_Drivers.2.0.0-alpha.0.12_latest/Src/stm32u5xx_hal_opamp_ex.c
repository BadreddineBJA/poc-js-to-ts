...
hal_status_t HAL_OPAMPEx_SelfCalibrateAll(OPAMP_HandleTypeDef *hopamp1, OPAMP_HandleTypeDef *hopamp2)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_OPAMPEx_Unlock(OPAMP_HandleTypeDef *hopamp)
{
  hal_status_t status = HAL_OK;
