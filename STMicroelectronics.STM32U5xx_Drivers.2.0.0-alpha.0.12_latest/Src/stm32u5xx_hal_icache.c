...
/**
  ...
  */
hal_status_t HAL_ICACHE_ConfigAssociativityMode(uint32_t AssociativityMode)
{
...
/**
  ...
  */
hal_status_t HAL_ICACHE_DeInit(void)
{
  hal_status_t status;
...
/**
  ...
  */
hal_status_t HAL_ICACHE_Invalidate(void)
{
  hal_status_t status;
...
/**
  ...
  * @retval HAL status (HAL_OK/HAL_ERROR)
  */
hal_status_t HAL_ICACHE_Invalidate_IT(void)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status (HAL_OK/HAL_TIMEOUT)
  */
hal_status_t HAL_ICACHE_WaitForInvalidateComplete(void)
{
  hal_status_t status = HAL_OK;
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status (HAL_OK)
  */
hal_status_t HAL_ICACHE_Monitor_Start(uint32_t MonitorType)
{
  /* Check the parameters */
...
/**
  ...
  * @retval HAL status (HAL_OK)
  */
hal_status_t HAL_ICACHE_Monitor_Stop(uint32_t MonitorType)
{
  /* Check the parameters */
  assert_param(IS_ICACHE_MONITOR_TYPE(MonitorType));
...
/**
  ...
  * @retval HAL status (HAL_OK)
  */
hal_status_t HAL_ICACHE_Monitor_Reset(uint32_t MonitorType)
{
  /* Check the parameters */
  assert_param(IS_ICACHE_MONITOR_TYPE(MonitorType));
...
/**
  ...
  * @retval HAL status (HAL_OK/HAL_ERROR)
  */
hal_status_t  HAL_ICACHE_EnableRemapRegion(uint32_t Region, const ICACHE_RegionConfigTypeDef *const pRegionConfig)
{
  hal_status_t status = HAL_OK;
  __IO uint32_t *p_reg;
  uint32_t value;
...
/**
  ...
  * @retval HAL status (HAL_OK/HAL_ERROR)
  */
hal_status_t  HAL_ICACHE_DisableRemapRegion(uint32_t Region)
{
  hal_status_t status = HAL_OK;
  __IO uint32_t *p_reg;
