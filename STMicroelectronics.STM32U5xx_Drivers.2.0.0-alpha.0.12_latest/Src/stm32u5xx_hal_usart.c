...
static hal_status_t USART_WaitOnFlagUntilTimeout(USART_HandleTypeDef *husart, uint32_t Flag, FlagStatus Status,
                                                 uint32_t Tickstart, uint32_t Timeout);
static hal_status_t USART_SetConfig(USART_HandleTypeDef *husart);
static hal_status_t USART_CheckIdleState(USART_HandleTypeDef *husart);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_Init(USART_HandleTypeDef *husart)
{
  ...
  ASSERT_DBG_PARAM(IS_USART_INSTANCE(husart->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_DeInit(USART_HandleTypeDef *husart)
{
  /* Check the USART handle allocation */
  if (husart == NULL)
  {
...
/**
  ...
  * @retval HAL status
+  */
hal_status_t HAL_USART_RegisterCallback(USART_HandleTypeDef *husart, HAL_USART_CallbackIDTypeDef CallbackID,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_UnRegisterCallback(USART_HandleTypeDef *husart, HAL_USART_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_Transmit(USART_HandleTypeDef *husart, const uint8_t *pTxData, uint16_t Size,
                                uint32_t Timeout)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_Receive(USART_HandleTypeDef *husart, uint8_t *pRxData, uint16_t Size, uint32_t Timeout)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_TransmitReceive(USART_HandleTypeDef *husart, const uint8_t *pTxData, uint8_t *pRxData,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_Transmit_IT(USART_HandleTypeDef *husart, const uint8_t *pTxData, uint16_t Size)
{
  if (husart->State == HAL_USART_STATE_READY)
  {
    if ((pTxData == NULL) || (Size == 0U))
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_Receive_IT(USART_HandleTypeDef *husart, uint8_t *pRxData, uint16_t Size)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_TransmitReceive_IT(USART_HandleTypeDef *husart, const uint8_t *pTxData, uint8_t *pRxData,
                                          uint16_t Size)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_Transmit_DMA(USART_HandleTypeDef *husart, const uint8_t *pTxData, uint16_t Size)
{
  hal_status_t status = HAL_OK;
  const uint32_t *tmp;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_Receive_DMA(USART_HandleTypeDef *husart, uint8_t *pRxData, uint16_t Size)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_TransmitReceive_DMA(USART_HandleTypeDef *husart, const uint8_t *pTxData, uint8_t *pRxData,
                                           uint16_t Size)
{
  hal_status_t status;
  const uint32_t *tmp;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_DMAPause(USART_HandleTypeDef *husart)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_DMAResume(USART_HandleTypeDef *husart)
{
  const HAL_USART_StateTypeDef state = husart->State;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_DMAStop(USART_HandleTypeDef *husart)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_Abort(USART_HandleTypeDef *husart)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_USART_Abort_IT(USART_HandleTypeDef *husart)
{
...
static hal_status_t USART_SetConfig(USART_HandleTypeDef *husart)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_USART_POLARITY(husart->Init.CLKPolarity));
  ASSERT_DBG_PARAM(IS_USART_PHASE(husart->Init.CLKPhase));
  ASSERT_DBG_PARAM(IS_USART_LASTBIT(husart->Init.CLKLastBit));
  ASSERT_DBG_PARAM(IS_USART_BAUDRATE(husart->Init.BaudRate));
  ASSERT_DBG_PARAM(IS_USART_WORD_LENGTH(husart->Init.WordLength));
  ASSERT_DBG_PARAM(IS_USART_STOPBITS(husart->Init.StopBits));
  ASSERT_DBG_PARAM(IS_USART_PARITY(husart->Init.Parity));
  ASSERT_DBG_PARAM(IS_USART_MODE(husart->Init.Mode));
  ASSERT_DBG_PARAM(IS_USART_PRESCALER(husart->Init.ClockPrescaler));
