...
/**
  ...
  * @retval HAL Status.
  */
hal_status_t HAL_EXTI_SetConfigLine(EXTI_HandleTypeDef *hexti, EXTI_ConfigTypeDef *pExtiConfig)
{
  ...
  ASSERT_DBG_PARAM(IS_EXTI_LINE(pExtiConfig->Line));
  ASSERT_DBG_PARAM(IS_EXTI_MODE(pExtiConfig->Mode));
  ...
  {
    ASSERT_DBG_PARAM(IS_EXTI_TRIGGER(pExtiConfig->Trigger));
    ...
    *regaddr = regval;
    ...
    {
      ASSERT_DBG_PARAM(IS_EXTI_GPIO_PORT(pExtiConfig->GPIOSel));
      ASSERT_DBG_PARAM(IS_EXTI_GPIO_PIN(linepos));
...
/**
  ...
  * @retval HAL Status.
  */
hal_status_t HAL_EXTI_GetConfigLine(EXTI_HandleTypeDef *hexti, EXTI_ConfigTypeDef *pExtiConfig)
{
  __IO uint32_t *regaddr;
  uint32_t regval;
  uint32_t linepos;
  ...
  /* Check the parameter */
  ASSERT_DBG_PARAM(IS_EXTI_LINE(hexti->Line));
...
/**
  ...
  * @retval HAL Status.
  */
hal_status_t HAL_EXTI_ClearConfigLine(EXTI_HandleTypeDef *hexti)
{
  __IO uint32_t *regaddr;
  uint32_t regval;
  uint32_t linepos;
...
/**
  ...
  * @retval HAL Status.
  */
hal_status_t HAL_EXTI_RegisterCallback(EXTI_HandleTypeDef *hexti, EXTI_CallbackIDTypeDef CallbackID,
...
/**
  ...
  * @retval HAL Status.
  */
hal_status_t HAL_EXTI_GetHandle(EXTI_HandleTypeDef *hexti, uint32_t ExtiLine)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_EXTI_LINE(ExtiLine));
...
uint32_t HAL_EXTI_GetPending(EXTI_HandleTypeDef *hexti, uint32_t Edge)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_EXTI_LINE(hexti->Line));
  ASSERT_DBG_PARAM(IS_EXTI_CONFIG_LINE(hexti->Line));
...
void HAL_EXTI_ConfigLineAttributes(uint32_t ExtiLine, uint32_t LineAttributes)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_EXTI_LINE(ExtiLine));
  ASSERT_DBG_PARAM(IS_EXTI_LINE_ATTRIBUTES(LineAttributes));
...
/**
  ...
  * @retval HAL Status.
  */
hal_status_t HAL_EXTI_GetConfigLineAttributes(uint32_t ExtiLine, uint32_t *pLineAttributes)
{
  __IO uint32_t *regaddr;
  uint32_t linepos;
  uint32_t maskline;
