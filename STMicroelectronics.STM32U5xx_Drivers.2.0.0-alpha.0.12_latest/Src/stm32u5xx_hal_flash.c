...
/**
  ...
  * @retval HAL Status
  */
hal_status_t HAL_FLASH_Program(uint32_t TypeProgram, uint32_t Address, uint32_t DataAddress)
{
  hal_status_t status;
...
/**
  ...
  * @retval HAL Status
  */
hal_status_t HAL_FLASH_Program_IT(uint32_t TypeProgram, uint32_t Address, uint32_t DataAddress)
{
  hal_status_t status;
  __IO uint32_t *reg_cr;
