...
ErrorStatus LL_EXTI_Init(LL_EXTI_InitTypeDef *EXTI_InitStruct)
{
  ...
  ASSERT_DBG_PARAM(IS_LL_EXTI_LINE_0_31(EXTI_InitStruct->Line_0_31));
  ASSERT_DBG_PARAM(IS_FUNCTIONAL_STATE(EXTI_InitStruct->LineCommand));
  ASSERT_DBG_PARAM(IS_LL_EXTI_MODE(EXTI_InitStruct->Mode));

  /* ENABLE LineCommand */
  if (EXTI_InitStruct->LineCommand != DISABLE)
  {
    ASSERT_DBG_PARAM(IS_LL_EXTI_TRIGGER(EXTI_InitStruct->Trigger));
