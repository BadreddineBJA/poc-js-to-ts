...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_Init(DMA2D_HandleTypeDef *hdma2d)
{
  ...
  ASSERT_DBG_PARAM(IS_DMA2D_ALL_INSTANCE(hdma2d->Instance));
  ASSERT_DBG_PARAM(IS_DMA2D_MODE(hdma2d->Init.Mode));
  ASSERT_DBG_PARAM(IS_DMA2D_CMODE(hdma2d->Init.ColorMode));
  ASSERT_DBG_PARAM(IS_DMA2D_OFFSET(hdma2d->Init.OutputOffset));
  ASSERT_DBG_PARAM(IS_DMA2D_ALPHA_INVERTED(hdma2d->Init.AlphaInverted));
  ASSERT_DBG_PARAM(IS_DMA2D_RB_SWAP(hdma2d->Init.RedBlueSwap));
  ASSERT_DBG_PARAM(IS_DMA2D_LOM_MODE(hdma2d->Init.LineOffsetMode));
  ASSERT_DBG_PARAM(IS_DMA2D_BYTES_SWAP(hdma2d->Init.BytesSwap));
...
hal_status_t HAL_DMA2D_DeInit(DMA2D_HandleTypeDef *hdma2d)
{
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_DMA2D_RegisterCallback(DMA2D_HandleTypeDef *hdma2d, HAL_DMA2D_CallbackIDTypeDef CallbackID,
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_DMA2D_UnRegisterCallback(DMA2D_HandleTypeDef *hdma2d, HAL_DMA2D_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_Start(DMA2D_HandleTypeDef *hdma2d, uint32_t pdata, uint32_t DstAddress, uint32_t Width,
                             uint32_t Height)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DMA2D_LINE(Height));
  ASSERT_DBG_PARAM(IS_DMA2D_PIXEL(Width));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_Start_IT(DMA2D_HandleTypeDef *hdma2d, uint32_t pdata, uint32_t DstAddress, uint32_t Width,
                                uint32_t Height)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DMA2D_LINE(Height));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_BlendingStart(DMA2D_HandleTypeDef *hdma2d, uint32_t SrcAddress1, uint32_t  SrcAddress2,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_BlendingStart_IT(DMA2D_HandleTypeDef *hdma2d, uint32_t SrcAddress1, uint32_t  SrcAddress2,
                                        uint32_t DstAddress, uint32_t Width,  uint32_t Height)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DMA2D_LINE(Height));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_Abort(DMA2D_HandleTypeDef *hdma2d)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_Suspend(DMA2D_HandleTypeDef *hdma2d)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_Resume(DMA2D_HandleTypeDef *hdma2d)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_EnableCLUT(DMA2D_HandleTypeDef *hdma2d, uint32_t LayerIdx)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DMA2D_LAYER(LayerIdx));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_CLUTStartLoad(DMA2D_HandleTypeDef *hdma2d, DMA2D_CLUTCfgTypeDef *CLUTCfg, uint32_t LayerIdx)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DMA2D_LAYER(LayerIdx));
  ASSERT_DBG_PARAM(IS_DMA2D_CLUT_CM(CLUTCfg->CLUTColorMode));
  ASSERT_DBG_PARAM(IS_DMA2D_CLUT_SIZE(CLUTCfg->Size));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_CLUTStartLoad_IT(DMA2D_HandleTypeDef *hdma2d, DMA2D_CLUTCfgTypeDef *CLUTCfg,
                                        uint32_t LayerIdx)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DMA2D_LAYER(LayerIdx));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_CLUTLoad(DMA2D_HandleTypeDef *hdma2d, DMA2D_CLUTCfgTypeDef CLUTCfg, uint32_t LayerIdx)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DMA2D_LAYER(LayerIdx));
  ASSERT_DBG_PARAM(IS_DMA2D_CLUT_CM(CLUTCfg.CLUTColorMode));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_CLUTLoad_IT(DMA2D_HandleTypeDef *hdma2d, DMA2D_CLUTCfgTypeDef CLUTCfg, uint32_t LayerIdx)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DMA2D_LAYER(LayerIdx));
  ASSERT_DBG_PARAM(IS_DMA2D_CLUT_CM(CLUTCfg.CLUTColorMode));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_CLUTLoading_Abort(DMA2D_HandleTypeDef *hdma2d, uint32_t LayerIdx)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_CLUTLoading_Suspend(DMA2D_HandleTypeDef *hdma2d, uint32_t LayerIdx)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_CLUTLoading_Resume(DMA2D_HandleTypeDef *hdma2d, uint32_t LayerIdx)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_PollForTransfer(DMA2D_HandleTypeDef *hdma2d, uint32_t Timeout)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_ConfigLayer(DMA2D_HandleTypeDef *hdma2d, uint32_t LayerIdx)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DMA2D_LAYER(LayerIdx));
  ASSERT_DBG_PARAM(IS_DMA2D_OFFSET(hdma2d->LayerCfg[LayerIdx].InputOffset));
  if (hdma2d->Init.Mode != DMA2D_R2M)
  {
    ASSERT_DBG_PARAM(IS_DMA2D_INPUT_COLOR_MODE(hdma2d->LayerCfg[LayerIdx].InputColorMode));
    if (hdma2d->Init.Mode != DMA2D_M2M)
    {
      ASSERT_DBG_PARAM(IS_DMA2D_ALPHA_MODE(hdma2d->LayerCfg[LayerIdx].AlphaMode));
    }
  }
  ASSERT_DBG_PARAM(IS_DMA2D_ALPHA_INVERTED(hdma2d->LayerCfg[LayerIdx].AlphaInverted));
  ASSERT_DBG_PARAM(IS_DMA2D_RB_SWAP(hdma2d->LayerCfg[LayerIdx].RedBlueSwap));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_ConfigCLUT(DMA2D_HandleTypeDef *hdma2d, DMA2D_CLUTCfgTypeDef CLUTCfg, uint32_t LayerIdx)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DMA2D_LAYER(LayerIdx));
  ASSERT_DBG_PARAM(IS_DMA2D_CLUT_CM(CLUTCfg.CLUTColorMode));
...
hal_status_t HAL_DMA2D_ProgramLineEvent(DMA2D_HandleTypeDef *hdma2d, uint32_t Line)
{
  /* Check the parameters */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_EnableDeadTime(DMA2D_HandleTypeDef *hdma2d)
{
  /* Process Locked */
  __HAL_LOCK(hdma2d);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_DisableDeadTime(DMA2D_HandleTypeDef *hdma2d)
{
  /* Process Locked */
  __HAL_LOCK(hdma2d);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DMA2D_ConfigDeadTime(DMA2D_HandleTypeDef *hdma2d, uint8_t DeadTime)
{
  /* Process Locked */
  __HAL_LOCK(hdma2d);
