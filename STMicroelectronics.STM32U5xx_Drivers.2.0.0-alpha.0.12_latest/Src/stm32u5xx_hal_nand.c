...
/**
  ...
  * @retval HAL status
  */
hal_status_t  HAL_NAND_Init(NAND_HandleTypeDef *hnand, FMC_NAND_PCC_TimingTypeDef *ComSpace_Timing,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_NAND_DeInit(NAND_HandleTypeDef *hnand)
{
#if (USE_HAL_NAND_REGISTER_CALLBACKS == 1)
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_NAND_Read_ID(NAND_HandleTypeDef *hnand, NAND_IDTypeDef *pNAND_ID)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_NAND_Reset(NAND_HandleTypeDef *hnand)
{
  uint32_t deviceaddress;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t  HAL_NAND_ConfigDevice(NAND_HandleTypeDef *hnand, NAND_DeviceConfigTypeDef *pDeviceConfig)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_NAND_Read_Page_8b(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, uint8_t *pBuffer,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_NAND_Read_Page_16b(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, uint16_t *pBuffer,
                                    uint32_t NumPageToRead)
{
  uint32_t index;
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_NAND_Write_Page_8b(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, uint8_t *pBuffer,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_NAND_Write_Page_16b(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, uint16_t *pBuffer,
                                     uint32_t NumPageToWrite)
{
  uint32_t index;
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_NAND_Read_SpareArea_8b(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress, uint8_t *pBuffer,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_NAND_Read_SpareArea_16b(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_NAND_Write_SpareArea_8b(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_NAND_Write_SpareArea_16b(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_NAND_Erase_Block(NAND_HandleTypeDef *hnand, NAND_AddressTypeDef *pAddress)
{
  uint32_t deviceaddress;
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_NAND_RegisterCallback(NAND_HandleTypeDef *hnand, HAL_NAND_CallbackIDTypeDef CallbackId,
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_NAND_UnRegisterCallback(NAND_HandleTypeDef *hnand, HAL_NAND_CallbackIDTypeDef CallbackId)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t  HAL_NAND_ECC_Enable(NAND_HandleTypeDef *hnand)
{
  /* Check the NAND controller state */
  if (hnand->State == HAL_NAND_STATE_BUSY)
  {
...
/**
  ...
  * @retval HAL status
  */
hal_status_t  HAL_NAND_ECC_Disable(NAND_HandleTypeDef *hnand)
{
  /* Check the NAND controller state */
  if (hnand->State == HAL_NAND_STATE_BUSY)
  {
...
/**
  ...
  * @retval HAL status
  */
hal_status_t  HAL_NAND_GetECC(NAND_HandleTypeDef *hnand, uint32_t *ECCval, uint32_t Timeout)
{
  hal_status_t status;
