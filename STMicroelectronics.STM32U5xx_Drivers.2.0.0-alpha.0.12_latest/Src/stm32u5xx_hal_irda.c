...
static hal_status_t IRDA_SetConfig(IRDA_HandleTypeDef *hirda);
static hal_status_t IRDA_CheckIdleState(IRDA_HandleTypeDef *hirda);
static hal_status_t IRDA_WaitOnFlagUntilTimeout(IRDA_HandleTypeDef *hirda, uint32_t Flag, FlagStatus Status,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_Init(IRDA_HandleTypeDef *hirda)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_DeInit(IRDA_HandleTypeDef *hirda)
{
  /* Check the IRDA handle allocation */
  if (hirda == NULL)
  {
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_RegisterCallback(IRDA_HandleTypeDef *hirda, HAL_IRDA_CallbackIDTypeDef CallbackID,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_UnRegisterCallback(IRDA_HandleTypeDef *hirda, HAL_IRDA_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_Transmit(IRDA_HandleTypeDef *hirda, const uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_Receive(IRDA_HandleTypeDef *hirda, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  uint8_t  *pdata8bits;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_Transmit_IT(IRDA_HandleTypeDef *hirda, const uint8_t *pData, uint16_t Size)
{
  /* Check that a Tx process is not already ongoing */
  if (hirda->gState == HAL_IRDA_STATE_READY)
  {
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_Receive_IT(IRDA_HandleTypeDef *hirda, uint8_t *pData, uint16_t Size)
{
  /* Check that a Rx process is not already ongoing */
  if (hirda->RxState == HAL_IRDA_STATE_READY)
  {
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_Transmit_DMA(IRDA_HandleTypeDef *hirda, const uint8_t *pData, uint16_t Size)
{
  hal_status_t status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_Receive_DMA(IRDA_HandleTypeDef *hirda, uint8_t *pData, uint16_t Size)
{
  hal_status_t status;
  uint16_t nbByte = Size;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_DMAPause(IRDA_HandleTypeDef *hirda)
{
  /* Process Locked */
  __HAL_LOCK(hirda);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_DMAResume(IRDA_HandleTypeDef *hirda)
{
  /* Process Locked */
  __HAL_LOCK(hirda);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_DMAStop(IRDA_HandleTypeDef *hirda)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_Abort(IRDA_HandleTypeDef *hirda)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_AbortTransmit(IRDA_HandleTypeDef *hirda)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_AbortReceive(IRDA_HandleTypeDef *hirda)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_Abort_IT(IRDA_HandleTypeDef *hirda)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_AbortTransmit_IT(IRDA_HandleTypeDef *hirda)
{
  /* Disable TXEIE and TCIE interrupts */
  CLEAR_BIT(hirda->Instance->CR1, (USART_CR1_TXEIE_TXFNFIE | USART_CR1_TCIE));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_IRDA_AbortReceive_IT(IRDA_HandleTypeDef *hirda)
{
  /* Disable RXNE, PE and ERR (Frame error, noise error, overrun error) interrupts */
  CLEAR_BIT(hirda->Instance->CR1, (USART_CR1_RXNEIE_RXFNEIE | USART_CR1_PEIE));
  CLEAR_BIT(hirda->Instance->CR3, USART_CR3_EIE);
