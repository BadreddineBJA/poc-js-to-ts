...
static uint32_t SDMMC_GetCmdError(sdmmc_t *SDMMCx);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t SDMMC_Init(sdmmc_t *SDMMCx, SDMMC_InitTypeDef Init)
{
  uint32_t tmpreg = 0;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_ReadFIFO(sdmmc_t *SDMMCx)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t SDMMC_WriteFIFO(sdmmc_t *SDMMCx, uint32_t *pWriteData)
{
  /* Write data to FIFO */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t SDMMC_PowerState_ON(sdmmc_t *SDMMCx)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t SDMMC_PowerState_Cycle(sdmmc_t *SDMMCx)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t SDMMC_PowerState_OFF(sdmmc_t *SDMMCx)
{
...
/**
  ...
  *            - 0x03: Power ON
  */
uint32_t SDMMC_GetPowerState(sdmmc_t *SDMMCx)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t SDMMC_SendCommand(sdmmc_t *SDMMCx, SDMMC_CmdInitTypeDef *Command)
{
  uint32_t tmpreg = 0;
...
/**
  ...
  */
uint8_t SDMMC_GetCommandResponse(sdmmc_t *SDMMCx)
{
...
/**
  ...
  */
uint32_t SDMMC_GetResponse(sdmmc_t *SDMMCx, uint32_t Response)
{
  uint32_t tmp;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t SDMMC_ConfigData(sdmmc_t *SDMMCx, SDMMC_DataInitTypeDef *Data)
{
  uint32_t tmpreg = 0;
...
/**
  ...
  */
uint32_t SDMMC_GetDataCounter(sdmmc_t *SDMMCx)
{
...
/**
  ...
  */
uint32_t SDMMC_GetFIFOCount(sdmmc_t *SDMMCx)
{
  return (SDMMCx->FIFO);
}
...
/**
  ...
  * @retval None
  */
hal_status_t SDMMC_SetSDMMCReadWaitMode(sdmmc_t *SDMMCx, uint32_t SDMMC_ReadWaitMode)
{
  /* Check the parameters */
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdBlockLength(sdmmc_t *SDMMCx, uint32_t BlockSize)
{
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdReadSingleBlock(sdmmc_t *SDMMCx, uint32_t ReadAdd)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdReadMultiBlock(sdmmc_t *SDMMCx, uint32_t ReadAdd)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdWriteSingleBlock(sdmmc_t *SDMMCx, uint32_t WriteAdd)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdWriteMultiBlock(sdmmc_t *SDMMCx, uint32_t WriteAdd)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdSDEraseStartAdd(sdmmc_t *SDMMCx, uint32_t StartAdd)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdSDEraseEndAdd(sdmmc_t *SDMMCx, uint32_t EndAdd)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdEraseStartAdd(sdmmc_t *SDMMCx, uint32_t StartAdd)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdEraseEndAdd(sdmmc_t *SDMMCx, uint32_t EndAdd)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdErase(sdmmc_t *SDMMCx, uint32_t EraseType)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdStopTransfer(sdmmc_t *SDMMCx)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdSelDesel(sdmmc_t *SDMMCx, uint32_t Addr)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdGoIdleState(sdmmc_t *SDMMCx)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdOperCond(sdmmc_t *SDMMCx)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdAppCommand(sdmmc_t *SDMMCx, uint32_t Argument)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdAppOperCommand(sdmmc_t *SDMMCx, uint32_t Argument)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdBusWidth(sdmmc_t *SDMMCx, uint32_t BusWidth)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdSendSCR(sdmmc_t *SDMMCx)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdSendCID(sdmmc_t *SDMMCx)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdSendCSD(sdmmc_t *SDMMCx, uint32_t Argument)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdSetRelAdd(sdmmc_t *SDMMCx, uint16_t *pRCA)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdSetRelAddMmc(sdmmc_t *SDMMCx, uint16_t RCA)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdSleepMmc(sdmmc_t *SDMMCx, uint32_t Argument)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdSendStatus(sdmmc_t *SDMMCx, uint32_t Argument)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdStatusRegister(sdmmc_t *SDMMCx)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdOpCondition(sdmmc_t *SDMMCx, uint32_t Argument)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdSwitch(sdmmc_t *SDMMCx, uint32_t Argument)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdVoltageSwitch(sdmmc_t *SDMMCx)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
uint32_t SDMMC_CmdSendEXTCSD(sdmmc_t *SDMMCx, uint32_t Argument)
{
  SDMMC_CmdInitTypeDef  sdmmc_cmdinit;
  uint32_t errorstate;
...
/**
  ...
  */
uint32_t SDMMC_GetCmdResp1(sdmmc_t *SDMMCx, uint8_t SD_CMD, uint32_t Timeout)
{
...
/**
  ...
  * @retval SD Card error state
  */
uint32_t SDMMC_GetCmdResp2(sdmmc_t *SDMMCx)
{
  uint32_t sta_reg;
  /* 8 is the number of required instructions cycles for the below loop statement.
...
/**
  ...
  * @retval SD Card error state
  */
uint32_t SDMMC_GetCmdResp3(sdmmc_t *SDMMCx)
{
  uint32_t sta_reg;
  /* 8 is the number of required instructions cycles for the below loop statement.
  The SDMMC_CMDTIMEOUT is expressed in ms */
...
/**
  ...
  * @retval SD Card error state
  */
uint32_t SDMMC_GetCmdResp6(sdmmc_t *SDMMCx, uint8_t SD_CMD, uint16_t *pRCA)
{
  uint32_t response_r1;
  uint32_t sta_reg;
...
/**
  ...
  * @retval SD Card error state
  */
uint32_t SDMMC_GetCmdResp7(sdmmc_t *SDMMCx)
{
  uint32_t sta_reg;
  /* 8 is the number of required instructions cycles for the below loop statement.
  The SDMMC_CMDTIMEOUT is expressed in ms */
