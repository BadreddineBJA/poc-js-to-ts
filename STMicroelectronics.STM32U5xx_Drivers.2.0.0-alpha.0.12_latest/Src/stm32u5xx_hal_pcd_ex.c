...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PCDEx_SetTxFiFo(PCD_HandleTypeDef *hpcd, uint8_t fifo, uint16_t size)
{
  uint8_t i;
  uint32_t Tx_Offset;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PCDEx_SetRxFiFo(PCD_HandleTypeDef *hpcd, uint16_t size)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PCDEx_ActivateLPM(PCD_HandleTypeDef *hpcd)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PCDEx_DeActivateLPM(PCD_HandleTypeDef *hpcd)
{
  USB_OTG_GlobalTypeDef *USBx = hpcd->Instance;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PCDEx_ActivateBCD(PCD_HandleTypeDef *hpcd)
{
  USB_OTG_GlobalTypeDef *USBx = hpcd->Instance;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PCDEx_DeActivateBCD(PCD_HandleTypeDef *hpcd)
{
  USB_OTG_GlobalTypeDef *USBx = hpcd->Instance;
