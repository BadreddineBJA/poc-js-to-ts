...
static hal_status_t DSI_ShortWrite(DSI_HandleTypeDef *hdsi,
                                   uint32_t ChannelID,
                                   uint32_t Mode,
                                   uint32_t Param1,
                                   uint32_t Param2);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_Init(DSI_HandleTypeDef *hdsi, DSI_PLLInitTypeDef *PLLInit)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_DeInit(DSI_HandleTypeDef *hdsi)
{
  /* Check the DSI handle allocation */
  if (hdsi == NULL)
  {
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_ConfigErrorMonitor(DSI_HandleTypeDef *hdsi, uint32_t ActiveErrors)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_DSI_RegisterCallback(DSI_HandleTypeDef *hdsi, HAL_DSI_CallbackIDTypeDef CallbackID,
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_DSI_UnRegisterCallback(DSI_HandleTypeDef *hdsi, HAL_DSI_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_SetGenericVCIDRX(DSI_HandleTypeDef *hdsi, uint32_t VirtualChannelIdRx)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_SetGenericVCIDTX(DSI_HandleTypeDef *hdsi, uint32_t VirtualChannelIdTx)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_SetGenericVCID(DSI_HandleTypeDef *hdsi, uint32_t VirtualChannelID)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_ConfigVideoMode(DSI_HandleTypeDef *hdsi, DSI_VidCfgTypeDef *VidCfg)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_ConfigAdaptedCommandMode(DSI_HandleTypeDef *hdsi, DSI_CmdCfgTypeDef *CmdCfg)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_ConfigCommand(DSI_HandleTypeDef *hdsi, DSI_LPCmdTypeDef *LPCmd)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_ConfigFlowControl(DSI_HandleTypeDef *hdsi, uint32_t FlowControl)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_ConfigPhyTimer(DSI_HandleTypeDef *hdsi, DSI_PHY_TimerTypeDef *PhyTimers)
{
  uint32_t maxTime;
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_ConfigHostTimeouts(DSI_HandleTypeDef *hdsi, DSI_HOST_TimeoutTypeDef *HostTimeouts)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_Start(DSI_HandleTypeDef *hdsi)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_Stop(DSI_HandleTypeDef *hdsi)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_Refresh(DSI_HandleTypeDef *hdsi)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_ColorMode(DSI_HandleTypeDef *hdsi, uint32_t ColorMode)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_Shutdown(DSI_HandleTypeDef *hdsi, uint32_t Shutdown)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_ShortWrite(DSI_HandleTypeDef *hdsi,
                                uint32_t ChannelID,
                                uint32_t Mode,
                                uint32_t Param1,
                                uint32_t Param2)
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_LongWrite(DSI_HandleTypeDef *hdsi,
                               uint32_t ChannelID,
                               uint32_t Mode,
                               uint32_t NbParams,
                               uint32_t Param1,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_Read(DSI_HandleTypeDef *hdsi,
                          uint32_t ChannelNbr,
                          uint8_t *Array,
                          uint32_t Size,
                          uint32_t Mode,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_EnterULPMData(DSI_HandleTypeDef *hdsi)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_ExitULPMData(DSI_HandleTypeDef *hdsi)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_EnterULPM(DSI_HandleTypeDef *hdsi)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_ExitULPM(DSI_HandleTypeDef *hdsi)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_PatternGeneratorStart(DSI_HandleTypeDef *hdsi, uint32_t Mode, uint32_t Orientation)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_PatternGeneratorStop(DSI_HandleTypeDef *hdsi)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_SetLanePinsConfiguration(DSI_HandleTypeDef *hdsi, uint32_t CustomLane, uint32_t Lane,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DSI_ForceTXStopMode(DSI_HandleTypeDef *hdsi, uint32_t Lane, FunctionalState State)
{
  /* Process locked */
  __HAL_LOCK(hdsi);
