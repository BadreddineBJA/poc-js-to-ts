...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetTimeStamp(RTC_HandleTypeDef *hrtc, uint32_t TimeStampEdge, uint32_t RTC_TimeStampPin)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIMESTAMP_EDGE(TimeStampEdge));
  ASSERT_DBG_PARAM(IS_RTC_TIMESTAMP_PIN(RTC_TimeStampPin));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetTimeStamp_IT(RTC_HandleTypeDef *hrtc, uint32_t TimeStampEdge, uint32_t RTC_TimeStampPin)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIMESTAMP_EDGE(TimeStampEdge));
  ASSERT_DBG_PARAM(IS_RTC_TIMESTAMP_PIN(RTC_TimeStampPin));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_DeactivateTimeStamp(RTC_HandleTypeDef *hrtc)
{
  /* Process Locked */
  __HAL_LOCK(hrtc);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetInternalTimeStamp(RTC_HandleTypeDef *hrtc)
{
  /* Process Locked */
  __HAL_LOCK(hrtc);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_DeactivateInternalTimeStamp(RTC_HandleTypeDef *hrtc)
{
  /* Process Locked */
  __HAL_LOCK(hrtc);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_GetTimeStamp(RTC_HandleTypeDef *hrtc, RTC_TimeTypeDef *sTimeStamp,
                                    RTC_DateTypeDef *sTimeStampDate, uint32_t Format)
{
  ...
  UNUSED(hrtc);
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RTC_FORMAT(Format));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_PollForTimeStampEvent(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetWakeUpTimer(RTC_HandleTypeDef *hrtc, uint32_t WakeUpCounter, uint32_t WakeUpClock)
{
  uint32_t tickstart;

  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RTC_WAKEUP_CLOCK(WakeUpClock));
  ASSERT_DBG_PARAM(IS_RTC_WAKEUP_COUNTER(WakeUpCounter));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetWakeUpTimer_IT(RTC_HandleTypeDef *hrtc, uint32_t WakeUpCounter, uint32_t WakeUpClock,
                                         uint32_t WakeUpAutoClr)
{
  ...
  ASSERT_DBG_PARAM(IS_RTC_WAKEUP_COUNTER(WakeUpCounter));
  /* (0x0000<=WUTOCLR<=WUT) */
  ASSERT_DBG_PARAM(WakeUpAutoClr <= WakeUpCounter);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_DeactivateWakeUpTimer(RTC_HandleTypeDef *hrtc)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_PollForWakeUpTimerEvent(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  uint32_t tickstart = HAL_GetTick();
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetSmoothCalib(RTC_HandleTypeDef *hrtc, uint32_t SmoothCalibPeriod,
                                      uint32_t SmoothCalibPlusPulses, uint32_t SmoothCalibMinusPulsesValue)
{
  uint32_t tickstart;

  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RTC_SMOOTH_CALIB_PERIOD(SmoothCalibPeriod));
  ASSERT_DBG_PARAM(IS_RTC_SMOOTH_CALIB_PLUS(SmoothCalibPlusPulses));
  ASSERT_DBG_PARAM(IS_RTC_SMOOTH_CALIB_MINUS(SmoothCalibMinusPulsesValue));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetLowPowerCalib(RTC_HandleTypeDef *hrtc, uint32_t LowPowerCalib)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RTC_LOW_POWER_CALIB(LowPowerCalib));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetSynchroShift(RTC_HandleTypeDef *hrtc, uint32_t ShiftAdd1S, uint32_t ShiftSubFS)
{
  uint32_t tickstart;

  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RTC_SHIFT_ADD1S(ShiftAdd1S));
  ASSERT_DBG_PARAM(IS_RTC_SHIFT_SUBFS(ShiftSubFS));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetCalibrationOutPut(RTC_HandleTypeDef *hrtc, uint32_t CalibOutput)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RTC_CALIB_OUTPUT(CalibOutput));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_DeactivateCalibrationOutPut(RTC_HandleTypeDef *hrtc)
{
  /* Process Locked */
  __HAL_LOCK(hrtc);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetRefClock(RTC_HandleTypeDef *hrtc)
{
  hal_status_t status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_DeactivateRefClock(RTC_HandleTypeDef *hrtc)
{
  hal_status_t status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_EnableBypassShadow(RTC_HandleTypeDef *hrtc)
{
  /* Process Locked */
  __HAL_LOCK(hrtc);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_DisableBypassShadow(RTC_HandleTypeDef *hrtc)
{
  /* Process Locked */
  __HAL_LOCK(hrtc);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_MonotonicCounterIncrement(RTC_HandleTypeDef *hrtc, uint32_t Instance)
{
  UNUSED(hrtc);
  UNUSED(Instance);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_MonotonicCounterGet(RTC_HandleTypeDef *hrtc, uint32_t Instance, uint32_t *Value)
{
  UNUSED(hrtc);
  UNUSED(Instance);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetSSRU_IT(RTC_HandleTypeDef *hrtc)
{
  /* Process Locked */
  __HAL_LOCK(hrtc);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_DeactivateSSRU(RTC_HandleTypeDef *hrtc)
{
  /* Process Locked */
  __HAL_LOCK(hrtc);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_PollForAlarmBEvent(RTC_HandleTypeDef *hrtc, uint32_t Timeout)
{
  uint32_t tickstart = HAL_GetTick();
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetTamper(RTC_HandleTypeDef *hrtc, RTC_TamperTypeDef *sTamper)
{
  uint32_t tmpreg;
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RTC_TAMPER(sTamper->Tamper));
  ASSERT_DBG_PARAM(IS_RTC_TAMPER_TRIGGER(sTamper->Trigger));
  ASSERT_DBG_PARAM(IS_RTC_TAMPER_ERASE_MODE(sTamper->NoErase));
  ASSERT_DBG_PARAM(IS_RTC_TAMPER_MASKFLAG_STATE(sTamper->MaskFlag));
  ASSERT_DBG_PARAM(IS_RTC_TAMPER_TIMESTAMPONTAMPER_DETECTION(sTamper->TimeStampOnTamperDetection));
  /* Mask flag only supported by TAMPER 1, 2 and 3 */
  ASSERT_DBG_PARAM(!((sTamper->MaskFlag != RTC_TAMPERMASK_FLAG_DISABLE) && (sTamper->Tamper > RTC_TAMPER_3)));
  ASSERT_DBG_PARAM(IS_RTC_TAMPER_FILTER(sTamper->Filter));
  ASSERT_DBG_PARAM(IS_RTC_TAMPER_SAMPLING_FREQ(sTamper->SamplingFrequency));
  ASSERT_DBG_PARAM(IS_RTC_TAMPER_PRECHARGE_DURATION(sTamper->PrechargeDuration));
  ASSERT_DBG_PARAM(IS_RTC_TAMPER_PULLUP_STATE(sTamper->TamperPullUp));
  /* Trigger and Filter have exclusive configurations */
  ASSERT_DBG_PARAM(((sTamper->Filter != RTC_TAMPERFILTER_DISABLE) && \
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetTamper_IT(RTC_HandleTypeDef *hrtc, RTC_TamperTypeDef *sTamper)
{
  uint32_t tmpreg;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_DeactivateTamper(RTC_HandleTypeDef *hrtc, uint32_t Tamper)
{
  UNUSED(hrtc);
  ASSERT_DBG_PARAM(IS_RTC_TAMPER(Tamper));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetActiveTampers(RTC_HandleTypeDef *hrtc, RTC_ActiveTampersTypeDef *sAllTamper)
{
  uint32_t IER;
  uint32_t CR1;
  uint32_t CR2;
  ...
  {
    ASSERT_DBG_PARAM(IS_RTC_TAMPER_ERASE_MODE(sAllTamper->TampInput[i].NoErase));
    ASSERT_DBG_PARAM(IS_RTC_TAMPER_MASKFLAG_STATE(sAllTamper->TampInput[i].MaskFlag));
    /* Mask flag only supported by TAMPER 1, 2 and 3 */
    ASSERT_DBG_PARAM(!((sAllTamper->TampInput[i].MaskFlag != RTC_TAMPERMASK_FLAG_DISABLE) && (i > RTC_TAMPER_3)));
  }
  ASSERT_DBG_PARAM(IS_RTC_TAMPER_TIMESTAMPONTAMPER_DETECTION(sAllTamper->TimeStampOnTamperDetection));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetActiveSeed(RTC_HandleTypeDef *hrtc, uint32_t *pSeed)
{
  uint32_t i;
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetBoothardwareKey(RTC_HandleTypeDef *hrtc)
{
  UNUSED(hrtc);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_DeactivateActiveTampers(RTC_HandleTypeDef *hrtc)
{
  /* Get Active tampers */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_PollForTamperEvent(RTC_HandleTypeDef *hrtc, uint32_t Tamper, uint32_t Timeout)
{
  UNUSED(hrtc);
  ASSERT_DBG_PARAM(IS_RTC_TAMPER(Tamper));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetInternalTamper(RTC_HandleTypeDef *hrtc, RTC_InternalTamperTypeDef *sIntTamper)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hrtc);

  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RTC_INTERNAL_TAMPER(sIntTamper->IntTamper));
  ASSERT_DBG_PARAM(IS_RTC_TAMPER_TIMESTAMPONTAMPER_DETECTION(sIntTamper->TimeStampOnTamperDetection));
  ASSERT_DBG_PARAM(IS_RTC_TAMPER_ERASE_MODE(sIntTamper->NoErase));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_SetInternalTamper_IT(RTC_HandleTypeDef *hrtc, RTC_InternalTamperTypeDef *sIntTamper)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hrtc);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_DeactivateInternalTamper(RTC_HandleTypeDef *hrtc, uint32_t IntTamper)
{
  UNUSED(hrtc);
  ASSERT_DBG_PARAM(IS_RTC_INTERNAL_TAMPER(IntTamper));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RTCEx_PollForInternalTamperEvent(RTC_HandleTypeDef *hrtc, uint32_t IntTamper, uint32_t Timeout)
{
  UNUSED(hrtc);
  ASSERT_DBG_PARAM(IS_RTC_INTERNAL_TAMPER(IntTamper));
...
void HAL_RTCEx_BKUPWrite(RTC_HandleTypeDef *hrtc, uint32_t BackupRegister, uint32_t Data)
{
  ...
  UNUSED(hrtc);
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RTC_BKP(BackupRegister));
...
/**
  ...
  * @retval hal_status_t
  */
hal_status_t HAL_RTCEx_SecureModeGet(RTC_HandleTypeDef *hrtc, RTC_SecureStateTypeDef  *secureState)
{
  UNUSED(hrtc);
  /* Read registers */
...
/**
  ...
  * @retval hal_status_t
  */
hal_status_t HAL_RTCEx_SecureModeSet(RTC_HandleTypeDef *hrtc, RTC_SecureStateTypeDef  *secureState)
{
  UNUSED(hrtc);
  ASSERT_DBG_PARAM(IS_RTC_SECURE_FULL(secureState->rtcSecureFull));
  ASSERT_DBG_PARAM(IS_RTC_NONSECURE_FEATURES(secureState->rtcNonSecureFeatures));
  ASSERT_DBG_PARAM(IS_TAMP_SECURE_FULL(secureState->tampSecureFull));
  ASSERT_DBG_PARAM(IS_RTC_BKP(secureState->backupRegisterStartZone2));
  ASSERT_DBG_PARAM(IS_RTC_BKP(secureState->backupRegisterStartZone3));
  ASSERT_DBG_PARAM(IS_TAMP_MONOTONIC_CNT_SECURE(secureState->MonotonicCounterSecure));
...
/**
  ...
  * @retval hal_status_t
  */
hal_status_t HAL_RTCEx_PrivilegeModeSet(RTC_HandleTypeDef *hrtc, RTC_PrivilegeStateTypeDef *privilegeState)
{
  UNUSED(hrtc);
  ASSERT_DBG_PARAM(IS_RTC_PRIVILEGE_FULL(privilegeState->rtcPrivilegeFull));
  ASSERT_DBG_PARAM(IS_RTC_PRIVILEGE_FEATURES(privilegeState->rtcPrivilegeFeatures));
  ASSERT_DBG_PARAM(IS_TAMP_PRIVILEGE_FULL(privilegeState->tampPrivilegeFull));
  ASSERT_DBG_PARAM(IS_TAMP_MONOTONIC_CNT_PRIVILEGE(privilegeState->MonotonicCounterPrivilege));
  ASSERT_DBG_PARAM(IS_RTC_PRIVILEGE_BKUP_ZONE(privilegeState->backupRegisterPrivZone));
  ASSERT_DBG_PARAM(IS_RTC_BKP(privilegeState->backupRegisterStartZone2));
  ASSERT_DBG_PARAM(IS_RTC_BKP(privilegeState->backupRegisterStartZone3));
...
/**
  ...
  * @retval hal_status_t
  */
hal_status_t HAL_RTCEx_PrivilegeModeGet(RTC_HandleTypeDef *hrtc, RTC_PrivilegeStateTypeDef *privilegeState)
{
  /* Read registers */
