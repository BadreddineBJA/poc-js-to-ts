...
/** @defgroup RCC_Private_Functions RCC Private Functions
  * @{
  */
static hal_status_t RCC_SetFlashLatencyFromMSIRange(uint32_t msirange);
/**
  * @}
  */
...
hal_status_t HAL_RCC_DeInit(void)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RCC_OscConfig(RCC_OscInitTypeDef  *pRCC_OscInitStruct)
{
  uint32_t tickstart;
  hal_status_t status;
  ...
  ASSERT_DBG_PARAM(IS_RCC_OSCILLATORTYPE(pRCC_OscInitStruct->OscillatorType));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_MSI(pRCC_OscInitStruct->MSIState));
    ASSERT_DBG_PARAM(IS_RCC_MSICALIBRATION_VALUE(pRCC_OscInitStruct->MSICalibrationValue));
    ASSERT_DBG_PARAM(IS_RCC_MSI_CLOCK_RANGE(pRCC_OscInitStruct->MSIClockRange));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_HSE(pRCC_OscInitStruct->HSEState));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_HSI(pRCC_OscInitStruct->HSIState));
    ASSERT_DBG_PARAM(IS_RCC_HSI_CALIBRATION_VALUE(pRCC_OscInitStruct->HSICalibrationValue));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_LSI(pRCC_OscInitStruct->LSIState));
    ...
    if (pRCC_OscInitStruct->LSIState != RCC_LSI_OFF)
    {
      ...
      ASSERT_DBG_PARAM(IS_RCC_LSIDIV(pRCC_OscInitStruct->LSIDiv));
  ...
  if (((pRCC_OscInitStruct->OscillatorType) & RCC_OSCILLATORTYPE_LSE) == RCC_OSCILLATORTYPE_LSE)
  {
    ...
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_LSE(pRCC_OscInitStruct->LSEState));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_HSI48(pRCC_OscInitStruct->HSI48State));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_SHSI(pRCC_OscInitStruct->SHSIState));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_MSIK(pRCC_OscInitStruct->MSIKState));
    ASSERT_DBG_PARAM(IS_RCC_MSIK_CLOCK_RANGE(pRCC_OscInitStruct->MSIKClockRange));
    ASSERT_DBG_PARAM(IS_RCC_MSICALIBRATION_VALUE(pRCC_OscInitStruct->MSICalibrationValue));
  ...
  /*-------------------------------- PLL Configuration -----------------------*/
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RCC_PLL(pRCC_OscInitStruct->PLL.PLLState));
  ...
  if ((pRCC_OscInitStruct->PLL.PLLState) != RCC_PLL_NONE)
  {
    ...
    if (__HAL_RCC_GET_SYSCLK_SOURCE() != RCC_SYSCLKSOURCE_STATUS_PLLCLK)
    {
      ...
      {
        /* Check the parameters */
        ASSERT_DBG_PARAM(IS_RCC_PLLMBOOST_VALUE(pRCC_OscInitStruct->PLL.PLLMBOOST));
        ASSERT_DBG_PARAM(IS_RCC_PLLSOURCE(pRCC_OscInitStruct->PLL.PLLSource));
        ASSERT_DBG_PARAM(IS_RCC_PLLM_VALUE(pRCC_OscInitStruct->PLL.PLLM));
        ASSERT_DBG_PARAM(IS_RCC_PLLN_VALUE(pRCC_OscInitStruct->PLL.PLLN));
        ASSERT_DBG_PARAM(IS_RCC_PLLP_VALUE(pRCC_OscInitStruct->PLL.PLLP));
        ASSERT_DBG_PARAM(IS_RCC_PLLQ_VALUE(pRCC_OscInitStruct->PLL.PLLQ));
        ASSERT_DBG_PARAM(IS_RCC_PLLR_VALUE(pRCC_OscInitStruct->PLL.PLLR));
        ...
        ASSERT_DBG_PARAM(IS_RCC_PLL_FRACN_VALUE(pRCC_OscInitStruct->PLL.PLLFRACN));
        ...
        ASSERT_DBG_PARAM(IS_RCC_PLLRGE_VALUE(pRCC_OscInitStruct->PLL.PLLRGE));
    ...
    else
    {
           ...
           RCC_PLL1FRACR_PLL1FRACN_Pos) != (pRCC_OscInitStruct->PLL.PLLFRACN))
      {
        ...
        /* Wait at least 2 CK_REF (PLL1 input source divided by M) period to make sure next latched value will be
           taken into account. */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RCC_ClockConfig(const RCC_ClkInitTypeDef   *const pRCC_ClkInitStruct, uint32_t FLatency)
{
  hal_status_t status;
  uint32_t tickstart;
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RCC_CLOCKTYPE(pRCC_ClkInitStruct->ClockType));
  ASSERT_DBG_PARAM(IS_FLASH_LATENCY(FLatency));
  ...
  if (((pRCC_ClkInitStruct->ClockType) & RCC_CLOCKTYPE_PCLK3) == RCC_CLOCKTYPE_PCLK3)
  {
    ...
    {
      ASSERT_DBG_PARAM(IS_RCC_PCLK(pRCC_ClkInitStruct->APB3CLKDivider));
  ...
  if (((pRCC_ClkInitStruct->ClockType) & RCC_CLOCKTYPE_PCLK2) == RCC_CLOCKTYPE_PCLK2)
  {
    ...
    {
      ASSERT_DBG_PARAM(IS_RCC_PCLK(pRCC_ClkInitStruct->APB2CLKDivider));
  ...
  if (((pRCC_ClkInitStruct->ClockType) & RCC_CLOCKTYPE_PCLK1) == RCC_CLOCKTYPE_PCLK1)
  {
    ...
    {
      ASSERT_DBG_PARAM(IS_RCC_PCLK(pRCC_ClkInitStruct->APB1CLKDivider));
  ...
  if (((pRCC_ClkInitStruct->ClockType) & RCC_CLOCKTYPE_HCLK) == RCC_CLOCKTYPE_HCLK)
  {
    ...
    {
      ASSERT_DBG_PARAM(IS_RCC_HCLK(pRCC_ClkInitStruct->AHBCLKDivider));
  ...
  {
    ASSERT_DBG_PARAM(IS_RCC_SYSCLKSOURCE(pRCC_ClkInitStruct->SYSCLKSource));
    FlagStatus  pwrclkchanged = RESET;
...
void HAL_RCC_MCOConfig(uint32_t RCC_MCOx, uint32_t RCC_MCOSource, uint32_t RCC_MCODiv)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RCC_MCO(RCC_MCOx));
  ASSERT_DBG_PARAM(IS_RCC_MCODIV(RCC_MCODiv));
  ASSERT_DBG_PARAM(IS_RCC_MCO1SOURCE(RCC_MCOSource));
...
uint32_t HAL_RCC_GetSysClockFreq(void)
{
  ...
  if (sysclk_source == RCC_SYSCLKSOURCE_STATUS_PLLCLK)
  {
    /* PLL used as system clock  source
       PLL_VCO = (HSE_VALUE or HSI_VALUE or MSI_RESET_VALUE/ PLLM) * PLLN
       SYSCLK = PLL_VCO / PLLR
    */
...
void HAL_RCC_GetOscConfig(RCC_OscInitTypeDef  *pRCC_OscInitStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(pRCC_OscInitStruct != (void *)NULL);
...
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(pRCC_ClkInitStruct != (void *)NULL);
  ASSERT_DBG_PARAM(pFLatency != (void *)NULL);
...
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RCC_ITEM_ATTRIBUTES(Item));
  ASSERT_DBG_PARAM(IS_RCC_ATTRIBUTES(Attributes));
...
/**
  ...
  * @retval HAL Status.
  */
hal_status_t HAL_RCC_GetConfigAttributes(uint32_t Item, uint32_t *pAttributes)
{
  uint32_t attributes;
