...
static hal_status_t CRYP_SetHeaderDMAConfig(CRYP_HandleTypeDef *hcryp, uint32_t inputaddr, uint16_t Size);
...
static hal_status_t CRYP_GCMCCM_SetHeaderPhase(CRYP_HandleTypeDef *hcryp, uint32_t Timeout);
static void CRYP_GCMCCM_SetPayloadPhase_IT(CRYP_HandleTypeDef *hcryp);
static void CRYP_GCMCCM_SetHeaderPhase_IT(CRYP_HandleTypeDef *hcryp);
static hal_status_t CRYP_GCMCCM_SetHeaderPhase_DMA(CRYP_HandleTypeDef *hcryp);
static hal_status_t CRYP_GCMCCM_SetPayloadPhase_DMA(CRYP_HandleTypeDef *hcryp);
static hal_status_t CRYP_AESGCM_Process_DMA(CRYP_HandleTypeDef *hcryp);
static hal_status_t CRYP_AESGCM_Process_IT(CRYP_HandleTypeDef *hcryp);
static hal_status_t CRYP_AESGCM_Process(CRYP_HandleTypeDef *hcryp, uint32_t Timeout);
static hal_status_t CRYP_AESCCM_Process(CRYP_HandleTypeDef *hcryp, uint32_t Timeout);
static hal_status_t CRYP_AESCCM_Process_IT(CRYP_HandleTypeDef *hcryp);
static hal_status_t CRYP_AESCCM_Process_DMA(CRYP_HandleTypeDef *hcryp);
static void CRYP_AES_ProcessData(CRYP_HandleTypeDef *hcrypt, uint32_t Timeout);
static hal_status_t CRYP_AES_Encrypt(CRYP_HandleTypeDef *hcryp, uint32_t Timeout);
static hal_status_t CRYP_AES_Decrypt(CRYP_HandleTypeDef *hcryp, uint32_t Timeout);
static hal_status_t CRYP_AES_Decrypt_IT(CRYP_HandleTypeDef *hcryp);
static hal_status_t CRYP_AES_Encrypt_IT(CRYP_HandleTypeDef *hcryp);
static hal_status_t CRYP_AES_Decrypt_DMA(CRYP_HandleTypeDef *hcryp);
static hal_status_t CRYP_WaitOnCCFlag(CRYP_HandleTypeDef *hcryp, uint32_t Timeout);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_CRYP_Init(CRYP_HandleTypeDef *hcryp)
{
  uint32_t cr_value;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_CRYP_DeInit(CRYP_HandleTypeDef *hcryp)
{
  /* Check the CRYP handle allocation */
  if (hcryp == NULL)
  {
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_CRYP_SetConfig(CRYP_HandleTypeDef *hcryp, CRYP_ConfigTypeDef *pConf)
{
  /* Check the CRYP handle allocation */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_CRYP_GetConfig(CRYP_HandleTypeDef *hcryp, CRYP_ConfigTypeDef *pConf)
{
  /* Check the CRYP handle allocation */
  if ((hcryp == NULL) || (pConf == NULL))
  {
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_CRYP_RegisterCallback(CRYP_HandleTypeDef *hcryp, HAL_CRYP_CallbackIDTypeDef CallbackID,
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_CRYP_UnRegisterCallback(CRYP_HandleTypeDef *hcryp, HAL_CRYP_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_CRYP_Suspend(CRYP_HandleTypeDef *hcryp)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_CRYP_Resume(CRYP_HandleTypeDef *hcryp)
{
  /* Check the CRYP handle allocation */
  if (hcryp == NULL)
  {
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_CRYP_Encrypt(CRYP_HandleTypeDef *hcryp, uint32_t *pInput, uint16_t Size, uint32_t *pOutput,
                              uint32_t Timeout)
{
  uint32_t algo;
  hal_status_t status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_CRYP_Decrypt(CRYP_HandleTypeDef *hcryp, uint32_t *pInput, uint16_t Size, uint32_t *pOutput,
                              uint32_t Timeout)
{
  hal_status_t status;
  uint32_t algo;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_CRYP_Encrypt_IT(CRYP_HandleTypeDef *hcryp, uint32_t *pInput, uint16_t Size, uint32_t *pOutput)
{
  hal_status_t status;
  uint32_t algo;
#ifdef  USE_FULL_ASSERT
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_CRYP_Decrypt_IT(CRYP_HandleTypeDef *hcryp, uint32_t *pInput, uint16_t Size, uint32_t *pOutput)
{
  hal_status_t status;
  uint32_t algo;
#ifdef  USE_FULL_ASSERT
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_CRYP_Encrypt_DMA(CRYP_HandleTypeDef *hcryp, uint32_t *pInput, uint16_t Size, uint32_t *pOutput)
{
  hal_status_t status;
  uint32_t count;
  uint32_t algo;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_CRYP_Decrypt_DMA(CRYP_HandleTypeDef *hcryp, uint32_t *pInput, uint16_t Size, uint32_t *pOutput)
{
  hal_status_t status;
  uint32_t algo;
#ifdef  USE_FULL_ASSERT
