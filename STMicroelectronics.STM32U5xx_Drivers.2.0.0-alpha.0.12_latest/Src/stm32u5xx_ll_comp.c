...
ErrorStatus LL_COMP_DeInit(COMP_TypeDef *COMPx)
{
  ...
  ASSERT_DBG_PARAM(IS_COMP_ALL_INSTANCE(COMPx));
...
ErrorStatus LL_COMP_Init(COMP_TypeDef *COMPx, LL_COMP_InitTypeDef *COMP_InitStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_COMP_ALL_INSTANCE(COMPx));
  ASSERT_DBG_PARAM(IS_LL_COMP_POWER_MODE(COMP_InitStruct->PowerMode));
  ASSERT_DBG_PARAM(IS_LL_COMP_INPUT_PLUS(COMPx, COMP_InitStruct->InputPlus));
  ASSERT_DBG_PARAM(IS_LL_COMP_INPUT_MINUS(COMPx, COMP_InitStruct->InputMinus));
  ASSERT_DBG_PARAM(IS_LL_COMP_INPUT_HYSTERESIS(COMP_InitStruct->InputHysteresis));
  ASSERT_DBG_PARAM(IS_LL_COMP_OUTPUT_POLARITY(COMP_InitStruct->OutputPolarity));
  ASSERT_DBG_PARAM(IS_LL_COMP_OUTPUT_BLANKING_SOURCE(COMP_InitStruct->OutputBlankingSource));
