...
ErrorStatus LL_GPIO_Init(gpio_t *GPIOx, LL_GPIO_InitTypeDef *GPIO_InitStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_GPIO_ALL_INSTANCE(GPIOx));
  ASSERT_DBG_PARAM(IS_LL_GPIO_PIN(GPIO_InitStruct->Pin));
  ASSERT_DBG_PARAM(IS_LL_GPIO_MODE(GPIO_InitStruct->Mode));
  ASSERT_DBG_PARAM(IS_LL_GPIO_PULL(GPIO_InitStruct->Pull));
  ...
  while (((GPIO_InitStruct->Pin) >> pinpos) != 0U)
  {
    ...
    if (currentpin != 0U)
    {
      ...
      if ((GPIO_InitStruct->Mode == LL_GPIO_MODE_OUTPUT) || (GPIO_InitStruct->Mode == LL_GPIO_MODE_ALTERNATE))
      {
        ...
        ASSERT_DBG_PARAM(IS_LL_GPIO_SPEED(GPIO_InitStruct->Speed));
      ...
      if (GPIO_InitStruct->Mode == LL_GPIO_MODE_ALTERNATE)
      {
        ...
        ASSERT_DBG_PARAM(IS_LL_GPIO_ALTERNATE(GPIO_InitStruct->Alternate));
  ...
  if ((GPIO_InitStruct->Mode == LL_GPIO_MODE_OUTPUT) || (GPIO_InitStruct->Mode == LL_GPIO_MODE_ALTERNATE))
  {
    ...
    ASSERT_DBG_PARAM(IS_LL_GPIO_OUTPUT_TYPE(GPIO_InitStruct->OutputType));
