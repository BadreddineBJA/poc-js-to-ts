...
#if defined(USE_HAL_SD_MODULE) || defined(USE_HAL_OSPI_MODULE) || defined(USE_HAL_XSPI_MODULE)
...
void LL_DLYB_SetDelay(DLYB_TypeDef *DLYBx, LL_DLYB_CfgTypeDef  *pdlyb_cfg)
{
  ...
  ASSERT_DBG_PARAM(IS_DLYB_ALL_INSTANCE(DLYBx));
...
/**
  * @}
  */
#endif /* USE_HAL_SD_MODULE || USE_HAL_OSPI_MODULE || USE_HAL_XSPI_MODULE */
