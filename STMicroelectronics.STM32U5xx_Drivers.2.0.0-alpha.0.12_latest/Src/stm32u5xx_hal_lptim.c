...
static hal_status_t LPTIM_OC1_SetConfig(LPTIM_HandleTypeDef *hlptim, LPTIM_OC_ConfigTypeDef *sConfig);
static hal_status_t LPTIM_OC2_SetConfig(LPTIM_HandleTypeDef *hlptim, LPTIM_OC_ConfigTypeDef *sConfig);
...
static hal_status_t LPTIM_WaitForFlag(LPTIM_HandleTypeDef *hlptim, uint32_t flag);
...
hal_status_t LPTIM_DMA_Start_IT(DMA_HandleTypeDef *hdma, uint32_t src, uint32_t dst,
                                uint32_t length);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_Init(LPTIM_HandleTypeDef *hlptim)
{
  uint32_t tmpcfgr;
  ...
  ASSERT_DBG_PARAM(IS_LPTIM_INSTANCE(hlptim->Instance));
  ASSERT_DBG_PARAM(IS_LPTIM_PERIOD(hlptim->Init.Period));

  ASSERT_DBG_PARAM(IS_LPTIM_CLOCK_SOURCE(hlptim->Init.Clock.Source));
  ASSERT_DBG_PARAM(IS_LPTIM_CLOCK_PRESCALER(hlptim->Init.Clock.Prescaler));
  if ((hlptim->Init.Clock.Source == LPTIM_CLOCKSOURCE_ULPTIM)
      || (hlptim->Init.CounterSource == LPTIM_COUNTERSOURCE_EXTERNAL))
  {
    ASSERT_DBG_PARAM(IS_LPTIM_CLOCK_POLARITY(hlptim->Init.UltraLowPowerClock.Polarity));
    ASSERT_DBG_PARAM(IS_LPTIM_CLOCK_SAMPLE_TIME(hlptim->Init.UltraLowPowerClock.SampleTime));
  }
  ASSERT_DBG_PARAM(IS_LPTIM_TRG_SOURCE(hlptim->Init.Trigger.Source));
  if (hlptim->Init.Trigger.Source != LPTIM_TRIGSOURCE_SOFTWARE)
  {
    ASSERT_DBG_PARAM(IS_LPTIM_EXT_TRG_POLARITY(hlptim->Init.Trigger.ActiveEdge));
    ASSERT_DBG_PARAM(IS_LPTIM_TRIG_SAMPLE_TIME(hlptim->Init.Trigger.SampleTime));
  }
  ASSERT_DBG_PARAM(IS_LPTIM_UPDATE_MODE(hlptim->Init.UpdateMode));
  ASSERT_DBG_PARAM(IS_LPTIM_COUNTER_SOURCE(hlptim->Init.CounterSource));
  ASSERT_DBG_PARAM(IS_LPTIM_REPETITION(hlptim->Init.RepetitionCounter));
  ...
  if ((hlptim->Instance == LPTIM1) || (hlptim->Instance == LPTIM2))
  {
    ...
    ASSERT_DBG_PARAM(IS_LPTIM_INPUT1_SOURCE(hlptim->Instance, hlptim->Init.Input1Source));
    ASSERT_DBG_PARAM(IS_LPTIM_INPUT2_SOURCE(hlptim->Instance, hlptim->Init.Input2Source));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_DeInit(LPTIM_HandleTypeDef *hlptim)
{
  /* Check the LPTIM handle allocation */
  if (hlptim == NULL)
  {
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_PWM_Start(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_PWM_Stop(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_PWM_Start_IT(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_PWM_Stop_IT(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_PWM_Start_DMA(LPTIM_HandleTypeDef *hlptim, uint32_t Channel, uint32_t *pData,
                                     uint32_t Length)
{
  DMA_HandleTypeDef *hdma;

  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_DMA_INSTANCE(hlptim->Instance));
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_PWM_Stop_DMA(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_DMA_INSTANCE(hlptim->Instance));
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_OnePulse_Start(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_OnePulse_Stop(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_OnePulse_Start_IT(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_OnePulse_Stop_IT(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_SetOnce_Start(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_SetOnce_Stop(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_SetOnce_Start_IT(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_SetOnce_Stop_IT(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_Encoder_Start(LPTIM_HandleTypeDef *hlptim)
{
  uint32_t          tmpcfgr;

  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_ENCODER_INTERFACE_INSTANCE(hlptim->Instance));
  ASSERT_DBG_PARAM(hlptim->Init.Clock.Source == LPTIM_CLOCKSOURCE_APBCLOCK_LPOSC);
  ASSERT_DBG_PARAM(hlptim->Init.Clock.Prescaler == LPTIM_PRESCALER_DIV1);
  ASSERT_DBG_PARAM(IS_LPTIM_CLOCK_POLARITY(hlptim->Init.UltraLowPowerClock.Polarity));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_Encoder_Stop(LPTIM_HandleTypeDef *hlptim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_ENCODER_INTERFACE_INSTANCE(hlptim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_Encoder_Start_IT(LPTIM_HandleTypeDef *hlptim)
{
  uint32_t          tmpcfgr;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_Encoder_Stop_IT(LPTIM_HandleTypeDef *hlptim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_ENCODER_INTERFACE_INSTANCE(hlptim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_TimeOut_Start(LPTIM_HandleTypeDef *hlptim, uint32_t Timeout)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_INSTANCE(hlptim->Instance));
  ASSERT_DBG_PARAM(IS_LPTIM_PULSE(Timeout));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_TimeOut_Stop(LPTIM_HandleTypeDef *hlptim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_INSTANCE(hlptim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_TimeOut_Start_IT(LPTIM_HandleTypeDef *hlptim, uint32_t Timeout)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_INSTANCE(hlptim->Instance));
  ASSERT_DBG_PARAM(IS_LPTIM_PULSE(Timeout));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_TimeOut_Stop_IT(LPTIM_HandleTypeDef *hlptim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_INSTANCE(hlptim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_Counter_Start(LPTIM_HandleTypeDef *hlptim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_INSTANCE(hlptim->Instance));
      ...
      && (hlptim->Init.CounterSource == LPTIM_COUNTERSOURCE_EXTERNAL))
  {
    ...
    ASSERT_DBG_PARAM(IS_LPTIM_CLOCK_PRESCALERDIV1(hlptim->Init.Clock.Prescaler));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_Counter_Stop(LPTIM_HandleTypeDef *hlptim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_INSTANCE(hlptim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_Counter_Start_IT(LPTIM_HandleTypeDef *hlptim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_INSTANCE(hlptim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_Counter_Stop_IT(LPTIM_HandleTypeDef *hlptim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_INSTANCE(hlptim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_IC_Start(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_INPUT_CAPTURE_INSTANCE(hlptim->Instance));
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_IC_Stop(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_INPUT_CAPTURE_INSTANCE(hlptim->Instance));
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_IC_Start_IT(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_INPUT_CAPTURE_INSTANCE(hlptim->Instance));
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_IC_Stop_IT(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_INPUT_CAPTURE_INSTANCE(hlptim->Instance));
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_IC_Start_DMA(LPTIM_HandleTypeDef *hlptim, uint32_t Channel, uint32_t *pData,
                                    uint32_t Length)
{
  DMA_HandleTypeDef *hdma;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_IC_Stop_DMA(LPTIM_HandleTypeDef *hlptim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_DMA_INSTANCE(hlptim->Instance));
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_OC_ConfigChannel(LPTIM_HandleTypeDef *hlptim, LPTIM_OC_ConfigTypeDef *sConfig,
                                        uint32_t Channel)
{
  hal_status_t status;
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
  ASSERT_DBG_PARAM(IS_LPTIM_OC_POLARITY(sConfig->OCPolarity));
  ASSERT_DBG_PARAM(IS_LPTIM_PULSE(sConfig->Pulse));
  ...
  switch (Channel)
  {
    ...
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_LPTIM_CC1_INSTANCE(hlptim->Instance));
    ...
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_LPTIM_CC2_INSTANCE(hlptim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_LPTIM_IC_ConfigChannel(LPTIM_HandleTypeDef *hlptim, LPTIM_IC_ConfigTypeDef *sConfig,
                                        uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_CCX_INSTANCE(hlptim->Instance, Channel));
  ASSERT_DBG_PARAM(IS_LPTIM_IC_PRESCALER(sConfig->ICPrescaler));
  ASSERT_DBG_PARAM(IS_LPTIM_IC_POLARITY(sConfig->ICPolarity));
  ASSERT_DBG_PARAM(IS_LPTIM_IC_FILTER(sConfig->ICFilter));
  ...
  switch (Channel)
  {
    case LPTIM_CHANNEL_1:
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_LPTIM_CC1_INSTANCE(hlptim->Instance));
      ASSERT_DBG_PARAM(IS_LPTIM_IC1_SOURCE(hlptim->Instance, sConfig->ICInputSource));
    ...
    case LPTIM_CHANNEL_2:
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_LPTIM_CC2_INSTANCE(hlptim->Instance));
      ASSERT_DBG_PARAM(IS_LPTIM_IC2_SOURCE(hlptim->Instance, sConfig->ICInputSource));
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_LPTIM_RegisterCallback(LPTIM_HandleTypeDef        *hlptim,
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_LPTIM_UnRegisterCallback(LPTIM_HandleTypeDef        *hlptim,
                                          HAL_LPTIM_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
