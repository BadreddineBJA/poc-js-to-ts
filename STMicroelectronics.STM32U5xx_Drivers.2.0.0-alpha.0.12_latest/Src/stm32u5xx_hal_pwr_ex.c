...
/**
  ...
  * @retval HAL Status.
  */
hal_status_t HAL_PWREx_ControlVoltageScaling(uint32_t VoltageScaling)
{
  uint32_t timeout;
  uint32_t vos_old;

  /* Check the parameter */
  ASSERT_DBG_PARAM(IS_PWR_VOLTAGE_SCALING_RANGE(VoltageScaling));
...
/**
  ...
  * @retval HAL Status.
  */
hal_status_t HAL_PWREx_ConfigSupply(uint32_t SupplySource)
{
  uint32_t timeout;

  /* Check the parameter */
  ASSERT_DBG_PARAM(IS_PWR_SUPPLY(SupplySource));
...
void HAL_PWREx_EnterSTOP1Mode(uint8_t STOPEntry)
{
  ...
  ASSERT_DBG_PARAM(IS_PWR_STOP_ENTRY(STOPEntry));
...
{
  /* Check the parameter */
  ASSERT_DBG_PARAM(IS_PWR_SRD_STATE(SRDState));
...
/**
  ...
  * @retval HAL Status.
  */
hal_status_t HAL_PWREx_ConfigPVM(PWR_PVMTypeDef *pConfigPVM)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_PWR_PVM_TYPE(pConfigPVM->PVMType));
  ASSERT_DBG_PARAM(IS_PWR_PVM_MODE(pConfigPVM->Mode));
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_PWREx_EnableUSBHSTranceiverSupply(void)
{
  uint32_t vos;
...
{
  /* Check the parameter */
  ASSERT_DBG_PARAM(IS_PWR_BATTERY_RESISTOR_SELECT(ResistorValue));
...
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_PWR_SRAM2_STANDBY_RETENTION(SRAM2Pages));
...
void HAL_PWREx_EnableRAMsContentStopRetention(uint32_t RAMSelection)
{
  ...
  switch (RAMSelection & SRAM_ID_MASK)
  {
    ...
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_PWR_SRAM1_STOP_RETENTION(RAMSelection));
    ...
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_PWR_SRAM2_STOP_RETENTION(RAMSelection));
    ...
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_PWR_SRAM3_STOP_RETENTION(RAMSelection));
    ...
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_PWR_SRAM4_STOP_RETENTION(RAMSelection));
    ...
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_PWR_ICACHE_STOP_RETENTION(RAMSelection));
    ...
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_PWR_DCACHE1_STOP_RETENTION(RAMSelection));
    ...
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_PWR_DMA2DRAM_STOP_RETENTION(RAMSelection));
    ...
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_PWR_PERIPHRAM_STOP_RETENTION(RAMSelection));
    ...
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_PWR_PKA32RAM_STOP_RETENTION(RAMSelection));
    ...
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_PWR_DCACHE2_STOP_RETENTION(RAMSelection));
    ...
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_PWR_GRAPHICPRAM_STOP_RETENTION(RAMSelection));
    ...
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_PWR_DSIRAM_STOP_RETENTION(RAMSelection));
    ...
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_PWR_SRAM5_STOP_RETENTION(RAMSelection));
...
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_PWR_RAM_RUN_RETENTION(RAMSelection));
...
/**
  ...
  * @retval HAL Status.
  */
hal_status_t HAL_PWREx_EnableBkupRAMRetention(void)
{
  /*
...
/**
  ...
  * @retval HAL Status.
  */
hal_status_t HAL_PWREx_EnableGPIOPullUp(uint32_t GPIO_Port, uint32_t GPIO_Pin)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_PWR_GPIO_PORT(GPIO_Port));
  ASSERT_DBG_PARAM(IS_PWR_GPIO_PIN_MASK(GPIO_Pin));
...
/**
  ...
  * @retval HAL Status.
  */
hal_status_t HAL_PWREx_DisableGPIOPullUp(uint32_t GPIO_Port, uint32_t GPIO_Pin)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_PWR_GPIO_PORT(GPIO_Port));
  ASSERT_DBG_PARAM(IS_PWR_GPIO_PIN_MASK(GPIO_Pin));
...
/**
  ...
  * @retval HAL Status.
  */
hal_status_t HAL_PWREx_EnableGPIOPullDown(uint32_t GPIO_Port, uint32_t GPIO_Pin)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_PWR_GPIO_PORT(GPIO_Port));
  ASSERT_DBG_PARAM(IS_PWR_GPIO_PIN_MASK(GPIO_Pin));
...
/**
  ...
  * @retval HAL Status.
  */
hal_status_t HAL_PWREx_DisableGPIOPullDown(uint32_t GPIO_Port, uint32_t GPIO_Pin)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_PWR_GPIO_PORT(GPIO_Port));
  ASSERT_DBG_PARAM(IS_PWR_GPIO_PIN_MASK(GPIO_Pin));
...
#endif /* defined (USE_HAL_PWR_MODULE) */
