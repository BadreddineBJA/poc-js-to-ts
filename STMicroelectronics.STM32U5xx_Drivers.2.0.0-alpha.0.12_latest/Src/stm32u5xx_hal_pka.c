...
hal_status_t PKA_PollEndOfOperation(PKA_HandleTypeDef *hpka, uint32_t Timeout, uint32_t Tickstart);
...
hal_status_t PKA_Process(PKA_HandleTypeDef *hpka, uint32_t mode, uint32_t Timeout);
hal_status_t PKA_Process_IT(PKA_HandleTypeDef *hpka, uint32_t mode);
...
hal_status_t PKA_WaitOnFlagUntilTimeout(PKA_HandleTypeDef *hpka, uint32_t Flag, FlagStatus Status,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_Init(PKA_HandleTypeDef *hpka)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_DeInit(PKA_HandleTypeDef *hpka)
{
  hal_status_t err = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_RegisterCallback(PKA_HandleTypeDef *hpka, HAL_PKA_CallbackIDTypeDef CallbackID,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_UnRegisterCallback(PKA_HandleTypeDef *hpka, HAL_PKA_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ModExp(PKA_HandleTypeDef *hpka, PKA_ModExpInTypeDef *in, uint32_t Timeout)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ModExp_IT(PKA_HandleTypeDef *hpka, PKA_ModExpInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ModExp_Set(hpka, in);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ModExpFastMode(PKA_HandleTypeDef *hpka, PKA_ModExpFastModeInTypeDef *in, uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ModExpFastMode_IT(PKA_HandleTypeDef *hpka, PKA_ModExpFastModeInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ModExpFastMode_Set(hpka, in);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ModExpProtectMode(PKA_HandleTypeDef *hpka, PKA_ModExpProtectModeInTypeDef *in,
                                       uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ModExpProtectMode_IT(PKA_HandleTypeDef *hpka, PKA_ModExpProtectModeInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ModExpProtectMode_Set(hpka, in);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ECDSASign(PKA_HandleTypeDef *hpka, PKA_ECDSASignInTypeDef *in, uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ECDSASign_IT(PKA_HandleTypeDef *hpka, PKA_ECDSASignInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ECDSASign_Set(hpka, in);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ECDSAVerif(PKA_HandleTypeDef *hpka, PKA_ECDSAVerifInTypeDef *in, uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ECDSAVerif_IT(PKA_HandleTypeDef *hpka, PKA_ECDSAVerifInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ECDSAVerif_Set(hpka, in);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_RSACRTExp(PKA_HandleTypeDef *hpka, PKA_RSACRTExpInTypeDef *in, uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_RSACRTExp_IT(PKA_HandleTypeDef *hpka, PKA_RSACRTExpInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_RSACRTExp_Set(hpka, in);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_PointCheck(PKA_HandleTypeDef *hpka, PKA_PointCheckInTypeDef *in, uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_PointCheck_IT(PKA_HandleTypeDef *hpka, PKA_PointCheckInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_PointCheck_Set(hpka, in);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ECCMul(PKA_HandleTypeDef *hpka, PKA_ECCMulInTypeDef *in, uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ECCMul_IT(PKA_HandleTypeDef *hpka, PKA_ECCMulInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ECCMul_Set(hpka, in);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_Add(PKA_HandleTypeDef *hpka, PKA_AddInTypeDef *in, uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_Add_IT(PKA_HandleTypeDef *hpka, PKA_AddInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ARI_Set(hpka, in->size, in->pOp1, in->pOp2, NULL);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_Sub(PKA_HandleTypeDef *hpka, PKA_SubInTypeDef *in, uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
  PKA_ARI_Set(hpka, in->size, in->pOp1, in->pOp2, NULL);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_Sub_IT(PKA_HandleTypeDef *hpka, PKA_SubInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ARI_Set(hpka, in->size, in->pOp1, in->pOp2, NULL);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_Mul(PKA_HandleTypeDef *hpka, PKA_MulInTypeDef *in, uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
  PKA_ARI_Set(hpka, in->size, in->pOp1, in->pOp2, NULL);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_Mul_IT(PKA_HandleTypeDef *hpka, PKA_MulInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ARI_Set(hpka, in->size, in->pOp1, in->pOp2, NULL);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_Cmp(PKA_HandleTypeDef *hpka, PKA_CmpInTypeDef *in, uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
  PKA_ARI_Set(hpka, in->size, in->pOp1, in->pOp2, NULL);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_Cmp_IT(PKA_HandleTypeDef *hpka, PKA_CmpInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ARI_Set(hpka, in->size, in->pOp1, in->pOp2, NULL);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ModAdd(PKA_HandleTypeDef *hpka, PKA_ModAddInTypeDef *in, uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ModAdd_IT(PKA_HandleTypeDef *hpka, PKA_ModAddInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ARI_Set(hpka, in->size, in->pOp1, in->pOp2, in->pOp3);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ModInv(PKA_HandleTypeDef *hpka, PKA_ModInvInTypeDef *in, uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ModInv_IT(PKA_HandleTypeDef *hpka, PKA_ModInvInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ModInv_Set(hpka, in);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ModSub(PKA_HandleTypeDef *hpka, PKA_ModSubInTypeDef *in, uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
  PKA_ARI_Set(hpka, in->size, in->pOp1, in->pOp2, in->pOp3);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ModSub_IT(PKA_HandleTypeDef *hpka, PKA_ModSubInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ARI_Set(hpka, in->size, in->pOp1, in->pOp2, in->pOp3);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ModRed(PKA_HandleTypeDef *hpka, PKA_ModRedInTypeDef *in, uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ModRed_IT(PKA_HandleTypeDef *hpka, PKA_ModRedInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ModRed_Set(hpka, in);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_MontgomeryMul(PKA_HandleTypeDef *hpka, PKA_MontgomeryMulInTypeDef *in, uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
  PKA_ARI_Set(hpka, in->size, in->pOp1, in->pOp2, in->pOp3);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_MontgomeryMul_IT(PKA_HandleTypeDef *hpka, PKA_MontgomeryMulInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ARI_Set(hpka, in->size, in->pOp1, in->pOp2, in->pOp3);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_MontgomeryParam(PKA_HandleTypeDef *hpka, PKA_MontgomeryParamInTypeDef *in, uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_MontgomeryParam_IT(PKA_HandleTypeDef *hpka, PKA_MontgomeryParamInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_MontgomeryParam_Set(hpka, in->size, in->pOp1);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ECCDoubleBaseLadder(PKA_HandleTypeDef *hpka, PKA_ECCDoubleBaseLadderInTypeDef *in,
                                         uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ECCDoubleBaseLadder_IT(PKA_HandleTypeDef *hpka, PKA_ECCDoubleBaseLadderInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ECCDoubleBaseLadder_Set(hpka, in);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ECCProjective2Affine(PKA_HandleTypeDef *hpka, PKA_ECCProjective2AffineInTypeDef *in,
                                          uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ECCProjective2Affine_IT(PKA_HandleTypeDef *hpka, PKA_ECCProjective2AffineInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ECCProjective2Affine_Set(hpka, in);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ECCCompleteAddition(PKA_HandleTypeDef *hpka, PKA_ECCCompleteAdditionInTypeDef *in,
                                         uint32_t Timeout)
{
  /* Set input parameter in PKA RAM */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_ECCCompleteAddition_IT(PKA_HandleTypeDef *hpka, PKA_ECCCompleteAdditionInTypeDef *in)
{
  /* Set input parameter in PKA RAM */
  PKA_ECCCompleteAddition_Set(hpka, in);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_PKA_Abort(PKA_HandleTypeDef *hpka)
{
  hal_status_t err = HAL_OK;
