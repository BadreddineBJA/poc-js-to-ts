...
ErrorStatus LL_LPTIM_DeInit(LPTIM_TypeDef *LPTIMx)
{
  ...
  ASSERT_DBG_PARAM(IS_LPTIM_INSTANCE(LPTIMx));
...
ErrorStatus LL_LPTIM_Init(LPTIM_TypeDef *LPTIMx, LL_LPTIM_InitTypeDef *LPTIM_InitStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPTIM_INSTANCE(LPTIMx));
  ASSERT_DBG_PARAM(IS_LL_LPTIM_CLOCK_SOURCE(LPTIM_InitStruct->ClockSource));
  ASSERT_DBG_PARAM(IS_LL_LPTIM_CLOCK_PRESCALER(LPTIM_InitStruct->Prescaler));
  ASSERT_DBG_PARAM(IS_LL_LPTIM_WAVEFORM(LPTIM_InitStruct->Waveform));
