...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GFXMMU_Init(GFXMMU_HandleTypeDef *hgfxmmu)
{
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GFXMMU_DeInit(GFXMMU_HandleTypeDef *hgfxmmu)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GFXMMU_RegisterCallback(GFXMMU_HandleTypeDef        *hgfxmmu,
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GFXMMU_UnRegisterCallback(GFXMMU_HandleTypeDef        *hgfxmmu,
                                           HAL_GFXMMU_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GFXMMU_ConfigLut(GFXMMU_HandleTypeDef *hgfxmmu,
                                  uint32_t FirstLine,
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GFXMMU_DisableLutLines(GFXMMU_HandleTypeDef *hgfxmmu,
                                        uint32_t FirstLine,
                                        uint32_t LinesNumber)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GFXMMU_ConfigLutLine(GFXMMU_HandleTypeDef *hgfxmmu, GFXMMU_LutLineTypeDef *lutLine)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GFXMMU_ConfigForceCache(GFXMMU_HandleTypeDef *hgfxmmu, uint32_t ForceParam)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GFXMMU_ModifyBuffers(GFXMMU_HandleTypeDef *hgfxmmu, GFXMMU_BuffersTypeDef *Buffers)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_GFXMMU_ModifyCachePrefetch(GFXMMU_HandleTypeDef *hgfxmmu,
