...
static hal_status_t FMAC_Reset(FMAC_HandleTypeDef *hfmac);
static void FMAC_ResetDataPointers(FMAC_HandleTypeDef *hfmac);
static void FMAC_ResetOutputStateAndDataPointers(FMAC_HandleTypeDef *hfmac);
static void FMAC_ResetInputStateAndDataPointers(FMAC_HandleTypeDef *hfmac);
static hal_status_t FMAC_FilterConfig(FMAC_HandleTypeDef *hfmac, FMAC_FilterConfigTypeDef *pConfig,
                                      uint8_t PreloadAccess);
static hal_status_t FMAC_FilterPreload(FMAC_HandleTypeDef *hfmac, int16_t *pInput, uint8_t InputSize,
...
static hal_status_t FMAC_WaitOnStartUntilTimeout(FMAC_HandleTypeDef *hfmac, uint32_t Tickstart, uint32_t Timeout);
static hal_status_t FMAC_AppendFilterDataUpdateState(FMAC_HandleTypeDef *hfmac, int16_t *pInput,
                                                     uint16_t *pInputSize);
static hal_status_t FMAC_ConfigFilterOutputBufferUpdateState(FMAC_HandleTypeDef *hfmac, int16_t *pOutput,
...
/**
  ...
  */
hal_status_t HAL_FMAC_Init(FMAC_HandleTypeDef *hfmac)
{
  hal_status_t status;
...
/**
  ...
  * @retval hal_status_t HAL status
  */
hal_status_t HAL_FMAC_DeInit(FMAC_HandleTypeDef *hfmac)
{
  /* Check the FMAC handle allocation */
  if (hfmac == NULL)
  {
...
/**
  ...
  * @retval hal_status_t HAL status
  */
hal_status_t HAL_FMAC_RegisterCallback(FMAC_HandleTypeDef *hfmac, HAL_FMAC_CallbackIDTypeDef CallbackID,
...
/**
  ...
  * @retval hal_status_t HAL status
  */
hal_status_t HAL_FMAC_UnRegisterCallback(FMAC_HandleTypeDef *hfmac, HAL_FMAC_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval hal_status_t HAL status
  */
hal_status_t HAL_FMAC_FilterConfig(FMAC_HandleTypeDef *hfmac, FMAC_FilterConfigTypeDef *pConfig)
{
...
/**
  ...
  * @retval hal_status_t HAL status
  */
hal_status_t HAL_FMAC_FilterConfig_DMA(FMAC_HandleTypeDef *hfmac, FMAC_FilterConfigTypeDef *pConfig)
{
...
/**
  ...
  * @retval hal_status_t HAL status
  */
hal_status_t HAL_FMAC_FilterPreload(FMAC_HandleTypeDef *hfmac, int16_t *pInput, uint8_t InputSize,
...
/**
  ...
  * @retval hal_status_t HAL status
  */
hal_status_t HAL_FMAC_FilterPreload_DMA(FMAC_HandleTypeDef *hfmac, int16_t *pInput, uint8_t InputSize,
                                        int16_t *pOutput, uint8_t OutputSize)
{
...
/**
  ...
  * @retval hal_status_t HAL status
  */
hal_status_t HAL_FMAC_FilterStart(FMAC_HandleTypeDef *hfmac, int16_t *pOutput, uint16_t *pOutputSize)
{
  uint32_t tmpcr = 0U;
  hal_status_t status;
...
/**
  ...
  * @retval hal_status_t HAL status
  */
hal_status_t HAL_FMAC_AppendFilterData(FMAC_HandleTypeDef *hfmac, int16_t *pInput, uint16_t *pInputSize)
{
  hal_status_t status;
...
/**
  ...
  * @retval hal_status_t HAL status
  */
hal_status_t HAL_FMAC_ConfigFilterOutputBuffer(FMAC_HandleTypeDef *hfmac, int16_t *pOutput, uint16_t *pOutputSize)
{
  hal_status_t status;
...
/**
  ...
  * @retval hal_status_t HAL status
  */
hal_status_t HAL_FMAC_PollFilterData(FMAC_HandleTypeDef *hfmac, uint32_t Timeout)
{
  uint32_t tickstart;
  uint8_t inpolling;
...
/**
  ...
  * @retval hal_status_t HAL status
  */
hal_status_t HAL_FMAC_FilterStop(FMAC_HandleTypeDef *hfmac)
{
  hal_status_t status;
