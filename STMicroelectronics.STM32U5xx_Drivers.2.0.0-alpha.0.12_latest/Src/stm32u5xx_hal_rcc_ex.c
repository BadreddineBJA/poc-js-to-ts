...
/** @defgroup RCCEx_Private_Functions RCCEx Private Functions
  * @{
  */
static hal_status_t RCCEx_PLLSource_Enable(uint32_t PllSource);
static hal_status_t RCCEx_PLL2_Config(RCC_PLL2InitTypeDef *Pll2);
static hal_status_t RCCEx_PLL3_Config(RCC_PLL3InitTypeDef *Pll3);
/**
  * @}
  */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RCCEx_PeriphCLKConfig(RCC_PeriphCLKInitTypeDef  *pPeriphClkInit)
{
  uint32_t tmpregister;
  uint32_t tickstart;
  hal_status_t ret = HAL_OK;      /* Intermediate status */
  hal_status_t status = HAL_OK;   /* Final status */

  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RCC_PERIPHCLOCK(pPeriphClkInit->PeriphClockSelection));

  /*-------------------------- USART1 clock source configuration -------------------*/
  if (((pPeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_USART1) == RCC_PERIPHCLK_USART1)
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_USART1CLKSOURCE(pPeriphClkInit->Usart1ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_USART2CLKSOURCE(pPeriphClkInit->Usart2ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_USART3CLKSOURCE(pPeriphClkInit->Usart3ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_UART4CLKSOURCE(pPeriphClkInit->Uart4ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_UART5CLKSOURCE(pPeriphClkInit->Uart5ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_USART6CLKSOURCE(pPeriphClkInit->Usart6ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_LPUART1CLKSOURCE(pPeriphClkInit->Lpuart1ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_I2C1CLKSOURCE(pPeriphClkInit->I2c1ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_I2C2CLKSOURCE(pPeriphClkInit->I2c2ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_I2C3CLKSOURCE(pPeriphClkInit->I2c3ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_I2C4CLKSOURCE(pPeriphClkInit->I2c4ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_I2C5CLKSOURCE(pPeriphClkInit->I2c5ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_I2C6CLKSOURCE(pPeriphClkInit->I2c6ClockSelection));
  ...
  {
    ASSERT_DBG_PARAM(IS_RCC_LPTIM1CLK(pPeriphClkInit->Lptim1ClockSelection));
  ...
  {
    ASSERT_DBG_PARAM(IS_RCC_LPTIM2CLK(pPeriphClkInit->Lptim2ClockSelection));
  ...
  {
    ASSERT_DBG_PARAM(IS_RCC_LPTIM34CLK(pPeriphClkInit->Lptim34ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_SAI1CLK(pPeriphClkInit->Sai1ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_SAI2CLK(pPeriphClkInit->Sai2ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_ADCDACCLKSOURCE(pPeriphClkInit->AdcDacClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_MDF1CLKSOURCE(pPeriphClkInit->Mdf1ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_ADF1CLKSOURCE(pPeriphClkInit->Adf1ClockSelection));
  ...
  if ((pPeriphClkInit->PeriphClockSelection & RCC_PERIPHCLK_RTC) == RCC_PERIPHCLK_RTC)
  {
    ...
    ASSERT_DBG_PARAM(IS_RCC_RTCCLKSOURCE(pPeriphClkInit->RTCClockSelection));
    /* Enable Power Clock */
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_ICLKCLKSOURCE(pPeriphClkInit->IclkClockSelection));
  ...
  if (((pPeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_RNG) == RCC_PERIPHCLK_RNG)
  {
    ...
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_RNGCLKSOURCE(pPeriphClkInit->RngClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_SAESCLKSOURCE(pPeriphClkInit->SaesClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_SDMMCCLKSOURCE(pPeriphClkInit->SdmmcClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_SPI1CLKSOURCE(pPeriphClkInit->Spi1ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_SPI2CLKSOURCE(pPeriphClkInit->Spi2ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_SPI3CLKSOURCE(pPeriphClkInit->Spi3ClockSelection));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_OSPICLKSOURCE(pPeriphClkInit->OspiClockSelection));
  ...
  if (((pPeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_HSPI) == RCC_PERIPHCLK_HSPI)
  {
    ...
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_HSPICLKSOURCE(pPeriphClkInit->HspiClockSelection));
  ...
  {
    ASSERT_DBG_PARAM(IS_RCC_FDCAN1CLK(pPeriphClkInit->Fdcan1ClockSelection));
  ...
  if (((pPeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_DAC1) == RCC_PERIPHCLK_DAC1)
  {
    ...
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_DAC1CLKSOURCE(pPeriphClkInit->Dac1ClockSelection));
  ...
  if (((pPeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_LTDC) == RCC_PERIPHCLK_LTDC)
  {
    ...
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_LTDCCLKSOURCE(pPeriphClkInit->LtdcClockSelection));
  ...
  if (((pPeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_DSI) == RCC_PERIPHCLK_DSI)
  {
    ...
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_DSICLKSOURCE(pPeriphClkInit->DsiClockSelection));
  ...
  if (((pPeriphClkInit->PeriphClockSelection) & RCC_PERIPHCLK_USBPHY) == RCC_PERIPHCLK_USBPHY)
  {
    ...
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_RCC_USBPHYCLKSOURCE(pPeriphClkInit->UsbPhyClockSelection));
...
uint32_t HAL_RCCEx_GetPeriphCLKFreq(uint64_t PeriphClk)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RCC_PERIPHCLOCK(PeriphClk));
  ...
  if (PeriphClk == RCC_PERIPHCLK_RTC)
  {
    ...
    if ((HAL_IS_BIT_SET(RCC->BDCR, RCC_BDCR_LSIRDY)) && (srcclk == RCC_RTCCLKSOURCE_LSI))
    {
  ...
  else if (PeriphClk == RCC_PERIPHCLK_FDCAN1)
  {
    ...
    if (srcclk == RCC_FDCAN1CLKSOURCE_PLL1) /* PLL1 ? */
    {
      HAL_RCCEx_GetPLL1ClockFreq(&pll1_clocks);
      frequency = pll1_clocks.PLL1_Q_Frequency;
    }
#if defined(HSE_VALUE)
    else if ((HAL_IS_BIT_SET(RCC->CR, RCC_CR_HSERDY)) && (srcclk == RCC_FDCAN1CLKSOURCE_HSE))
    {
      frequency = HSE_VALUE;
    }
#endif /* HSE_VALUE */
  ...
  else if (PeriphClk == RCC_PERIPHCLK_DAC1)
  {
    ...
    if ((HAL_IS_BIT_SET(RCC->BDCR, RCC_BDCR_LSIRDY)) && (srcclk == RCC_DAC1CLKSOURCE_LSI))
    {
      if (HAL_IS_BIT_SET(RCC->BDCR, RCC_BDCR_LSIPREDIV))
      {
        frequency = LSI_VALUE / 128U;
    ...
    else if ((HAL_IS_BIT_SET(RCC->BDCR, RCC_BDCR_LSERDY)) && (srcclk == RCC_DAC1CLKSOURCE_LSE))
    {
      frequency = LSE_VALUE;
    }
#endif /* LSE_VALUE */
  ...
  else if (PeriphClk == RCC_PERIPHCLK_USBPHY)
  {
    ...
    if (srcclk == RCC_USBPHYCLKSOURCE_PLL1) /* PLL1P */
    {
      HAL_RCCEx_GetPLL1ClockFreq(&pll1_clocks);
      frequency = pll1_clocks.PLL1_P_Frequency;
    }
#if defined(HSE_VALUE)
    else if ((HAL_IS_BIT_SET(RCC->CR, RCC_CR_HSERDY)) && (srcclk == RCC_USBPHYCLKSOURCE_HSE))
    {
      frequency = HSE_VALUE;
    }
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RCCEx_EnablePLL2(RCC_PLL2InitTypeDef  *PLL2Init)
{
  uint32_t tickstart;
  hal_status_t status = HAL_OK;

  /* check for PLL2 Parameters used to output PLL2CLK */
  ASSERT_DBG_PARAM(IS_RCC_PLLSOURCE(PLL2Init->PLL2Source));
  ASSERT_DBG_PARAM(IS_RCC_PLLM_VALUE(PLL2Init->PLL2M));
  ASSERT_DBG_PARAM(IS_RCC_PLLN_VALUE(PLL2Init->PLL2N));
  ASSERT_DBG_PARAM(IS_RCC_PLLP_VALUE(PLL2Init->PLL2P));
  ASSERT_DBG_PARAM(IS_RCC_PLLQ_VALUE(PLL2Init->PLL2Q));
  ASSERT_DBG_PARAM(IS_RCC_PLLR_VALUE(PLL2Init->PLL2R));
  ASSERT_DBG_PARAM(IS_RCC_PLL2CLOCKOUT_VALUE(PLL2Init->PLL2ClockOut));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RCCEx_DisablePLL2(void)
{
  uint32_t tickstart;
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RCCEx_EnablePLL3(RCC_PLL3InitTypeDef  *PLL3Init)
{
  uint32_t tickstart;
  hal_status_t status = HAL_OK;

  /* check for PLL3 Parameters used to output PLL3CLK */
  ASSERT_DBG_PARAM(IS_RCC_PLLSOURCE(PLL3Init->PLL3Source));
  ASSERT_DBG_PARAM(IS_RCC_PLLM_VALUE(PLL3Init->PLL3M));
  ASSERT_DBG_PARAM(IS_RCC_PLLN_VALUE(PLL3Init->PLL3N));
  ASSERT_DBG_PARAM(IS_RCC_PLLP_VALUE(PLL3Init->PLL3P));
  ASSERT_DBG_PARAM(IS_RCC_PLL3CLOCKOUT_VALUE(PLL3Init->PLL3ClockOut));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RCCEx_DisablePLL3(void)
{
  uint32_t tickstart;
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RCCEx_EnableMSIPLLModeSelection(uint32_t MSIPLLModeSelection)
{
  hal_status_t status = HAL_ERROR;

  ASSERT_DBG_PARAM(IS_RCC_MSIPLLMODE_SELECT(MSIPLLModeSelection));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RCCEx_EnableMSIPLLFastStartup(void)
{
  hal_status_t status = HAL_ERROR;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_RCCEx_DisableMSIPLLFastStartup(void)
{
  hal_status_t status = HAL_ERROR;
...
{
  ASSERT_DBG_PARAM(IS_RCC_STOP_WAKEUPCLOCK(WakeUpClk));
...
{
  ASSERT_DBG_PARAM(IS_RCC_STOP_KERWAKEUPCLOCK(WakeUpClk));
...
{
  ASSERT_DBG_PARAM(IS_RCC_MSI_STANDBY_CLOCK_RANGE(MSIRange));
...
{
  ASSERT_DBG_PARAM(IS_RCC_MSIK_STANDBY_CLOCK_RANGE(MSIKRange));
...
void HAL_RCCEx_EnableLSCO(uint32_t LSCOSource)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RCC_LSCOSOURCE(LSCOSource));
...
void HAL_RCCEx_CRSConfig(const RCC_CRSInitTypeDef *const pInit)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RCC_CRS_SYNC_DIV(pInit->Prescaler));
  ASSERT_DBG_PARAM(IS_RCC_CRS_SYNC_SOURCE(pInit->Source));
  ASSERT_DBG_PARAM(IS_RCC_CRS_SYNC_POLARITY(pInit->Polarity));
  ASSERT_DBG_PARAM(IS_RCC_CRS_RELOADVALUE(pInit->ReloadValue));
  ASSERT_DBG_PARAM(IS_RCC_CRS_ERRORLIMIT(pInit->ErrorLimitValue));
  ASSERT_DBG_PARAM(IS_RCC_CRS_HSI48CALIBRATION(pInit->HSI48CalibrationValue));
...
{
  /* Check the parameter */
  ASSERT_DBG_PARAM(pSynchroInfo != (void *) NULL);
...
static hal_status_t RCCEx_PLL2_Config(RCC_PLL2InitTypeDef *pll2)
{
  ...
  uint32_t tickstart;
  ASSERT_DBG_PARAM(IS_RCC_PLLSOURCE(pll2->PLL2Source));
  ASSERT_DBG_PARAM(IS_RCC_PLLM_VALUE(pll2->PLL2M));
  ASSERT_DBG_PARAM(IS_RCC_PLLN_VALUE(pll2->PLL2N));
  ASSERT_DBG_PARAM(IS_RCC_PLLP_VALUE(pll2->PLL2P));
  ASSERT_DBG_PARAM(IS_RCC_PLLQ_VALUE(pll2->PLL2Q));
  ASSERT_DBG_PARAM(IS_RCC_PLLR_VALUE(pll2->PLL2R));
...
{
  uint32_t tickstart;
  ASSERT_DBG_PARAM(IS_RCC_PLLSOURCE(pll3->PLL3Source));
  ASSERT_DBG_PARAM(IS_RCC_PLLM_VALUE(pll3->PLL3M));
  ASSERT_DBG_PARAM(IS_RCC_PLLN_VALUE(pll3->PLL3N));
  ASSERT_DBG_PARAM(IS_RCC_PLLP_VALUE(pll3->PLL3P));
  ASSERT_DBG_PARAM(IS_RCC_PLLQ_VALUE(pll3->PLL3Q));
  ASSERT_DBG_PARAM(IS_RCC_PLLR_VALUE(pll3->PLL3R));
