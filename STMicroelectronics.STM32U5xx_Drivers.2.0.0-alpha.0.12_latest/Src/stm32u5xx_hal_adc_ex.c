...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADCEx_Calibration_Start(ADC_HandleTypeDef *hadc, uint32_t CalibrationMode, uint32_t SingleDiff)
{
  hal_status_t tmp_hal_status;
...
uint32_t HAL_ADCEx_Calibration_GetValue(ADC_HandleTypeDef *hadc, uint32_t SingleDiff)
{
  ...
  hal_status_t tmp_hal_status = HAL_OK;
...
/**
  ...
  * @retval HAL state
  */
hal_status_t HAL_ADCEx_LinearCalibration_GetValue(ADC_HandleTypeDef *hadc, uint32_t *pLinearCalib_Buffer)
{
  uint32_t cnt;
  hal_status_t tmp_hal_status;
...
/**
  ...
  * @retval HAL state
  */
hal_status_t HAL_ADCEx_Calibration_SetValue(ADC_HandleTypeDef *hadc, uint32_t SingleDiff,
...
/**
  ...
  * @retval HAL state
  */
hal_status_t HAL_ADCEx_LinearCalibration_SetValue(ADC_HandleTypeDef *hadc, uint32_t *pLinearCalib_Buffer)
{
  uint32_t cnt;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADCEx_InjectedStart(ADC_HandleTypeDef *hadc)
{
  hal_status_t tmp_hal_status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADCEx_InjectedStop(ADC_HandleTypeDef *hadc)
{
  hal_status_t tmp_hal_status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADCEx_InjectedPollForConversion(ADC_HandleTypeDef *hadc, uint32_t Timeout)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_ADCEx_InjectedStart_IT(ADC_HandleTypeDef *hadc)
{
  hal_status_t tmp_hal_status;
#if defined(ADC_MULTIMODE_SUPPORT)
  uint32_t tmp_multimode_config = LL_ADC_GetMultimode(__LL_ADC_COMMON_INSTANCE(hadc->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADCEx_InjectedStop_IT(ADC_HandleTypeDef *hadc)
{
  hal_status_t tmp_hal_status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADCEx_MultiModeStart_DMA(ADC_HandleTypeDef *hadc, const uint32_t *pData, uint32_t Length)
{
  hal_status_t tmp_hal_status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADCEx_MultiModeStop_DMA(ADC_HandleTypeDef *hadc)
{
  hal_status_t tmp_hal_status;
  uint32_t tickstart;
  ADC_HandleTypeDef tmp_hadc_slave;
  uint32_t tmp_hadc_slave_conversion_on_going;
  hal_status_t tmp_hadc_slave_disable_status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADCEx_MultiModeStart_DMA_Data32(ADC_HandleTypeDef *hadc, const uint32_t *pData, uint32_t Length)
{
  hal_status_t tmp_hal_status;
  ADC_HandleTypeDef tmp_hadc_slave;
  ADC_Common_TypeDef *tmp_adc_common;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_ADCEx_RegularStop(ADC_HandleTypeDef *hadc)
{
  hal_status_t tmp_hal_status;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_ADCEx_RegularStop_IT(ADC_HandleTypeDef *hadc)
{
  hal_status_t tmp_hal_status;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_ADCEx_RegularStop_DMA(ADC_HandleTypeDef *hadc)
{
  hal_status_t tmp_hal_status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADCEx_RegularMultiModeStop_DMA(ADC_HandleTypeDef *hadc)
{
  hal_status_t tmp_hal_status;
  ADC_HandleTypeDef tmp_hadc_slave;
  uint32_t tmp_hadc_slave_conversion_on_going;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADCEx_InjectedConfigChannel(ADC_HandleTypeDef *hadc, ADC_InjectionConfTypeDef *pConfigInjected)
{
  hal_status_t tmp_hal_status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADCEx_MultiModeConfigChannel(ADC_HandleTypeDef *hadc, ADC_MultiModeTypeDef *pMultimode)
{
  hal_status_t tmp_hal_status = HAL_OK;
  ADC_Common_TypeDef *tmp_adc_common;
  ADC_HandleTypeDef  tmp_hadc_slave;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADCEx_DisableVoltageRegulator(ADC_HandleTypeDef *hadc)
{
  hal_status_t tmp_hal_status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADCEx_EnterADCDeepPowerDownMode(ADC_HandleTypeDef *hadc)
{
  hal_status_t tmp_hal_status;
