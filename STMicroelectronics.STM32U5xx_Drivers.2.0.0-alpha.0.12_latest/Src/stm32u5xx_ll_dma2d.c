...
ErrorStatus LL_DMA2D_DeInit(DMA2D_TypeDef *DMA2Dx)
{
  ...
  ASSERT_DBG_PARAM(IS_DMA2D_ALL_INSTANCE(DMA2Dx));
...
ErrorStatus LL_DMA2D_Init(DMA2D_TypeDef *DMA2Dx, LL_DMA2D_InitTypeDef *DMA2D_InitStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DMA2D_ALL_INSTANCE(DMA2Dx));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_MODE(DMA2D_InitStruct->Mode));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_OCMODE(DMA2D_InitStruct->ColorMode));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_LINE(DMA2D_InitStruct->NbrOfLines));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_PIXEL(DMA2D_InitStruct->NbrOfPixelsPerLines));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_GREEN(DMA2D_InitStruct->OutputGreen));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_RED(DMA2D_InitStruct->OutputRed));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_BLUE(DMA2D_InitStruct->OutputBlue));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_ALPHA(DMA2D_InitStruct->OutputAlpha));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_SWAP_MODE(DMA2D_InitStruct->OutputSwapMode));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_OFFSET_MODE(DMA2D_InitStruct->LineOffsetMode));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_OFFSET(DMA2D_InitStruct->LineOffset));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_ALPHAINV(DMA2D_InitStruct->AlphaInversionMode));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_RBSWAP(DMA2D_InitStruct->RBSwapMode));
...
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LL_DMA2D_OFFSET(DMA2D_LayerCfg->LineOffset));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_LCMODE(DMA2D_LayerCfg->ColorMode));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_CLUTCMODE(DMA2D_LayerCfg->CLUTColorMode));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_CLUTSIZE(DMA2D_LayerCfg->CLUTSize));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_ALPHAMODE(DMA2D_LayerCfg->AlphaMode));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_GREEN(DMA2D_LayerCfg->Green));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_RED(DMA2D_LayerCfg->Red));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_BLUE(DMA2D_LayerCfg->Blue));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_ALPHA(DMA2D_LayerCfg->Alpha));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_ALPHAINV(DMA2D_LayerCfg->AlphaInversionMode));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_RBSWAP(DMA2D_LayerCfg->RBSwapMode));
...
void LL_DMA2D_ConfigOutputColor(DMA2D_TypeDef *DMA2Dx, LL_DMA2D_ColorTypeDef *DMA2D_ColorStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DMA2D_ALL_INSTANCE(DMA2Dx));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_OCMODE(DMA2D_ColorStruct->ColorMode));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_GREEN(DMA2D_ColorStruct->OutputGreen));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_RED(DMA2D_ColorStruct->OutputRed));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_BLUE(DMA2D_ColorStruct->OutputBlue));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_ALPHA(DMA2D_ColorStruct->OutputAlpha));
...
uint32_t LL_DMA2D_GetOutputBlueColor(DMA2D_TypeDef *DMA2Dx, uint32_t ColorMode)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DMA2D_ALL_INSTANCE(DMA2Dx));
  ASSERT_DBG_PARAM(IS_LL_DMA2D_OCMODE(ColorMode));
