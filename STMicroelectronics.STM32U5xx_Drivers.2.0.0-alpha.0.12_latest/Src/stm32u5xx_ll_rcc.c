...
uint32_t LL_RCC_GetUSARTClockFreq(uint32_t USARTxSource)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_USART_CLKSOURCE(USARTxSource));
...
uint32_t LL_RCC_GetUARTClockFreq(uint32_t UARTxSource)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_UART_CLKSOURCE(UARTxSource));
...
uint32_t LL_RCC_GetSPIClockFreq(uint32_t SPIxSource)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_SPI_CLKSOURCE(SPIxSource));
...
uint32_t LL_RCC_GetI2CClockFreq(uint32_t I2CxSource)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_I2C_CLKSOURCE(I2CxSource));
...
uint32_t LL_RCC_GetLPUARTClockFreq(uint32_t LPUARTxSource)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_LPUART_CLKSOURCE(LPUARTxSource));
...
uint32_t LL_RCC_GetLPTIMClockFreq(uint32_t LPTIMxSource)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_LPTIM_CLKSOURCE(LPTIMxSource));
...
uint32_t LL_RCC_GetSAIClockFreq(uint32_t SAIxSource)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_SAI_CLKSOURCE(SAIxSource));
...
uint32_t LL_RCC_GetSDMMCKernelClockFreq(uint32_t SDMMCxSource)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_SDMMC_KERNELCLKSOURCE(SDMMCxSource));
...
uint32_t LL_RCC_GetSDMMCClockFreq(uint32_t SDMMCxSource)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_SDMMC_CLKSOURCE(SDMMCxSource));
...
uint32_t LL_RCC_GetRNGClockFreq(uint32_t RNGxSource)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_RNG_CLKSOURCE(RNGxSource));
...
uint32_t LL_RCC_GetUSBClockFreq(uint32_t USBxSource)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_USB_CLKSOURCE(USBxSource));
...
uint32_t LL_RCC_GetADCDACClockFreq(uint32_t ADCxSource)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_ADCDAC_CLKSOURCE(ADCxSource));
...
uint32_t LL_RCC_GetADF1ClockFreq(uint32_t ADF1Source)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_ADF1_CLKSOURCE(ADF1Source));
...
uint32_t LL_RCC_GetMDF1ClockFreq(uint32_t MDF1Source)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_MDF1_CLKSOURCE(MDF1Source));
...
uint32_t LL_RCC_GetDAC1ClockFreq(uint32_t DAC1Source)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_DAC1_CLKSOURCE(DAC1Source));
...
uint32_t LL_RCC_GetOCTOSPIClockFreq(uint32_t OCTOSPIxSource)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_OCTOSPI_CLKSOURCE(OCTOSPIxSource));
...
uint32_t LL_RCC_GetSAESClockFreq(uint32_t SAESxSource)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_SAES_CLKSOURCE(SAESxSource));
...
uint32_t LL_RCC_GetFDCANClockFreq(uint32_t FDCANxSource)
{
  ...
  /* Check parameter */
  ASSERT_DBG_PARAM(IS_LL_RCC_FDCAN_CLKSOURCE(FDCANxSource));
