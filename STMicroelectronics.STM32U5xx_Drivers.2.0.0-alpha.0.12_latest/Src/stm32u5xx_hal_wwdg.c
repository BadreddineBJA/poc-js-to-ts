...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_WWDG_Init(WWDG_HandleTypeDef *hwwdg)
{
  ...
  ASSERT_DBG_PARAM(IS_WWDG_ALL_INSTANCE(hwwdg->Instance));
  ASSERT_DBG_PARAM(IS_WWDG_PRESCALER(hwwdg->Init.Prescaler));
  ASSERT_DBG_PARAM(IS_WWDG_WINDOW(hwwdg->Init.Window));
  ASSERT_DBG_PARAM(IS_WWDG_COUNTER(hwwdg->Init.Counter));
  ASSERT_DBG_PARAM(IS_WWDG_EWI_MODE(hwwdg->Init.EWIMode));
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_WWDG_RegisterCallback(WWDG_HandleTypeDef *hwwdg, HAL_WWDG_CallbackIDTypeDef CallbackID,
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_WWDG_UnRegisterCallback(WWDG_HandleTypeDef *hwwdg, HAL_WWDG_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_WWDG_Refresh(WWDG_HandleTypeDef *hwwdg)
{
