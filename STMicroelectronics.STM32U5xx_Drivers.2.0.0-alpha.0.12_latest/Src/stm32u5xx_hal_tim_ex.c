...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_HallSensor_Init(TIM_HandleTypeDef *htim, const TIM_HallSensor_InitTypeDef *sConfig)
{
  ...
  ASSERT_DBG_PARAM(IS_TIM_HALL_SENSOR_INTERFACE_INSTANCE(htim->Instance));
  ...
  ASSERT_DBG_PARAM(IS_TIM_IC_POLARITY(sConfig->IC1Polarity));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_HallSensor_DeInit(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_HallSensor_Start(TIM_HandleTypeDef *htim)
{
  uint32_t tmpsmcr;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_HallSensor_Stop(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_HALL_SENSOR_INTERFACE_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_HallSensor_Start_IT(TIM_HandleTypeDef *htim)
{
  uint32_t tmpsmcr;
  HAL_TIM_ChannelStateTypeDef channel_1_state = TIM_CHANNEL_STATE_GET(htim, TIM_CHANNEL_1);
  HAL_TIM_ChannelStateTypeDef channel_2_state = TIM_CHANNEL_STATE_GET(htim, TIM_CHANNEL_2);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_HallSensor_Stop_IT(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_HALL_SENSOR_INTERFACE_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_HallSensor_Start_DMA(TIM_HandleTypeDef *htim, uint32_t *pData, uint16_t Length)
{
  uint32_t tmpsmcr;
  HAL_TIM_ChannelStateTypeDef channel_1_state = TIM_CHANNEL_STATE_GET(htim, TIM_CHANNEL_1);
  HAL_TIM_ChannelStateTypeDef complementary_channel_1_state = TIM_CHANNEL_N_STATE_GET(htim, TIM_CHANNEL_1);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_HallSensor_Stop_DMA(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_HALL_SENSOR_INTERFACE_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_OCN_Start(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  uint32_t tmpsmcr;

  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_CCXN_INSTANCE(htim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_OCN_Stop(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_CCXN_INSTANCE(htim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_OCN_Start_IT(TIM_HandleTypeDef *htim, uint32_t Channel)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_OCN_Stop_IT(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  hal_status_t status = HAL_OK;
  uint32_t tmpccer;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_OCN_Start_DMA(TIM_HandleTypeDef *htim, uint32_t Channel, const uint32_t *pData,
                                     uint16_t Length)
{
  hal_status_t status = HAL_OK;
  uint32_t tmpsmcr;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_OCN_Stop_DMA(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_PWMN_Start(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  uint32_t tmpsmcr;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_PWMN_Stop(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_CCXN_INSTANCE(htim->Instance, Channel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_PWMN_Start_IT(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  hal_status_t status = HAL_OK;
  uint32_t tmpsmcr;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_PWMN_Stop_IT(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  hal_status_t status = HAL_OK;
  uint32_t tmpccer;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_PWMN_Start_DMA(TIM_HandleTypeDef *htim, uint32_t Channel, const uint32_t *pData, uint16_t Length)
{
  hal_status_t status = HAL_OK;
  uint32_t tmpsmcr;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_PWMN_Stop_DMA(TIM_HandleTypeDef *htim, uint32_t Channel)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_OnePulseN_Start(TIM_HandleTypeDef *htim, uint32_t OutputChannel)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_CCXN_INSTANCE(htim->Instance, OutputChannel));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_OnePulseN_Stop(TIM_HandleTypeDef *htim, uint32_t OutputChannel)
{
  uint32_t input_channel = (OutputChannel == TIM_CHANNEL_1) ? TIM_CHANNEL_2 : TIM_CHANNEL_1;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_OnePulseN_Start_IT(TIM_HandleTypeDef *htim, uint32_t OutputChannel)
{
  uint32_t input_channel = (OutputChannel == TIM_CHANNEL_1) ? TIM_CHANNEL_2 : TIM_CHANNEL_1;
  HAL_TIM_ChannelStateTypeDef channel_1_state = TIM_CHANNEL_STATE_GET(htim, TIM_CHANNEL_1);
  HAL_TIM_ChannelStateTypeDef channel_2_state = TIM_CHANNEL_STATE_GET(htim, TIM_CHANNEL_2);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_OnePulseN_Stop_IT(TIM_HandleTypeDef *htim, uint32_t OutputChannel)
{
  uint32_t input_channel = (OutputChannel == TIM_CHANNEL_1) ? TIM_CHANNEL_2 : TIM_CHANNEL_1;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_ConfigCommutEvent(TIM_HandleTypeDef *htim, uint32_t  InputTrigger,
                                         uint32_t  CommutationSource)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_COMMUTATION_EVENT_INSTANCE(htim->Instance));
  ASSERT_DBG_PARAM(IS_TIM_INTERNAL_TRIGGEREVENT_INSTANCE(htim->Instance, InputTrigger));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_ConfigCommutEvent_IT(TIM_HandleTypeDef *htim, uint32_t  InputTrigger,
                                            uint32_t  CommutationSource)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_COMMUTATION_EVENT_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_ConfigCommutEvent_DMA(TIM_HandleTypeDef *htim, uint32_t  InputTrigger,
                                             uint32_t  CommutationSource)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_COMMUTATION_EVENT_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_MasterConfigSynchronization(TIM_HandleTypeDef *htim,
                                                   const TIM_MasterConfigTypeDef *sMasterConfig)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_MASTER_INSTANCE(htim->Instance));
  ASSERT_DBG_PARAM(IS_TIM_TRGO_SOURCE(sMasterConfig->MasterOutputTrigger));
  ASSERT_DBG_PARAM(IS_TIM_MSM_STATE(sMasterConfig->MasterSlaveMode));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_TIM_TRGO2_SOURCE(sMasterConfig->MasterOutputTrigger2));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_ConfigBreakDeadTime(TIM_HandleTypeDef *htim,
                                           const TIM_BreakDeadTimeConfigTypeDef *sBreakDeadTimeConfig)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_BREAK_INSTANCE(htim->Instance));
  ASSERT_DBG_PARAM(IS_TIM_OSSR_STATE(sBreakDeadTimeConfig->OffStateRunMode));
  ASSERT_DBG_PARAM(IS_TIM_OSSI_STATE(sBreakDeadTimeConfig->OffStateIDLEMode));
  ASSERT_DBG_PARAM(IS_TIM_LOCK_LEVEL(sBreakDeadTimeConfig->LockLevel));
  ASSERT_DBG_PARAM(IS_TIM_DEADTIME(sBreakDeadTimeConfig->DeadTime));
  ASSERT_DBG_PARAM(IS_TIM_BREAK_STATE(sBreakDeadTimeConfig->BreakState));
  ASSERT_DBG_PARAM(IS_TIM_BREAK_POLARITY(sBreakDeadTimeConfig->BreakPolarity));
  ASSERT_DBG_PARAM(IS_TIM_BREAK_FILTER(sBreakDeadTimeConfig->BreakFilter));
  ASSERT_DBG_PARAM(IS_TIM_AUTOMATIC_OUTPUT_STATE(sBreakDeadTimeConfig->AutomaticOutput));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_TIM_BREAK_AFMODE(sBreakDeadTimeConfig->BreakAFMode));
  ...
  {
    /* Check the parameters */
    ASSERT_DBG_PARAM(IS_TIM_BREAK2_STATE(sBreakDeadTimeConfig->Break2State));
    ASSERT_DBG_PARAM(IS_TIM_BREAK2_POLARITY(sBreakDeadTimeConfig->Break2Polarity));
    ASSERT_DBG_PARAM(IS_TIM_BREAK_FILTER(sBreakDeadTimeConfig->Break2Filter));
    ...
    {
      /* Check the parameters */
      ASSERT_DBG_PARAM(IS_TIM_BREAK2_AFMODE(sBreakDeadTimeConfig->Break2AFMode));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_ConfigBreakInput(TIM_HandleTypeDef *htim,
                                        uint32_t BreakInput,
...

{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_BREAK_INSTANCE(htim->Instance));
  ASSERT_DBG_PARAM(IS_TIM_BREAKINPUT(BreakInput));
  ASSERT_DBG_PARAM(IS_TIM_BREAKINPUTSOURCE(sBreakInputConfig->Source));
  ASSERT_DBG_PARAM(IS_TIM_BREAKINPUTSOURCE_STATE(sBreakInputConfig->Enable));
  if (sBreakInputConfig->Source != TIM_BREAKINPUTSOURCE_MDF1)
  {
    ASSERT_DBG_PARAM(IS_TIM_BREAKINPUTSOURCE_POLARITY(sBreakInputConfig->Polarity));
  }
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_RemapConfig(TIM_HandleTypeDef *htim, uint32_t Remap)
{
  /* Check parameters */
  ASSERT_DBG_PARAM(IS_TIM_REMAP_INSTANCE(htim->Instance));
  ASSERT_DBG_PARAM(IS_TIM_REMAP(Remap));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t  HAL_TIMEx_TISelection(TIM_HandleTypeDef *htim, uint32_t TISelection, uint32_t Channel)
{
  hal_status_t status = HAL_OK;

  /* Check parameters */
  ASSERT_DBG_PARAM(IS_TIM_TISEL_INSTANCE(htim->Instance));
  ASSERT_DBG_PARAM(IS_TIM_TISEL(TISelection));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_GroupChannel5(TIM_HandleTypeDef *htim, uint32_t Channels)
{
  /* Check parameters */
  ASSERT_DBG_PARAM(IS_TIM_COMBINED3PHASEPWM_INSTANCE(htim->Instance));
  ASSERT_DBG_PARAM(IS_TIM_GROUPCH5(Channels));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_DisarmBreakInput(TIM_HandleTypeDef *htim, uint32_t BreakInput)
{
  hal_status_t status = HAL_OK;
  uint32_t tmpbdtr;

  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_ADVANCED_INSTANCE(htim->Instance));
  ASSERT_DBG_PARAM(IS_TIM_BREAKINPUT(BreakInput));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_ReArmBreakInput(TIM_HandleTypeDef *htim, uint32_t BreakInput)
{
  hal_status_t status = HAL_OK;
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_DitheringEnable(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_DitheringDisable(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_OC_ConfigPulseOnCompare(TIM_HandleTypeDef *htim,
                                               ...
                                               uint32_t PulseWidth)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_PULSEONCOMPARE_INSTANCE(htim->Instance));
  ASSERT_DBG_PARAM(IS_TIM_PULSEONCOMPARE_WIDTH(PulseWidth));
  ASSERT_DBG_PARAM(IS_TIM_PULSEONCOMPARE_WIDTHPRESCALER(PulseWidthPrescaler));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_ConfigSlaveModePreload(TIM_HandleTypeDef *htim, uint32_t Source)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_SLAVE_INSTANCE(htim->Instance));
  ASSERT_DBG_PARAM(IS_TIM_SLAVE_PRELOAD_SOURCE(Source));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_EnableSlaveModePreload(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_SLAVE_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_DisableSlaveModePreload(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_SLAVE_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_EnableDeadTimePreload(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_BREAK_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_DisableDeadTimePreload(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_BREAK_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_ConfigDeadTime(TIM_HandleTypeDef *htim, uint32_t Deadtime)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_BREAK_INSTANCE(htim->Instance));
  ASSERT_DBG_PARAM(IS_TIM_DEADTIME(Deadtime));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_ConfigAsymmetricalDeadTime(TIM_HandleTypeDef *htim, uint32_t FallingDeadtime)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_BREAK_INSTANCE(htim->Instance));
  ASSERT_DBG_PARAM(IS_TIM_DEADTIME(FallingDeadtime));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_EnableAsymmetricalDeadTime(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_BREAK_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_DisableAsymmetricalDeadTime(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_BREAK_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_ConfigEncoderIndex(TIM_HandleTypeDef *htim,
                                          TIMEx_EncoderIndexConfigTypeDef *sEncoderIndexConfig)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_ENCODER_INTERFACE_INSTANCE(htim->Instance));
  ASSERT_DBG_PARAM(IS_TIM_ENCODERINDEX_POLARITY(sEncoderIndexConfig->Polarity));
  ASSERT_DBG_PARAM(IS_TIM_ENCODERINDEX_PRESCALER(sEncoderIndexConfig->Prescaler));
  ASSERT_DBG_PARAM(IS_TIM_ENCODERINDEX_FILTER(sEncoderIndexConfig->Filter));
  ASSERT_DBG_PARAM(IS_TIM_ENCODERINDEX_BLANKING(sEncoderIndexConfig->Blanking));
  ASSERT_DBG_PARAM(IS_FUNCTIONAL_STATE(sEncoderIndexConfig->FirstIndexEnable));
  ASSERT_DBG_PARAM(IS_TIM_ENCODERINDEX_POSITION(sEncoderIndexConfig->Position));
  ASSERT_DBG_PARAM(IS_TIM_ENCODERINDEX_DIRECTION(sEncoderIndexConfig->Direction));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_EnableEncoderIndex(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_ENCODER_INTERFACE_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_DisableEncoderIndex(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_ENCODER_INTERFACE_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_EnableEncoderFirstIndex(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_ENCODER_INTERFACE_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_TIMEx_DisableEncoderFirstIndex(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_ENCODER_INTERFACE_INSTANCE(htim->Instance));
...
HAL_TIM_ChannelStateTypeDef HAL_TIMEx_GetChannelNState(const TIM_HandleTypeDef *htim,  uint32_t ChannelN)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_CCXN_INSTANCE(htim->Instance, ChannelN));
...
/**
  ...
  * @retval  HAL status.
  */
hal_status_t HAL_TIMEx_EnableHSE32(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_HSE32_INSTANCE(htim->Instance));
...
/**
  ...
  * @retval  HAL status.
  */
hal_status_t HAL_TIMEx_DisableHSE32(TIM_HandleTypeDef *htim)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_TIM_HSE32_INSTANCE(htim->Instance));
