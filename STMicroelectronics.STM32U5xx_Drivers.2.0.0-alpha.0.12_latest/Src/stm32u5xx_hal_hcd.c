...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_HCD_Init(HCD_HandleTypeDef *hhcd)
{
  ...
  ASSERT_DBG_PARAM(IS_HCD_ALL_INSTANCE(hhcd->Instance));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_HCD_HC_Init(HCD_HandleTypeDef *hhcd,
                             uint8_t ch_num,
                             uint8_t epnum,
                             uint8_t dev_address,
                             uint8_t speed,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_HCD_HC_Halt(HCD_HandleTypeDef *hhcd, uint8_t ch_num)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_HCD_DeInit(HCD_HandleTypeDef *hhcd)
{
  /* Check the HCD handle allocation */
  if (hhcd == NULL)
  {
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_HCD_HC_SubmitRequest(HCD_HandleTypeDef *hhcd,
                                      uint8_t ch_num,
                                      uint8_t direction,
                                      uint8_t ep_type,
                                      uint8_t token,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_HCD_RegisterCallback(HCD_HandleTypeDef *hhcd,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_HCD_UnRegisterCallback(HCD_HandleTypeDef *hhcd, HAL_HCD_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_HCD_RegisterHC_NotifyURBChangeCallback(HCD_HandleTypeDef *hhcd,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_HCD_UnRegisterHC_NotifyURBChangeCallback(HCD_HandleTypeDef *hhcd)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_HCD_Start(HCD_HandleTypeDef *hhcd)
{
  __HAL_LOCK(hhcd);
  /* Enable port power */
...
hal_status_t HAL_HCD_Stop(HCD_HandleTypeDef *hhcd)
{
  __HAL_LOCK(hhcd);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_HCD_ResetPort(HCD_HandleTypeDef *hhcd)
{
