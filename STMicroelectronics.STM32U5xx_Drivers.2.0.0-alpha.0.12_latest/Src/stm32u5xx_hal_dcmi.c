...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DCMI_Init(DCMI_HandleTypeDef *hdcmi)
{
...
hal_status_t HAL_DCMI_DeInit(DCMI_HandleTypeDef *hdcmi)
{
#if (USE_HAL_DCMI_REGISTER_CALLBACKS == 1)
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DCMI_Start_DMA(DCMI_HandleTypeDef *hdcmi, uint32_t DCMI_Mode, uint32_t pData, uint32_t Length)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DCMI_Stop(DCMI_HandleTypeDef *hdcmi)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DCMI_Suspend(DCMI_HandleTypeDef *hdcmi)
{
  uint32_t count = HAL_TIMEOUT_DCMI_STOP * (SystemCoreClock / 8U / 1000U);
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DCMI_Resume(DCMI_HandleTypeDef *hdcmi)
{
  /* Process locked */
  __HAL_LOCK(hdcmi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DCMI_ConfigCrop(DCMI_HandleTypeDef *hdcmi, uint32_t X0, uint32_t Y0, uint32_t XSize,
                                 uint32_t YSize)
{
  /* Process Locked */
  __HAL_LOCK(hdcmi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DCMI_DisableCrop(DCMI_HandleTypeDef *hdcmi)
{
  /* Process Locked */
  __HAL_LOCK(hdcmi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DCMI_EnableCrop(DCMI_HandleTypeDef *hdcmi)
{
  /* Process Locked */
  __HAL_LOCK(hdcmi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t  HAL_DCMI_ConfigSyncUnmask(DCMI_HandleTypeDef *hdcmi, DCMI_SyncUnmaskTypeDef *SyncUnmask)
{
  /* Process Locked */
  __HAL_LOCK(hdcmi);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DCMI_RegisterCallback(DCMI_HandleTypeDef *hdcmi, HAL_DCMI_CallbackIDTypeDef CallbackID,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DCMI_UnRegisterCallback(DCMI_HandleTypeDef *hdcmi, HAL_DCMI_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
