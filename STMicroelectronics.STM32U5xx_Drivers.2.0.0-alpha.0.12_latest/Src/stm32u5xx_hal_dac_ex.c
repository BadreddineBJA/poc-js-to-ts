...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DACEx_DualStart(DAC_HandleTypeDef *hdac)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DACEx_DualStop(DAC_HandleTypeDef *hdac)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DACEx_DualStart_DMA(DAC_HandleTypeDef *hdac, uint32_t Channel, uint32_t *pData, uint32_t Length,
                                          uint32_t Alignment)
{
  hal_status_t status;
  uint32_t tmpreg = 0UL;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DACEx_DualStop_DMA(DAC_HandleTypeDef *hdac, uint32_t Channel)
{
  hal_status_t status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DACEx_TriangleWaveGenerate(DAC_HandleTypeDef *hdac, uint32_t Channel, uint32_t Amplitude)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DAC_CHANNEL(Channel));
  ASSERT_DBG_PARAM(IS_DAC_LFSR_UNMASK_TRIANGLE_AMPLITUDE(Amplitude));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DACEx_NoiseWaveGenerate(DAC_HandleTypeDef *hdac, uint32_t Channel, uint32_t Amplitude)
{
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DAC_CHANNEL(Channel));
  ASSERT_DBG_PARAM(IS_DAC_LFSR_UNMASK_TRIANGLE_AMPLITUDE(Amplitude));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DACEx_DualSetValue(DAC_HandleTypeDef *hdac, uint32_t Alignment, uint32_t Data1, uint32_t Data2)
{
  uint32_t data;
  uint32_t tmp;
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DAC_ALIGN(Alignment));
  ASSERT_DBG_PARAM(IS_DAC_DATA(Data1));
  ASSERT_DBG_PARAM(IS_DAC_DATA(Data2));
...
/**
  ...
  */
hal_status_t HAL_DACEx_SelfCalibrate(DAC_HandleTypeDef *hdac, DAC_ChannelConfTypeDef *sConfig, uint32_t Channel)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DACEx_SetUserTrimming(DAC_HandleTypeDef *hdac, DAC_ChannelConfTypeDef *sConfig, uint32_t Channel,
                                            uint32_t NewTrimmingValue)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_DAC_CHANNEL(Channel));
  ASSERT_DBG_PARAM(IS_DAC_NEWTRIMMINGVALUE(NewTrimmingValue));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DACEx_SetConfigAutonomousMode(DAC_HandleTypeDef *hdac, DAC_AutonomousModeConfTypeDef *sConfig)
{
  ASSERT_DBG_PARAM(IS_DAC_AUTONOMOUS(sConfig->AutonomousModeState));
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DACEx_GetConfigAutonomousMode(DAC_HandleTypeDef *hdac, DAC_AutonomousModeConfTypeDef *sConfig)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_DACEx_ClearConfigAutonomousMode(DAC_HandleTypeDef *hdac)
{
  if (hdac->State == HAL_DAC_STATE_READY)
  {
    /* Process Locked */
