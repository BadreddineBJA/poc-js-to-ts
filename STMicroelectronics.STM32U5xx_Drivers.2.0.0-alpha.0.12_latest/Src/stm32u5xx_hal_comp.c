...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_COMP_Init(COMP_HandleTypeDef *hcomp)
{
  uint32_t tmp_csr;
  uint32_t exti_line;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_COMP_DeInit(COMP_HandleTypeDef *hcomp)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_COMP_RegisterCallback(COMP_HandleTypeDef *hcomp, HAL_COMP_CallbackIDTypeDef CallbackID,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_COMP_UnRegisterCallback(COMP_HandleTypeDef *hcomp, HAL_COMP_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_COMP_Start(COMP_HandleTypeDef *hcomp)
{
  __IO uint32_t wait_loop_index = 0UL;
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_COMP_Stop(COMP_HandleTypeDef *hcomp)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_COMP_Lock(COMP_HandleTypeDef *hcomp)
{
  hal_status_t status = HAL_OK;
