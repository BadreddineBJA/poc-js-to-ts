...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADC_Init(ADC_HandleTypeDef *hadc)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADC_DeInit(ADC_HandleTypeDef *hadc)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADC_RegisterCallback(ADC_HandleTypeDef *hadc, HAL_ADC_CallbackIDTypeDef CallbackID,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADC_UnRegisterCallback(ADC_HandleTypeDef *hadc, HAL_ADC_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADC_Start(ADC_HandleTypeDef *hadc)
{
  hal_status_t tmp_hal_status;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_ADC_Stop(ADC_HandleTypeDef *hadc)
{
  hal_status_t tmp_hal_status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADC_PollForConversion(ADC_HandleTypeDef *hadc, uint32_t Timeout)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADC_PollForEvent(ADC_HandleTypeDef *hadc, uint32_t EventType, uint32_t Timeout)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADC_Start_IT(ADC_HandleTypeDef *hadc)
{
  hal_status_t tmp_hal_status;
#if defined(ADC_MULTIMODE_SUPPORT)
  const ADC_TypeDef       *tmp_adc_master;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_ADC_Stop_IT(ADC_HandleTypeDef *hadc)
{
  hal_status_t tmp_hal_status;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_ADC_Start_DMA(ADC_HandleTypeDef *hadc, const uint32_t *pData, uint32_t Length)
{
  hal_status_t tmp_hal_status;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_ADC_Stop_DMA(ADC_HandleTypeDef *hadc)
{
  hal_status_t tmp_hal_status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADC_ConfigChannel(ADC_HandleTypeDef *hadc, ADC_ChannelConfTypeDef *pConfig)
{
  hal_status_t tmp_hal_status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_ADC_AnalogWDGConfig(ADC_HandleTypeDef *hadc, ADC_AnalogWDGConfTypeDef *pAnalogWDGConfig)
{
  hal_status_t tmp_hal_status = HAL_OK;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t ADC_ConversionStop(ADC_HandleTypeDef *hadc, uint32_t ConversionGroup)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t ADC_Enable(ADC_HandleTypeDef *hadc)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t ADC_Disable(ADC_HandleTypeDef *hadc)
{
  uint32_t tickstart;
