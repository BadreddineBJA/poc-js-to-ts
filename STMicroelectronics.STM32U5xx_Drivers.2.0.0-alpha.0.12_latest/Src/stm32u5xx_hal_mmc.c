...
static hal_status_t MMC_ReadExtCSD(MMC_HandleTypeDef *hmmc, uint32_t *pFieldData, uint16_t FieldIndex,
                                   uint32_t Timeout);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_Init(MMC_HandleTypeDef *hmmc)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_InitCard(MMC_HandleTypeDef *hmmc)
{
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_DeInit(MMC_HandleTypeDef *hmmc)
{
  /* Check the MMC handle allocation */
  if (hmmc == NULL)
  {
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_ReadBlocks(MMC_HandleTypeDef *hmmc, uint8_t *pData, uint32_t BlockAdd,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_WriteBlocks(MMC_HandleTypeDef *hmmc, uint8_t *pData, uint32_t BlockAdd,
                                 uint32_t NumberOfBlocks, uint32_t Timeout)
{
  SDMMC_DataInitTypeDef config;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_ReadBlocks_IT(MMC_HandleTypeDef *hmmc, uint8_t *pData,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_WriteBlocks_IT(MMC_HandleTypeDef *hmmc, uint8_t *pData,
                                    uint32_t BlockAdd, uint32_t NumberOfBlocks)
{
  SDMMC_DataInitTypeDef config;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_ReadBlocks_DMA(MMC_HandleTypeDef *hmmc, uint8_t *pData,
                                    uint32_t BlockAdd, uint32_t NumberOfBlocks)
{
  SDMMC_DataInitTypeDef config;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_WriteBlocks_DMA(MMC_HandleTypeDef *hmmc, uint8_t *pData,
                                     uint32_t BlockAdd, uint32_t NumberOfBlocks)
{
  SDMMC_DataInitTypeDef config;
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_Erase(MMC_HandleTypeDef *hmmc, uint32_t BlockStartAdd, uint32_t BlockEndAdd)
{
  uint32_t errorstate;
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_MMC_RegisterCallback(MMC_HandleTypeDef *hmmc, HAL_MMC_CallbackIDTypeDef CallbackId,
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_MMC_UnRegisterCallback(MMC_HandleTypeDef *hmmc, HAL_MMC_CallbackIDTypeDef CallbackId)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_GetCardCID(MMC_HandleTypeDef *hmmc, HAL_MMC_CardCIDTypeDef *pCID)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_GetCardCSD(MMC_HandleTypeDef *hmmc, HAL_MMC_CardCSDTypeDef *pCSD)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_GetCardInfo(MMC_HandleTypeDef *hmmc, HAL_MMC_CardInfoTypeDef *pCardInfo)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_GetCardExtCSD(MMC_HandleTypeDef *hmmc, uint32_t *pExtCSD, uint32_t Timeout)
{
  SDMMC_DataInitTypeDef config;
  uint32_t errorstate;
  uint32_t tickstart = HAL_GetTick();
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_ConfigWideBusOperation(MMC_HandleTypeDef *hmmc, uint32_t WideMode)
{
  uint32_t count;
...
hal_status_t HAL_MMC_ConfigSpeedBusOperation(MMC_HandleTypeDef *hmmc, uint32_t SpeedMode)
{
  uint32_t tickstart;
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_Abort(MMC_HandleTypeDef *hmmc)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_Abort_IT(MMC_HandleTypeDef *hmmc)
{
  HAL_MMC_CardStateTypeDef CardState;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_EraseSequence(MMC_HandleTypeDef *hmmc, uint32_t EraseType,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_Sanitize(MMC_HandleTypeDef *hmmc)
{
  uint32_t errorstate;
  uint32_t response = 0U;
  uint32_t count;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_ConfigSecRemovalType(MMC_HandleTypeDef *hmmc, uint32_t SRTMode)
{
  uint32_t srt;
  uint32_t errorstate;
  uint32_t response = 0U;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_GetSupportedSecRemovalType(MMC_HandleTypeDef *hmmc, uint32_t *SupportedSRT)
{
  /* Check the state of the driver */
  if (hmmc->State == HAL_MMC_STATE_READY)
  {
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_SleepDevice(MMC_HandleTypeDef *hmmc)
{
  uint32_t errorstate,
           sleep_timeout,
           timeout,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_MMC_AwakeDevice(MMC_HandleTypeDef *hmmc)
{
  uint32_t errorstate;
...
/**
  ...
  * @retval HAL status
  */
static hal_status_t MMC_ReadExtCSD(MMC_HandleTypeDef *hmmc, uint32_t *pFieldData,
