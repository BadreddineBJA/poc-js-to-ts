...
ErrorStatus LL_LPGPIO_DeInit(gpio_t *LPGPIOx)
{
  ...
  ASSERT_DBG_PARAM(IS_LPGPIO_ALL_INSTANCE(LPGPIOx));
...
ErrorStatus LL_LPGPIO_Init(gpio_t *LPGPIOx, const LL_LPGPIO_InitTypeDef *const LPGPIO_InitStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_LPGPIO_ALL_INSTANCE(LPGPIOx));
  ASSERT_DBG_PARAM(IS_LL_LPGPIO_PIN(LPGPIO_InitStruct->Pin));
  ASSERT_DBG_PARAM(IS_LL_LPGPIO_MODE(LPGPIO_InitStruct->Mode));
