...
static hal_status_t SAI_InitI2S(SAI_HandleTypeDef *hsai, uint32_t protocol, uint32_t datasize, uint32_t nbslot);
static hal_status_t SAI_InitPCM(SAI_HandleTypeDef *hsai, uint32_t protocol, uint32_t datasize, uint32_t nbslot);

static hal_status_t SAI_Disable(SAI_HandleTypeDef *hsai);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_InitProtocol(SAI_HandleTypeDef *hsai, uint32_t protocol, uint32_t datasize, uint32_t nbslot)
{
  hal_status_t status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_Init(SAI_HandleTypeDef *hsai)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_DeInit(SAI_HandleTypeDef *hsai)
{
  /* Check the SAI handle allocation */
  if (hsai == NULL)
  {
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_SAI_RegisterCallback(SAI_HandleTypeDef        *hsai,
...
/**
  ...
  * @retval HAL status.
  */
hal_status_t HAL_SAI_UnRegisterCallback(SAI_HandleTypeDef        *hsai,
                                        HAL_SAI_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_Transmit(SAI_HandleTypeDef *hsai, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_Receive(SAI_HandleTypeDef *hsai, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  uint32_t tickstart = HAL_GetTick();
  uint32_t temp;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_Transmit_IT(SAI_HandleTypeDef *hsai, uint8_t *pData, uint16_t Size)
{
  if ((pData == NULL) || (Size == 0U))
  {
    return  HAL_ERROR;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_Receive_IT(SAI_HandleTypeDef *hsai, uint8_t *pData, uint16_t Size)
{
  if ((pData == NULL) || (Size == 0U))
  {
    return  HAL_ERROR;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_DMAPause(SAI_HandleTypeDef *hsai)
{
  /* Process Locked */
  __HAL_LOCK(hsai);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_DMAResume(SAI_HandleTypeDef *hsai)
{
  /* Process Locked */
  __HAL_LOCK(hsai);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_DMAStop(SAI_HandleTypeDef *hsai)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_Abort(SAI_HandleTypeDef *hsai)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_Transmit_DMA(SAI_HandleTypeDef *hsai, uint8_t *pData, uint16_t Size)
{
  hal_status_t status;
  uint32_t tickstart = HAL_GetTick();
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_Receive_DMA(SAI_HandleTypeDef *hsai, uint8_t *pData, uint16_t Size)
{
  hal_status_t status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_EnableTxMuteMode(SAI_HandleTypeDef *hsai, uint16_t val)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_DisableTxMuteMode(SAI_HandleTypeDef *hsai)
{
  if (hsai->State != HAL_SAI_STATE_RESET)
  {
    CLEAR_BIT(hsai->Instance->CR2, SAI_xCR2_MUTEVAL | SAI_xCR2_MUTE);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_EnableRxMuteMode(SAI_HandleTypeDef *hsai, SAIcallback callback, uint16_t counter)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SAI_DisableRxMuteMode(SAI_HandleTypeDef *hsai)
{
  if (hsai->State != HAL_SAI_STATE_RESET)
  {
