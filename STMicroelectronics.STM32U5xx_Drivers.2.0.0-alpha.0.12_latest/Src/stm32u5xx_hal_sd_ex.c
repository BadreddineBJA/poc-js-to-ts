...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SDEx_DMALinkedList_BuildNode(SD_DMALinkNodeTypeDef *pNode, SD_DMALinkNodeConfTypeDef *pNodeConf)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SDEx_DMALinkedList_InsertNode(SD_DMALinkedListTypeDef *pLinkedList,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SDEx_DMALinkedList_RemoveNode(SD_DMALinkedListTypeDef *pLinkedList, SD_DMALinkNodeTypeDef *pNode)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SDEx_DMALinkedList_LockNode(SD_DMALinkNodeTypeDef *pNode)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SDEx_DMALinkedList_UnlockNode(SD_DMALinkNodeTypeDef *pNode)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SDEx_DMALinkedList_EnableCircularMode(SD_DMALinkedListTypeDef *pLinkedList)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SDEx_DMALinkedList_DisableCircularMode(SD_DMALinkedListTypeDef *pLinkedList)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SDEx_DMALinkedList_ReadBlocks(SD_HandleTypeDef *hsd, SDMMC_DMALinkedListTypeDef *pLinkedList,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SDEx_DMALinkedList_WriteBlocks(SD_HandleTypeDef *hsd, SDMMC_DMALinkedListTypeDef *pLinkedList,
                                                uint32_t BlockAdd, uint32_t NumberOfBlocks)
