...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_GPU2D_Init(GPU2D_HandleTypeDef *hgpu2d)
{
...
/**
  ...
  * @retval None
  */
hal_status_t HAL_GPU2D_DeInit(GPU2D_HandleTypeDef *hgpu2d)
{
  /* Check the GPU2D handle validity */
  if (hgpu2d == NULL)
  {
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_GPU2D_RegisterCallback(GPU2D_HandleTypeDef *hgpu2d, HAL_GPU2D_CallbackIDTypeDef CallbackID,
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_GPU2D_UnRegisterCallback(GPU2D_HandleTypeDef *hgpu2d, HAL_GPU2D_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_GPU2D_RegisterCommandListCpltCallback(GPU2D_HandleTypeDef *hgpu2d,
...
/**
  ...
  * @retval status
  */
hal_status_t HAL_GPU2D_UnRegisterCommandListCpltCallback(GPU2D_HandleTypeDef *hgpu2d)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_GPU2D_WriteRegister(GPU2D_HandleTypeDef *hgpu2d, uint32_t offset, uint32_t value)
{
  /* Check the GPU2D handle validity */
  assert_param(hgpu2d != NULL);
