...
ErrorStatus LL_RTC_DeInit(RTC_TypeDef *RTCx)
{
  ...
  /* Check the parameter */
  ASSERT_DBG_PARAM(IS_RTC_ALL_INSTANCE(RTCx));
...
ErrorStatus LL_RTC_Init(RTC_TypeDef *RTCx, LL_RTC_InitTypeDef *RTC_InitStruct)
{
  ...
  ASSERT_DBG_PARAM(IS_RTC_ALL_INSTANCE(RTCx));
  ASSERT_DBG_PARAM(IS_LL_RTC_HOURFORMAT(RTC_InitStruct->HourFormat));
  ASSERT_DBG_PARAM(IS_LL_RTC_ASYNCH_PREDIV(RTC_InitStruct->AsynchPrescaler));
  ASSERT_DBG_PARAM(IS_LL_RTC_SYNCH_PREDIV(RTC_InitStruct->SynchPrescaler));
...
ErrorStatus LL_RTC_TIME_Init(RTC_TypeDef *RTCx, uint32_t RTC_Format, LL_RTC_TimeTypeDef *RTC_TimeStruct)
{
  ...
  /* Check the parameters */
  ASSERT_DBG_PARAM(IS_RTC_ALL_INSTANCE(RTCx));
  ASSERT_DBG_PARAM(IS_LL_RTC_FORMAT(RTC_Format));

  if (RTC_Format == LL_RTC_FORMAT_BIN)
  {
    if (LL_RTC_GetHourFormat(RTCx) != LL_RTC_HOURFORMAT_24HOUR)
    {
      ASSERT_DBG_PARAM(IS_LL_RTC_HOUR12(RTC_TimeStruct->Hours));
      ASSERT_DBG_PARAM(IS_LL_RTC_TIME_FORMAT(RTC_TimeStruct->TimeFormat));
    }
    else
    {
      RTC_TimeStruct->TimeFormat = 0x00U;
      ASSERT_DBG_PARAM(IS_LL_RTC_HOUR24(RTC_TimeStruct->Hours));
    }
    ASSERT_DBG_PARAM(IS_LL_RTC_MINUTES(RTC_TimeStruct->Minutes));
    ASSERT_DBG_PARAM(IS_LL_RTC_SECONDS(RTC_TimeStruct->Seconds));
  }
  else
  {
    if (LL_RTC_GetHourFormat(RTCx) != LL_RTC_HOURFORMAT_24HOUR)
    {
      ASSERT_DBG_PARAM(IS_LL_RTC_HOUR12(__LL_RTC_CONVERT_BCD2BIN(RTC_TimeStruct->Hours)));
      ASSERT_DBG_PARAM(IS_LL_RTC_TIME_FORMAT(RTC_TimeStruct->TimeFormat));
    }
    else
    {
      RTC_TimeStruct->TimeFormat = 0x00U;
      ASSERT_DBG_PARAM(IS_LL_RTC_HOUR24(__LL_RTC_CONVERT_BCD2BIN(RTC_TimeStruct->Hours)));
    }
    ASSERT_DBG_PARAM(IS_LL_RTC_MINUTES(__LL_RTC_CONVERT_BCD2BIN(RTC_TimeStruct->Minutes)));
    ASSERT_DBG_PARAM(IS_LL_RTC_SECONDS(__LL_RTC_CONVERT_BCD2BIN(RTC_TimeStruct->Seconds)));
  }
...
ErrorStatus LL_RTC_DATE_Init(RTC_TypeDef *RTCx, uint32_t RTC_Format, LL_RTC_DateTypeDef *RTC_DateStruct)
{
  ...
  if (RTC_Format == LL_RTC_FORMAT_BIN)
  {
    ASSERT_DBG_PARAM(IS_LL_RTC_YEAR(RTC_DateStruct->Year));
    ASSERT_DBG_PARAM(IS_LL_RTC_DAY(RTC_DateStruct->Day));
  }
  else
  {
    ASSERT_DBG_PARAM(IS_LL_RTC_YEAR(__LL_RTC_CONVERT_BCD2BIN(RTC_DateStruct->Year)));
    ASSERT_DBG_PARAM(IS_LL_RTC_DAY(__LL_RTC_CONVERT_BCD2BIN(RTC_DateStruct->Day)));
  }

  ASSERT_DBG_PARAM(IS_LL_RTC_MONTH(RTC_DateStruct->Month));
  ASSERT_DBG_PARAM(IS_LL_RTC_WEEKDAY(RTC_DateStruct->WeekDay));
...
ErrorStatus LL_RTC_ALMA_Init(RTC_TypeDef *RTCx, uint32_t RTC_Format, LL_RTC_AlarmTypeDef *RTC_AlarmStruct)
{
  ...
  ASSERT_DBG_PARAM(IS_RTC_ALL_INSTANCE(RTCx));
  ASSERT_DBG_PARAM(IS_LL_RTC_FORMAT(RTC_Format));
  ASSERT_DBG_PARAM(IS_LL_RTC_ALMA_MASK(RTC_AlarmStruct->AlarmMask));
  ASSERT_DBG_PARAM(IS_LL_RTC_ALMA_DATE_WEEKDAY_SEL(RTC_AlarmStruct->AlarmDateWeekDaySel));

  if (RTC_Format == LL_RTC_FORMAT_BIN)
  {
    if (LL_RTC_GetHourFormat(RTCx) != LL_RTC_HOURFORMAT_24HOUR)
    {
      ASSERT_DBG_PARAM(IS_LL_RTC_HOUR12(RTC_AlarmStruct->AlarmTime.Hours));
      ASSERT_DBG_PARAM(IS_LL_RTC_TIME_FORMAT(RTC_AlarmStruct->AlarmTime.TimeFormat));
    }
    else
    {
      RTC_AlarmStruct->AlarmTime.TimeFormat = 0x00U;
      ASSERT_DBG_PARAM(IS_LL_RTC_HOUR24(RTC_AlarmStruct->AlarmTime.Hours));
    }
    ASSERT_DBG_PARAM(IS_LL_RTC_MINUTES(RTC_AlarmStruct->AlarmTime.Minutes));
    ASSERT_DBG_PARAM(IS_LL_RTC_SECONDS(RTC_AlarmStruct->AlarmTime.Seconds));

    if (RTC_AlarmStruct->AlarmDateWeekDaySel == LL_RTC_ALMA_DATEWEEKDAYSEL_DATE)
    {
      ASSERT_DBG_PARAM(IS_LL_RTC_DAY(RTC_AlarmStruct->AlarmDateWeekDay));
    }
    else
    {
      ASSERT_DBG_PARAM(IS_LL_RTC_WEEKDAY(RTC_AlarmStruct->AlarmDateWeekDay));
    }
  }
  else
  {
    if (LL_RTC_GetHourFormat(RTCx) != LL_RTC_HOURFORMAT_24HOUR)
    {
      ASSERT_DBG_PARAM(IS_LL_RTC_HOUR12(__LL_RTC_CONVERT_BCD2BIN(RTC_AlarmStruct->AlarmTime.Hours)));
      ASSERT_DBG_PARAM(IS_LL_RTC_TIME_FORMAT(RTC_AlarmStruct->AlarmTime.TimeFormat));
    }
    else
    {
      RTC_AlarmStruct->AlarmTime.TimeFormat = 0x00U;
      ASSERT_DBG_PARAM(IS_LL_RTC_HOUR24(__LL_RTC_CONVERT_BCD2BIN(RTC_AlarmStruct->AlarmTime.Hours)));
    }

    ASSERT_DBG_PARAM(IS_LL_RTC_MINUTES(__LL_RTC_CONVERT_BCD2BIN(RTC_AlarmStruct->AlarmTime.Minutes)));
    ASSERT_DBG_PARAM(IS_LL_RTC_SECONDS(__LL_RTC_CONVERT_BCD2BIN(RTC_AlarmStruct->AlarmTime.Seconds)));

    if (RTC_AlarmStruct->AlarmDateWeekDaySel == LL_RTC_ALMA_DATEWEEKDAYSEL_DATE)
    {
      ASSERT_DBG_PARAM(IS_LL_RTC_DAY(__LL_RTC_CONVERT_BCD2BIN(RTC_AlarmStruct->AlarmDateWeekDay)));
    }
    else
    {
      ASSERT_DBG_PARAM(IS_LL_RTC_WEEKDAY(__LL_RTC_CONVERT_BCD2BIN(RTC_AlarmStruct->AlarmDateWeekDay)));
    }
  }
...
ErrorStatus LL_RTC_ALMB_Init(RTC_TypeDef *RTCx, uint32_t RTC_Format, LL_RTC_AlarmTypeDef *RTC_AlarmStruct)
{
  ...
  ASSERT_DBG_PARAM(IS_RTC_ALL_INSTANCE(RTCx));
  ASSERT_DBG_PARAM(IS_LL_RTC_FORMAT(RTC_Format));
  ASSERT_DBG_PARAM(IS_LL_RTC_ALMB_MASK(RTC_AlarmStruct->AlarmMask));
  ASSERT_DBG_PARAM(IS_LL_RTC_ALMB_DATE_WEEKDAY_SEL(RTC_AlarmStruct->AlarmDateWeekDaySel));
