...
static hal_status_t SMARTCARD_SetConfig(SMARTCARD_HandleTypeDef *hsmartcard);
static void SMARTCARD_AdvFeatureConfig(SMARTCARD_HandleTypeDef *hsmartcard);
static hal_status_t SMARTCARD_CheckIdleState(SMARTCARD_HandleTypeDef *hsmartcard);
static hal_status_t SMARTCARD_WaitOnFlagUntilTimeout(SMARTCARD_HandleTypeDef *hsmartcard, uint32_t Flag,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SMARTCARD_Init(SMARTCARD_HandleTypeDef *hsmartcard)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SMARTCARD_DeInit(SMARTCARD_HandleTypeDef *hsmartcard)
{
  /* Check the SMARTCARD handle allocation */
  if (hsmartcard == NULL)
  {
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SMARTCARD_RegisterCallback(SMARTCARD_HandleTypeDef *hsmartcard,
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SMARTCARD_UnRegisterCallback(SMARTCARD_HandleTypeDef *hsmartcard,
                                              HAL_SMARTCARD_CallbackIDTypeDef CallbackID)
{
  hal_status_t status = HAL_OK;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SMARTCARD_Transmit(SMARTCARD_HandleTypeDef *hsmartcard, const uint8_t *pData, uint16_t Size,
                                    uint32_t Timeout)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SMARTCARD_Receive(SMARTCARD_HandleTypeDef *hsmartcard, uint8_t *pData, uint16_t Size,
                                   uint32_t Timeout)
{
  uint32_t tickstart;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SMARTCARD_Transmit_IT(SMARTCARD_HandleTypeDef *hsmartcard, const uint8_t *pData, uint16_t Size)
{
  /* Check that a Tx process is not already ongoing */
  if (hsmartcard->gState == HAL_SMARTCARD_STATE_READY)
  {
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SMARTCARD_Receive_IT(SMARTCARD_HandleTypeDef *hsmartcard, uint8_t *pData, uint16_t Size)
{
  /* Check that a Rx process is not already ongoing */
  if (hsmartcard->RxState == HAL_SMARTCARD_STATE_READY)
  {
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SMARTCARD_Transmit_DMA(SMARTCARD_HandleTypeDef *hsmartcard, const uint8_t *pData, uint16_t Size)
{
  hal_status_t status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SMARTCARD_Receive_DMA(SMARTCARD_HandleTypeDef *hsmartcard, uint8_t *pData, uint16_t Size)
{
  hal_status_t status;
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SMARTCARD_Abort(SMARTCARD_HandleTypeDef *hsmartcard)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SMARTCARD_AbortTransmit(SMARTCARD_HandleTypeDef *hsmartcard)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SMARTCARD_AbortReceive(SMARTCARD_HandleTypeDef *hsmartcard)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SMARTCARD_Abort_IT(SMARTCARD_HandleTypeDef *hsmartcard)
{
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SMARTCARD_AbortTransmit_IT(SMARTCARD_HandleTypeDef *hsmartcard)
{
  /* Disable TCIE, TXEIE and TXFTIE interrupts */
  CLEAR_BIT(hsmartcard->Instance->CR1, (USART_CR1_TXEIE_TXFNFIE | USART_CR1_TCIE));
  CLEAR_BIT(hsmartcard->Instance->CR3, USART_CR3_TXFTIE);
...
/**
  ...
  * @retval HAL status
  */
hal_status_t HAL_SMARTCARD_AbortReceive_IT(SMARTCARD_HandleTypeDef *hsmartcard)
{
