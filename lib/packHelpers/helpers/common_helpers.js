...
exports.helper_common_get_resource_ctxt = exports.helper_common_get_partial = exports.helper_common_get_target_context = exports.helper_common_get_dma_activation = exports.helper_common_get_register_callback = void 0;
...
/*
  ...
  Output='' => 1 or 0
  */
function helper_common_get_register_callback(Settings, Module) {
    let result = 0;
    let resources = Settings["resources"];
    for (let resource in resources) {
        if (resources[resource].hasOwnProperty("componentid") &&
            resources[resource]["componentid"].includes(Module)) {
            if (resources[resource].hasOwnProperty("register_callback") &&
...
exports.helper_common_get_register_callback = helper_common_get_register_callback;
/*
  ...
  Output='' => 1 or 0
  */
function helper_common_get_dma_activation(Settings, Module) {
    let result = 0;
    let resources = Settings["resources"];
    for (let resource in resources) {
        if (resources[resource].hasOwnProperty("componentid") &&
...
exports.helper_common_get_dma_activation = helper_common_get_dma_activation;
/*
  ...
  Output=''
{
  ...
  */
function helper_common_get_target_context(global_ctxt) {
        ...
        if (key != undefined) {
            ...
            if (Cgroup == "STM32 HAL Code Gen") {
                ...
                instanceList.forEach((instance) => {
                    ...
                    let labels = [];
                    if (instance.settings.blocks !== undefined &&
                        ...
                        if (instance.settings.blocks.configs !== undefined) {
                            ...
                            result["periphs"].push(periph);
                            console.log(`[WARNING] helper_common_get_target_context: no configs block`);
                        }
                    }
                    else {
                        ...
                        result["periphs"].push(periph);
                        console.log(`[WARNING] helper_common_get_target_context: no blocks or info block`);
                    }
                });
            }
        }
...
exports.helper_common_get_target_context = helper_common_get_target_context;
/*
  ...
  */
function helper_common_get_partial(component) {
    console.log(`[INFO] helper_common_get_partial`);
    return component;
}
exports.helper_common_get_partial = helper_common_get_partial;
function helper_common_get_resource_ctxt(global_ctxt, component) {
...
exports.helper_common_get_resource_ctxt = helper_common_get_resource_ctxt;
