...
exports.helper_exti_get_config = exports.helper_exti_get_gpio = void 0;
function helper_exti_get_gpio(Gpio_Config) {
...
exports.helper_exti_get_gpio = helper_exti_get_gpio;
function helper_exti_get_config(gpio_list) {
    ...
    let result = { found_exti: false, exti_list: [] };
    gpio_list.forEach((gpio) => {
        let gpio_hw = gpio_list["pad"];
        let list_exti = { port: "", line: "", trigger: "" };
        let exti = gpio["exti"];
        if (exti) {
            result["found_exti"] = true;
...
exports.helper_exti_get_config = helper_exti_get_config;
//# sourceMappingURL=exti_helpers.js.map